...
static char* mapcmdnames[] = { "ALLOWMONSTERTELEFRAGS", "AUTHOR", "BOSSACTION",
    "CLUSTER", "COMPAT_CORPSEGIBS", "COMPAT_FLOORMOVE", "COMPAT_LIGHT",
    "COMPAT_LIMITPAIN", "COMPAT_NOPASSOVER", "COMPAT_STAIRS", "COMPAT_USEBLOCKING",
    "COMPAT_VILEGHOSTS", "COMPAT_ZOMBIE", "ENDBUNNY", "ENDCAST", "ENDGAME",
    "ENDPIC", "ENTERANIM", "ENTERPIC", "EPISODE", "EXITANIM", "EXITPIC",
    "INTERBACKDROP", "INTERMUSIC", "INTERTEXT", "INTERTEXTSECRET", "LABEL",
    "LEVELNAME", "LEVELPIC", "LIQUID", "MUSIC", "MUSICARTIST", "MUSICTITLE",
    "NEXT", "NEXTSECRET", "NOBRIGHTMAP", "NOFREELOOK", "NOGRADUALLIGHTING",
    "NOINTERMISSION", "NOJUMP", "NOLIQUID", "NOMOUSELOOK", "PAR", "PARTIME",
    "PISTOLSTART", "SECRETNEXT", "SKY1", "SKYTEXTURE", "TITLEPATCH", NULL };

static int mapcmdids[] = { MCMD_ALLOWMONSTERTELEFRAGS, MCMD_AUTHOR,
    MCMD_BOSSACTION, MCMD_CLUSTER, MCMD_COMPAT_CORPSEGIBS, MCMD_COMPAT_FLOORMOVE,
    MCMD_COMPAT_LIGHT, MCMD_COMPAT_LIMITPAIN, MCMD_COMPAT_NOPASSOVER,
    MCMD_COMPAT_STAIRS, MCMD_COMPAT_USEBLOCKING, MCMD_COMPAT_VILEGHOSTS,
    MCMD_COMPAT_ZOMBIE, MCMD_ENDBUNNY, MCMD_ENDCAST, MCMD_ENDGAME, MCMD_ENDPIC,
    MCMD_ENTERANIM, MCMD_ENTERPIC, MCMD_EPISODE, MCMD_EXITANIM, MCMD_EXITPIC,
    MCMD_INTERBACKDROP, MCMD_INTERMUSIC, MCMD_INTERTEXT, MCMD_INTERTEXTSECRET,
    MCMD_LABEL, MCMD_LEVELNAME, MCMD_LEVELPIC, MCMD_LIQUID, MCMD_MUSIC,
    MCMD_MUSICARTIST, MCMD_MUSICTITLE, MCMD_NEXT, MCMD_NEXTSECRET, MCMD_NOBRIGHTMAP,
    MCMD_NOFREELOOK, MCMD_NOGRADUALLIGHTING, MCMD_NOINTERMISSION, MCMD_NOJUMP,
    MCMD_NOLIQUID, MCMD_NOMOUSELOOK, MCMD_PAR, MCMD_PARTIME, MCMD_PISTOLSTART,
    MCMD_SECRETNEXT, MCMD_SKY1, MCMD_SKYTEXTURE, MCMD_TITLEPATCH };
...
const char* nodeformats[] = { "Vanilla", ITALICS("DeeP"),
    ITALICS("ZDoom") " extended", ITALICS("NanoBSP") };
...
const char* linespecials[NUMLINESPECIALS] = { "", "DR Door open wait close (also monsters)",
    "W1 Door open stay", "W1 Door close stay", "W1 Door open wait close",
    "W1 Floor raise to lowest ceiling", "W1 Crusher start with fast damage",
    "S1 Stairs raise by 8", "W1 Stairs raise by 8",
    "S1 Floor raise donut (changes texture)", "W1 Lift lower wait raise",
    "S1 Exit level", "W1 Light change to brightest adjacent", "W1 Light change to 255",
    "S1 Floor raise by 32 (changes texture)", "S1 Floor raise by 24 (changes texture)",
    "W1 Door close wait open", "W1 Light start blinking",
    "S1 Floor raise to next highest floor", "W1 Floor lower to highest floor",
    "S1 Floor raise to next highest floor (changes texture)",
    "S1 Lift lower wait raise", "W1 Floor raise to next highest floor (changes texture)",
    "S1 Floor lower to lowest floor", "G1 Floor raise to lowest ceiling",
    "W1 Crusher start with slow damage", "DR Door (blue) open wait close",
    "DR Door (yellow) open wait close", "DR Door (red) open wait close",
    "S1 Door open wait close", "W1 Floor raise by shortest lower texture",
    "D1 Door open stay", "D1 Door (blue) open stay", "D1 Door (red) open stay",
    "D1 Door (yellow) open stay", "W1 Light change to 35",
    "W1 Floor lower to 8 above highest floor", "W1 Floor lower to lowest floor (changes texture)",
    "W1 Floor lower to lowest floor", "W1 Teleport", "W1 Ceiling raise to highest ceiling",
    "S1 Ceiling lower to floor", "SR Door close stay", "SR Ceiling lower to floor",
    "W1 Ceiling lower to 8 above floor", "SR Floor lower to highest floor",
    "GR Door open stay", "G1 Floor raise to next highest floor (changes texture)",
    "Scroll texture left", "S1 Ceiling lower to 8 above floor (perpetual slow crusher damage)",
    "S1 Door close stay", "S1 Exit level (goes to secret level)",
    "W1 Exit level", "W1 Floor start moving up and down",
    "W1 Floor stop moving", "S1 Floor raise to 8 below lowest ceiling (crushes)",
    "W1 Floor raise to 8 below lowest ceiling (crushes)", "W1 Crusher stop",
    "W1 Floor raise by 24", "W1 Floor raise by 24 (changes texture)",
    "SR Floor lower to lowest floor", "SR Door open stay", "SR Lift lower wait raise",
    "SR Door open wait close", "SR Floor raise to lowest ceiling",
    "SR Floor raise to 8 below lowest ceiling (crushes)",
    "SR Floor raise by 24 (changes texture)", "SR Floor raise by 32 (changes texture)",
    "SR Floor raise to next highest floor (changes texture)",
    "SR Floor raise to next highest floor", "SR Floor lower to 8 above highest floor",
    "S1 Floor lower to 8 above highest floor", "WR Ceiling lower to 8 above floor",
    "WR Crusher start with slow damage", "WR Crusher stop", "WR Door close stay",
    "WR Door close stay open", "WR Crusher start with fast damage",
    "SR Change texture and effect to nearest", "WR Light change to 35",
    "WR Light change to brightest adjacent", "WR Light change to 255",
    "WR Floor lower to lowest floor", "WR Floor lower to highest floor",
    "WR Floor lower to lowest floor (changes texture)", "Scroll texture right",
    "WR Door open stay", "WR Floor start moving up and down", "WR Lift lower wait raise",
    "WR Floor stop moving", "WR Door open wait close", "WR Floor raise to lowest ceiling",
    "WR Floor raise by 24", "WR Floor raise by 24 (changes texture)",
    "WR Floor raise to 8 below lowest ceiling (crushes)",
    "WR Floor raise to next highest floor (changes texture)",
    "WR Floor raise by shortest lower texture", "WR Teleport",
    "WR Floor lower to 8 above highest floor", "SR Door (blue) open stay (fast)",
    "W1 Stairs raise by 16 (fast)", "S1 Floor raise to lowest ceiling",
    "S1 Floor lower to highest floor", "S1 Door open stay",
    "W1 Light change to darkest adjacent", "WR Door open wait close (fast)",
    "WR Door open stay (fast)", "WR Door close stay (fast)",
    "W1 Door open wait close (fast)", "W1 Door open stay (fast)",
    "W1 Door close stay (fast)", "S1 Door open wait close (fast)",
    "S1 Door open stay (fast)", "S1 Door close stay (fast)",
    "SR Door open wait close (fast)", "SR Door open stay (fast)",
    "SR Door close stay (fast)", "DR Door open wait close (fast)",
    "D1 Door open stay (fast)", "W1 Floor raise to next highest floor",
    "WR Lift lower wait raise (fast)", "W1 Lift lower wait raise (fast)",
    "S1 Lift lower wait raise (fast)", "SR Lift lower wait raise (fast)",
    "W1 Exit level (goes to secret level)", "W1 Teleport (monsters only)",
    "WR Teleport (monsters only)", "S1 Stairs raise by 16 (fast)",
    "WR Floor raise to next highest floor", "WR Floor raise to next highest floor (fast)",
    "W1 Floor raise to next highest floor (fast)", "S1 Floor raise to next highest floor (fast)",
    "SR Floor raise to next highest floor (fast)", "S1 Door (blue) open stay (fast)",
    "SR Door (red) open stay (fast)", "S1 Door (red) open stay (fast)",
    "SR Door (yellow) open stay (fast)", "S1 Door (yellow) open stay (fast)",
    "SR Light change to 255", "SR Light change to 35", "S1 Floor raise by 512",
    "W1 Crusher start with slow damage (silent)", "W1 Floor raise by 512",
    "W1 Lift raise by 24 (changes texture)", "W1 Lift raise by 32 (changes texture)",
    "W1 Ceiling lower to floor (fast)", "W1 Floor raise donut (changes texture)",
    "WR Floor raise by 512", "WR Lift raise by 24 (changes texture)",
    "WR Lift raise by 32 (changes texture)", "WR Crusher start (silent)",
    "WR Ceiling raise to highest ceiling", "WR Ceiling lower to floor (fast)",
    "W1 Change texture and effect", "WR Change texture and effect",
    "WR Floor raise donut (changes texture)", "WR Light start blinking",
    "WR Light change to darkest adjacent", "S1 Floor raise by shortest lower texture",
    "S1 Floor lower to lowest floor (changes texture)",
    "S1 Floor raise by 24 (changes texture and effect)", "S1 Floor raise by 24",
    "S1 Lift perpetual lowest and highest floors", "S1 Lift stop",
    "S1 Crusher start (fast)", "S1 Crusher start (silent)",
    "S1 Ceiling raise to highest ceiling", "S1 Ceiling lower to 8 above floor",
    "S1 Crusher stop", "S1 Light change to brightest adjacent",
    "S1 Light change to 35", "S1 Light change to 255", "S1 Light start blinking",
    "S1 Light change to darkest adjacent", "S1 Teleport (also monsters)",
    "S1 Door close wait open (30 seconds)", "SR Floor raise by shortest lower texture",
    "SR Floor lower to lowest floor (changes texture)", "SR Floor raise by 512",
    "SR Floor raise by 24 (changes texture and effect)", "SR Floor raise by 24",
    "SR Lift perpetual lowest and highest floors", "SR Lift stop",
    "SR Crusher start (fast)", "SR Crusher start", "SR Crusher start (silent)",
    "SR Ceiling raise to highest ceiling", "SR Ceiling lower to 8 above floor",
    "SR Crusher stop", "S1 Change texture and effect",
    "SR Change texture and effect", "SR Floor raise donut (changes texture)",
    "SR Light change to brightest adjacent", "SR Light start blinking",
    "SR Light change to darkest adjacent", "SR Teleport (also monsters)",
    "SR Door close wait open (30 seconds)", "G1 Exit level",
    "G1 Exit level (goes to secret level)", "W1 Ceiling lower to lowest ceiling",
    "W1 Ceiling lower to highest floor", "WR Ceiling lower to lowest ceiling",
    "WR Ceiling lower to highest floor", "S1 Ceiling lower to lowest ceiling",
    "S1 Ceiling lower to highest floor", "SR Ceiling lower to lowest ceiling",
    "SR Ceiling lower to highest floor", "W1 Teleport (also monsters, silent, same angle)",
    "WR Teleport (also monsters, silent, same angle)",
    "S1 Teleport (also monsters, silent, same angle)",
    "SR Teleport (also monsters, silent, same angle)", "SR Lift raise to ceiling (instantly)",
    "WR Lift raise to ceiling (instantly)", "Floor change brightness to this brightness",
    ...
    "W1 Floor lower to nearest floor", "WR Floor lower to nearest floor",
    "S1 Floor lower to nearest floor", "SR Floor lower to nearest floor",
    "Friction tagged sector", "Wind according to line vector",
    "Current according to line vector", "Wind/current by push/pull thing in sector",
    "W1 Lift raise to next highest floor (fast)", "WR Lift raise to next highest floor (fast)",
    "S1 Lift raise to next highest floor (fast)", "SR Lift raise to next highest floor (fast)",
    "W1 Lift lower to next lowest floor (fast)", "WR Lift lower to next lowest floor (fast)",
    "S1 Lift lower to next lowest floor (fast)", "SR Lift lower to next lowest floor (fast)",
    "W1 Lift move to same floor height (fast)", "WR Lift move to same floor height (fast)",
    "S1 Lift move to same floor height (fast)", "SR Lift move to same floor height (fast)",
    "W1 Change texture and effect to nearest", "WR Change texture and effect to nearest",
    "S1 Change texture and effect to nearest", "Create fake ceiling and floor",
    "W1 Teleport to line with same tag (silent, same angle)",
    "WR Teleport to line with same tag (silent, same angle)",
    "Scroll ceiling when sector changes height", "Scroll floor when sector changes height",
    ...
    "Scroll ceiling according to line vector", "Scroll floor according to line vector",
    "Scroll move things according to line vector", "Scroll floor, move things",
    "Scroll wall according to line vector", "Scroll wall using sidedef offsets",
    "WR Stairs raise by 8", "WR Stairs raise by 16 (fast)",
    "SR Stairs raise by 8", "SR Stairs raise by 16 (fast)",
    "Translucent (middle texture)", "Ceiling change brightness to this brightness",
    ...
    "W1 Teleport (monsters only, silent)", "WR Teleport (monsters only, silent)",
    "", "Transfer sky texture to tagged sectors",
    "Transfer sky texture to tagged sectors (flipped)" };

static const char* sectorspecials[] = { "", "Light blinks (randomly)",
    "Light blinks (0.5 sec.)", "Light blinks (1 sec.)",
    "Damage -10% or -20% health and light blinks (0.5 sec.)",
    "Damage -5% or -10% health", "", "Damage -2% or -5% health",
    "Light glows (1+ sec.)", "Secret", "Door close stay (after 30 sec.)",
    "Damage -10% or -20% health and end level", "Light blinks (0.5 sec. synchronized)",
    "Light blinks (1 sec. synchronized)", "Door open close (opens after 5 min.)",
    "", "Damage -10% or -20% health", "Light flickers (randomly)" };
...
static void P_LoadVertexes(int lump)
{
    ...
    else
    {
        ...
        for(int i = 0; i < numvertexes; i++)
        {
            ...
            if(canmodify && r_fixmaperrors && game.mode != shareware)
                for(int j = 0; vertexfix[j].mission != -1; j++)
                    if(game.mission == vertexfix[j].mission &&
                    game.episode == vertexfix[j].episode &&
                    game.map == vertexfix[j].map && i == vertexfix[j].vertex &&
                    vertexes[i].x == vertexfix[j].oldx << FRACBITS &&
                    vertexes[i].y == vertexfix[j].oldy << FRACBITS)
                    {
                        ...
                        temp, vertexfix[j].oldx, vertexfix[j].oldy,
                        vertexfix[j].newx, vertexfix[j].newy);
        ...
        if(!special)
        {
            if(ld->tag)
            {
                ...
                if(ld->tag < 0 || P_FindSectorFromLineTag(ld, -1) == -1)
                    C_Warning(2, "Linedef %s has an unused tag of %s and no line special.",
                    temp1, temp2);
                else
                    C_Warning(2, "Linedef %s has a tag of %s but no line special.",
                    temp1, temp2);
            ...
            if(!P_CheckTag(ld))
            {
                ...
                if(special < NUMLINESPECIALS)
                {
                    if(linespecials[special])
                        ...
                        temp1,
                        (special < BOOMLINESPECIALS ?
                        "a" :
                        (special < MBFLINESPECIALS ?
                        "a " ITALICS("BOOM") "-compatible" :
                        (special < MBF21LINESPECIALS ?
                        "an " ITALICS("MBF") "-compatible" :
                        "an " ITALICS("MBF21") "-compatible"))),
                        temp2, linespecials[special]);
                    else
                        C_Warning(2, "Linedef %s has an invalid line special of %s.",
                        temp1, temp2);
                }
                else if(special >= GenCrusherBase && special < GenEnd)
                    C_Warning(2, "Linedef %s has a " ITALICS("BOOM") "-compatible generalized line special of %s but no tag.",
                    temp1, temp2);
                else
                    C_Warning(2, "Linedef %s has an invalid line special of %s.",
                    temp1, temp2);
            ...
            else if(ld->tag < 0 || P_FindSectorFromLineTag(ld, -1) == -1)
            {
                ...
                if(special < NUMLINESPECIALS)
                {
                    if(linespecials[special])
                        ...
                        "an " ITALICS("MBF") "-compatible" :
                        "an " ITALICS("MBF21") "-compatible"))),
                        temp2, linespecials[special], temp3);
                    else
                        C_Warning(2, "Linedef %s has an invalid line special of %s.",
                        temp1, temp2);
                }
...
static void P_LoadSegs(int lump)
{
    ...
    for(int i = 0; i < numsegs; i++)
    {
        ...
        if(linedefnum >= numlines)
            I_Error("Seg %s references an invalid linedef of %s.", commify(i),
            commify(linedefnum));
        ...
        if((unsigned int)ldef->sidenum[side] >= (unsigned int)numsides)
            I_Error(
            "Linedef %s for seg %s references an invalid sidedef of %s.",
        ...
        else
        {
            ...
            C_Warning(2, "The %s of seg %s has no sidedef.",
            (side ? "back" : "front"), temp);
            li->frontsector = NULL;
            free(temp);
        }
        ...
        if(canmodify && r_fixmaperrors && game.mode != shareware)
            for(int j = 0; linefix[j].mission != -1; j++)
                if(game.mission == linefix[j].mission &&
                game.episode == linefix[j].episode &&
                game.map == linefix[j].map && linedefnum == linefix[j].linedef &&
                side == linefix[j].side && !linefix[j].fixed)
                {
                    ...
                    if(*linefix[j].toptexture)
                    {
                        ...
                        if(!texture)
                            C_Warning(2, "The unused top texture of linedef %s has been removed.",
                            temp);
                        else
                        {
                            if(!li->sidedef->toptexture)
                                C_Warning(2,
                                "The missing top texture of linedef %s has "
                                "been changed to " BOLD("%.8s") ".",
                                temp, linefix[j].toptexture);
                            else
                                C_Warning(2,
                                "The top texture of linedef %s has been "
                                "changed from " BOLD("%.8s") " to " BOLD("%.8s") ".",
                                temp, textures[li->sidedef->toptexture]->name,
                                linefix[j].toptexture);
                        }
                    ...
                    if(*linefix[j].middletexture)
                    {
                        ...
                        if(!texture)
                            C_Warning(2, "The unused middle texture of linedef %s has been removed.",
                            temp);
                        else
                        {
                            if(!li->sidedef->midtexture)
                                C_Warning(2,
                                "The missing middle texture of linedef %s has "
                                "been changed to " BOLD("%.8s") ".",
                                temp, linefix[j].middletexture);
                            else
                                C_Warning(2,
                                "The middle texture of linedef %s has been "
                                "changed from " BOLD("%.8s") " to " BOLD("%.8s") ".",
                                temp, textures[li->sidedef->midtexture]->name,
                                linefix[j].middletexture);
                        }
                    ...
                    if(*linefix[j].bottomtexture)
                    {
                        ...
                        if(!texture)
                            C_Warning(2, "The unused bottom texture of linedef %s has been removed.",
                            temp);
                        else
                        {
                            if(!li->sidedef->bottomtexture)
                                C_Warning(2,
                                "The missing bottom texture of linedef %s has "
                                "been changed to " BOLD("%.8s") ".",
                                temp, linefix[j].bottomtexture);
                            else
                                C_Warning(2,
                                "The bottom texture of linedef %s has been "
                                "changed from " BOLD("%.8s") " to " BOLD("%.8s") ".",
                                temp, textures[li->sidedef->bottomtexture]->name,
                                linefix[j].bottomtexture);
                        }
                    ...
                    if(linefix[j].special != DEFAULT)
                    {
                        if(linefix[j].special)
                        {
                            ...
                            if(special > 0 && special < NUMLINESPECIALS)
                            {
                                ...
                                "The" :
                                (special < MBFLINESPECIALS ?
                                "The " ITALICS("BOOM") "-compatible" :
                                (special < MBF21LINESPECIALS ?
                                "The " ITALICS("MBF") "-compatible" :
                                "The " ITALICS("MBF21") "-compatible"))),
                                temp1, temp2, linespecials[special], temp3,
                                linespecials[linefix[j].special]);
                                free(temp3);
                            }
                            else
                                C_Warning(2, "Linedef %s now has %s line special %s (\"%s\").",
                                temp1,
                                (linefix[j].special < BOOMLINESPECIALS ?
                                "the" :
                                (linefix[j].special < MBFLINESPECIALS ?
                                "The " ITALICS("BOOM") "-compatible" :
                                (linefix[j].special < MBF21LINESPECIALS ?
                                "the " ITALICS("MBF") "-compatible" :
                                "the " ITALICS("MBF21") "-compatible"))),
                                temp2, linespecials[linefix[j].special]);
                        ...
                        else
                        {
                            ...
                            (li->linedef->special < BOOMLINESPECIALS ?
                            "The" :
                            (li->linedef->special < MBFLINESPECIALS ?
                            "The " ITALICS("BOOM") "-compatible" :
                            (li->linedef->special < MBF21LINESPECIALS ?
                            "The " ITALICS("MBF") "-compatible" :
                            "The " ITALICS("MBF21") "-compatible"))),
                            temp);
                            free(temp);
                    ...
                    if(linefix[j].tag != DEFAULT)
                    {
                        ...
                        if(linefix[j].tag)
                        {
                            ...
                            C_Warning(2, "Linedef %s's tag has been changed from %s to %s.",
                            temp1, temp2, temp3);
                            free(temp3);
                        }
                        else
                            C_Warning(2, "Linedef %s's tag of %s has been removed.",
                            temp1, temp2);
    ...
    for(int i = 0; i < numsectors; i++)
    {
        ...
        if(canmodify && r_fixmaperrors && game.mode != shareware)
            for(int j = 0; sectorfix[j].mission != -1; j++)
                if(game.mission == sectorfix[j].mission &&
                game.episode == sectorfix[j].episode &&
                game.map == sectorfix[j].map && i == sectorfix[j].sector)
                {
                    if(*sectorfix[j].floorpic)
                    {
                        ...
                        C_Warning(2,
                        "The texture of sector %s's floor has been changed "
                        "from " BOLD("%.8s") " to " BOLD("%.8s") ".",
                        temp, lumpinfo[ss->floorpic + firstflat]->name,
                        sectorfix[j].floorpic);
                    ...
                    if(*sectorfix[j].ceilingpic)
                    {
                        ...
                        C_Warning(2,
                        "The texture of sector %s's ceiling has been changed "
                        "from " BOLD("%.8s") " to " BOLD("%.8s") ".",
                        temp, lumpinfo[ss->ceilingpic + firstflat]->name,
                        sectorfix[j].ceilingpic);
                    ...
                    if(sectorfix[j].floorheight != DEFAULT)
                    {
                        ...
                        C_Warning(2, "The height of sector %s's floor has been changed from %s to %s.",
                        temp1, temp2, temp3);
                    ...
                    if(sectorfix[j].ceilingheight != DEFAULT)
                    {
                        ...
                        C_Warning(2, "The height of sector %s's ceiling has been changed from %s to %s.",
                        temp1, temp2, temp3);
                    ...
                    if(sectorfix[j].special != DEFAULT)
                    {
                        ...
                        M_StringCopy(oldspecial, sectorspecials[ss->special],
                        sizeof(oldspecial));
                        M_StringCopy(newspecial,
                        sectorspecials[sectorfix[j].special], sizeof(newspecial));
                        ...
                        if(ss->special)
                        {
                            if(sectorfix[j].special)
                                ...
                                sectorfix[j].special, newspecial);
                            else
                    ...
                    if(ss->tag == sectorfix[j].oldtag)
                    {
                        ...
                        if(!sectorfix[j].oldtag)
                            C_Warning(2, "Sector %s's tag of %s has been removed.",
                            temp1, temp2);
                        else if(ss->tag)
                            C_Warning(2, "Sector %s's tag has been changed from %s to %s.",
                            temp1, temp2, temp3);
                        else
            ...
            for(int j = 0; j < 2; j++)
            {
                ...
                else if(no->children[j] & 0x8000)
                {
                    ...
                    if(no->children[j] >= numsubsectors)
                    {
                        ...
                        C_Warning(2, "Node %s references an invalid subsector of %s.",
                        temp1, temp2);
                        no->children[j] = 0;
                        free(temp1);
                        free(temp2);
...
static void P_LoadZNodes(int lump)
{
    ...
    if(numSegs != currSeg)
        I_Error(
        "There are an incorrect number of segs in the nodes in this map.");
...
static void P_LoadThings(int map, int lump)
{
    ...
    M_BigSeed(game.mission == doom && map == 1 && canmodify ? BIGSEED : numthings);
    ...
    for(thingid = 0; thingid < numthings; thingid++)
    {
        ...
        if(game.mode != commercial && type >= ArchVile &&
        type <= MonsterSpawner && W_GetNumLumps("DEHACKED") == 1)
        {
            ...
            C_Warning(2, "%s can't be spawned in " ITALICS("%s."), buffer, game.description);
        ...
        if(canmodify && r_fixmaperrors && game.mode != shareware)
            for(int j = 0; thingfix[j].mission != -1; j++)
                if(game.mission == thingfix[j].mission &&
                game.episode == thingfix[j].episode && game.map == thingfix[j].map &&
...
static void P_LoadLineDefs(int lump)
{
    ...
    for(int i = 0; i < numlines; i++)
    {
        ...
        ld->slopetype = (!ld->dx ?
        ST_VERTICAL :
        (!ld->dy ? ST_HORIZONTAL : (FixedDiv(ld->dy, ld->dx) > 0 ? ST_POSITIVE : ST_NEGATIVE)));

        ld->angle = R_PointToAngle2(
        lines[i].v1->x, lines[i].v1->y, lines[i].v2->x, lines[i].v2->y);
...
static void P_LoadLineDefs2(void)
{
    ...
    for(int i = numlines; i--; ld++)
    {
        ...
        ld->frontsector =
        (ld->sidenum[0] != NO_INDEX ? sides[ld->sidenum[0]].sector : NULL);
        ld->backsector =
...
static void P_LoadSideDefs2(int lump)
{
    ...
    for(int i = 0; i < numsides; i++)
    {
        ...
        sd->textureoffset = sd->basetextureoffset = sd->oldtextureoffset =
        SHORT(msd->textureoffset) << FRACBITS;
        ...
        case CreateFakeCeilingAndFloor:
            ...
            sd->midtexture =
            ((sec->midmap = R_ColormapNumForName(msd->midtexture)) < 0 ? sec->midmap = 0,
            R_TextureNumForName(msd->midtexture) : 0);
            sd->toptexture =
            ((sec->topmap = R_ColormapNumForName(msd->toptexture)) < 0 ? sec->topmap = 0,
        ...
        case Translucent_MiddleTexture:
            ...
            W_LumpLength(sd->special) != 65536 ?
               sd->special = 0,
            R_TextureNumForName(msd->midtexture) :
        ...
        default:
            ...
            sd->bottomtexture = R_TextureNumForName(msd->bottomtexture);
            sd->missingbottomtexture =
            (R_CheckTextureNumForName(msd->bottomtexture) == -1);
            break;
        }
    }
    ...
    //     either the x or y direction, to the block which contains the linedef.
    {
        ...
        for(int i = 0; i < numlines; i++)
        {
            ...
            while(b < tot) // failsafe -- should ALWAYS be true
            {
                ...
                if(bp->n >= bp->nalloc)
                    bp->list = I_Realloc(bp->list,
                    (bp->nalloc = (bp->nalloc ? bp->nalloc * 2 : 8)) *
                    sizeof(*bp->list));
        ...
        // 4 words, unused if this routine is called, are reserved at the start.
        {
            ...
            blockmaplump =
            malloc_IfSameLevel(blockmaplump, count * sizeof(*blockmaplump));
        }
...
static void P_LoadBlockMap(int lump)
{
    ...
    else if(M_CheckParm("blockmap"))
    {
        P_CreateBlockMap();
        C_Warning(1,
        "A " BOLD("-blockmap") " parameter was found on the command-line. "
                               "The " BOLD(
                               "BLOCKMAP") " lump has been rebuilt.");
    }
    else
    {
    ...
    blocklinks = calloc_IfSameLevel(
    blocklinks, (size_t)bmapwidth * bmapheight, sizeof(*blocklinks));
...
static void P_GroupLines(void)
{
    ...
    for(i = 0, sector = sectors; i < numsectors; i++, sector++)
    {
        ...
        MIN(P_GetSafeBlockY(bbox[BOXTOP] - bmaporgy + MAXRADIUS), bmapheight - 1);
        sector->blockbox[BOXBOTTOM] =
        MAX(0, P_GetSafeBlockY(bbox[BOXBOTTOM] - bmaporgy - MAXRADIUS));
        sector->blockbox[BOXRIGHT] =
        MIN(P_GetSafeBlockX(bbox[BOXRIGHT] - bmaporgx + MAXRADIUS), bmapwidth - 1);
        sector->blockbox[BOXLEFT] =
        MAX(0, P_GetSafeBlockX(bbox[BOXLEFT] - bmaporgx - MAXRADIUS));
    }
}
            ...
            do
            {
                if(!hit[v - vertexes]) // If we haven't processed vertex
                {
                    ...
                    if(v != l->v1 && v != l->v2) // Exclude endpoints of linedefs
                    {
                        ...
                        const int64_t dx2 =
                        (int64_t)(l->dx >> FRACBITS) * (l->dx >> FRACBITS);
                        const int64_t dy2 =
                        (int64_t)(l->dy >> FRACBITS) * (l->dy >> FRACBITS);
                        const int64_t dxy =
                        (int64_t)(l->dx >> FRACBITS) * (l->dy >> FRACBITS);
                        ...
                        v->x =
                        (fixed_t)((dx2 * x0 + dy2 * x1 + dxy * ((int64_t)y0 - y1)) / s);
                        v->y =
                        (fixed_t)((dy2 * y0 + dx2 * y1 + dxy * ((int64_t)x0 - x1)) / s);
...
static void P_CalcSegsLength(void)
{
    ...
    for(int i = 0; i < numsegs; i++)
    {
        ...
        const angle_t angle =
        R_PointToAngleEx2(li->v1->x, li->v1->y, li->v2->x, li->v2->y);
...
void P_MapName(int ep, int map)
{
    ...
    case doom:
        ...
        else if(W_GetNumLumps(mapnum) > 1 && dehmaptitlecount == 1)
        {
            ...
            M_StringCopy(maptitle,
            trimwhitespace(*mapnames[(ep - 1) * 9 + map - 1]), sizeof(maptitle));
    ...
    if(strlen(maptitle) >= 4)
    {
        ...
        else if(maptitle[0] == 'e' && isdigit((int)maptitle[1]) &&
        maptitle[2] == 'm' && isdigit((int)maptitle[3]))
        {
            maptitle[0] = 'E';
            maptitle[2] = 'M';
        }
    ...
    if(!mapnumonly)
    {
        ...
        if(pos)
        {
            ...
            M_StringStartsWith(maptitle, "LV.") || M_StringStartsWith(maptitle, "MAP") ||
            (toupper(maptitle[0]) == 'E' && isdigit(maptitle[1]) &&
            toupper(maptitle[2]) == 'M' && isdigit(maptitle[3])))
            {
                memmove(maptitle, maptitle + index, strlen(maptitle) - index + 1);
            ...
            else if(toupper(maptitle[0]) == 'L' && isdigit(maptitle[1]) &&
            isdigit(maptitle[2]))
            {
                memmove(maptitle, maptitle + index, strlen(maptitle) - index + 1);
    ...
    if((b = lumpnum + ML_NODES) < numlumps && (n = W_CacheLumpNum(b)) && W_LumpLength(b))
    {
        ...
        else if(!W_LumpLength(lumpnum + ML_SEGS) && W_LumpLength(lumpnum + ML_NODES) >= 12)
        {
            if(!memcmp(n, "XNOD", 4))
                ...
                // when nanobsp is integrated, we will build our own nodes in the case of
                // ZNOD and other unsupported node types, but for now error out
                I_Error("Zip-compressed ZDoom extended nodes not supported.");
        }
    }
...
void P_SetupLevel(int ep, int map)
{
    ...
    memset(&game.stats, 0, sizeof(gamestat_t));
    ...
    // Free level-related memory, but NOT PU_NANOBSP which is handled separately
    // based on samelevel and r_buildnodes logic below
    ...
    if((!numconsolestrings ||
       ...
       !M_StringStartsWith(console[numconsolestrings - 1].string, "Restarting ") && !autostart)) &&
    ((numconsolestrings == 1 ||
    (!M_StringStartsWith(console[numconsolestrings - 2].string, "map ") && !autostart))))
    {
        const char* mapinfolabel = trimwhitespace(P_GetLabel(ep, map));
    ...
    if(!samelevel)
    {
        if (nodeformat == NANOBSP)
            Z_FreeTags(PU_NANOBSP, PU_NANOBSP);
        else
        {
            free(segs);
            free(nodes);
    ...
    {
        if (r_buildnodes && nodeformat != NANOBSP)
        {
            free(segs);
            free(nodes);
            free(subsectors);
        }
        else if (!r_buildnodes && nodeformat == NANOBSP)
            Z_FreeTags(PU_NANOBSP, PU_NANOBSP);
    }

    canmodify = ((W_GetNumLumps(lumpname) == 1 || game.mission == pack_nerve) &&
    !FREEDOOM && !(game.mission == doom && *speciallumpname && (map == 4 || map == 8)));
    ...
    animatedtic = 0;
    animatedliquiddiff =
    2 * FRACUNIT + animatedliquiddiffs[M_BigRandom() & (ANIMATEDLIQUIDDIFFS - 1)];
    ...
    if (!samelevel) // node format should have already been determined otherwise
    {
        if (r_buildnodes)
            nodeformat = NANOBSP;
        else
    ...
    if (r_buildnodes)
    {
        if (!samelevel || nodeformat != NANOBSP)
        {
            nodeformat = NANOBSP;
            BSP_BuildNodes();
        }
    ...
    compat_corpsegibs =
    (compat_corpsegibs_global != -1 ? compat_corpsegibs_global :
                                      mapinfo[ep][map].compat_corpsegibs);
    compat_floormove =
    (compat_floormove_global != -1 ? compat_floormove_global : mapinfo[ep][map].compat_floormove);
    compat_light =
    (compat_light_global != -1 ? compat_light_global : mapinfo[ep][map].compat_light);
    compat_limitpain =
    (compat_limitpain_global != -1 ? compat_limitpain_global : mapinfo[ep][map].compat_limitpain);
    compat_nopassover =
    (compat_nopassover_global != -1 ? compat_nopassover_global :
                                      mapinfo[ep][map].compat_nopassover);
    compat_stairs =
    (compat_stairs_global != -1 ? compat_stairs_global : mapinfo[ep][map].compat_stairs);
    compat_useblocking =
    (compat_useblocking_global != -1 ? compat_useblocking_global :
                                       mapinfo[ep][map].compat_useblocking);
    compat_zombie =
    (compat_zombie_global != -1 ? compat_zombie_global : mapinfo[ep][map].compat_zombie);
    nograduallighting =
    (nograduallighting_global != -1 ? nograduallighting_global :
                                      mapinfo[ep][map].nograduallighting);

    if(game.mission == pack_tnt)
        compat_stairs = true;

    if(P_GetMapNoJump(ep, map) &&
    (keyboardjump || keyboardjump2 || mousejump != -1 || controllerjump))
    ...
    if(P_GetMapNoFreelook(ep, map) && canfreelook)
        C_Warning(1,
        "This %s has disabled use of the " BOLD("freelook") " CVAR and " BOLD("+freelook") " action.",
        (lumpinfo[MAPINFO]->wadfile->type == IWAD ? "IWAD" : "PWAD"));
}
...
static void P_ParseMapString(const char* string, int* map, int* ep)
{
    ...
    if(game.mode == commercial)
    {
        if(sscanf(buffer, "MAP0%1i", &value1) == 1 || sscanf(buffer, "MAP%2i", &value1) == 1)
            *map = value1;
    }
    else
    {
...
static bool P_ParseMapInfo(const char* scriptname)
{
    ...
    for(MAPINFO = numlumps - 1; MAPINFO >= 0; MAPINFO--)
        ...
        {
            const char* file = leafname(lumpinfo[MAPINFO]->wadfile->path);

            if(!D_IsFinalDOOMIWAD(file))
                break;
        }
    ...
    while(SC_GetString())
    {
        ...
        else if(SC_Compare("MAP"))
        {
            ...
            while(SC_GetString())
            {
                ...
                SC_Compare("CLUSTERDEF") || SC_Compare("LIQUID") || SC_Compare("NOLIQUID"))
                {
                    SC_UnGet();
                    break;
                }
                ...
                if((mcmdvalue = SC_MatchString(mapcmdnames)) >= 0)
                    ...
                    case MCMD_BOSSACTION:
                        ...
                        else
                        {
                            ...
                            for(i = 0; i < nummobjtypes; i++)
                            {
                                ...
                                char* name2 = (*mobjinfo[i].name2 ?
                                removenonalpha(mobjinfo[i].name2) :
                                NULL);
                                char* name3 = (*mobjinfo[i].name3 ?
                                removenonalpha(mobjinfo[i].name3) :
                                NULL);
                            ...
                            if(i < nummobjtypes)
                            {
                                ...
                                if(tag || special == S1_ExitLevel ||
                                special == S1_ExitLevel_GoesToSecretLevel ||
                                special == W1_ExitLevel || special == W1_ExitLevel_GoesToSecretLevel ||
                                ...
                                special <= G1_ExitToTheSecretMapAndResetInventory))
                                {
                                    ...
                                    info->bossactions =
                                    (bossaction_t*)I_Realloc(info->bossactions,
                    ...
                    case MCMD_INTERBACKDROP:
                        SC_MustGetString();
                        M_StringCopy(info->interbackdrop, sc_String,
                        sizeof(info->interbackdrop));
                        break;
                    ...
                    case MCMD_INTERTEXTSECRET:
                    {
                        ...
                        M_StringCopy(info->intertextsecret, buffer,
                        sizeof(info->intertextsecret));
                        break;
                    }
                    ...
                    case MCMD_NEXT:
                    {
                        ...
                        nextmap < 0 || nextmap > 99)
                        {
                            char* buffer = uppercase(sc_String);

                            if(game.mode == commercial)
                            {
                                if(sscanf(buffer, "MAP0%1i", &nextmap) != 1 &&
                                sscanf(buffer, "MAP%2i", &nextmap) != 1)
                                    continue;
                            }
                            else
                            {
    ...
    C_Output("%s line%s have been parsed in the " BOLD(
             "%s") " lump in the %s " BOLD("%s") ".",
    temp1, (sc_Line == 1 ? "" : "s"), temp2,
    (lumpinfo[MAPINFO]->wadfile->type == IWAD ? "IWAD" : "PWAD"),
    lumpinfo[MAPINFO]->wadfile->path);
    free(temp1);
    free(temp2);
...
{
    return (MAPINFO >= 0 && mapinfo[ep][map].author[0] ?
    mapinfo[ep][map].author :
    (*speciallumpname && (map == 4 || map == 8) ?
    s_AUTHOR_ROMERO :
    ""));
}
...
char* P_GetMapName(const int ep, const int map)
{
    return (MAPINFO >= 0 ?
    mapinfo[ep][map].name :
    (*speciallumpname && map == 4 ?
    s_HUSTR_E1M4B :
    (*speciallumpname && map == 8 ? s_HUSTR_E1M8B : "")));
}
...
void P_Init(void)
{
    ...
    if(!M_CheckParm("nomapinfo"))
    {
        ...
        if(nofreelook)
            C_Warning(1,
            "This %s has disabled use of the " BOLD(
            "freelook") " CVAR and " BOLD("+freelook") " action.",
            (lumpinfo[MAPINFO]->wadfile->type == IWAD ? "IWAD" : "PWAD"));
    }
    ...
    "Scroll wall with same tag using sidedef offsets when sector changes "
    "height";
    linespecials[Scroll_ScrollWallWithSameTagUsingSidedefOffsetsAcceleratesWhenSectorChangesHeight] =
    "Scroll wall with same tag using sidedef offsets (accelerates when sector "
    "changes height)";
}

...
#define ALIASCMDFORMAT                                                         \
    BOLDITALICS("alias")                                                       \
    " [[" BOLD("\"") "]" BOLDITALICS("command") "[" BOLD(";") " " BOLDITALICS( \
    "command") " ..." BOLD("\"") "]]"
#define BINDCMDFORMAT                                            \
    BOLDITALICS("control")                                       \
    " [" BOLDITALICS("+action") "|[" BOLD("\"") "]" BOLDITALICS( \
    "command") "[" BOLD(";") " " BOLDITALICS("command") " ..." BOLD("\"") "]]"
#define EXECCMDFORMAT BOLDITALICS("filename") "[" BOLD(".cfg") "]"
#define EXPLODECMDFORMAT BOLD("barrels") "|" BOLD("missiles")
#define GIVECMDFORMAT                                               \
    BOLD("ammo")                                                    \
    "|" BOLD("armor") "|" BOLD("health") "|" BOLD("keys") "|" BOLD( \
    "weapons") "|" BOLD("powerups") "|" BOLD("all") "|" BOLDITALICS("item")
#define IFCMDFORMAT                                                                           \
    BOLDITALICS("CVAR")                                                                       \
    " " BOLD("is") " " BOLDITALICS("value") " " BOLD("then") " [" BOLD("\"") "]" BOLDITALICS( \
    "command") "[" BOLD(";") " " BOLDITALICS("command") " ..." BOLD("\"") "]"
#define KILLCMDFORMAT                                                       \
    BOLD("player")                                                          \
    "|" BOLD("all") "|[[" BOLD("un") "]" BOLD("friendly") " ]" BOLDITALICS( \
    "monster")
#define LOADCMDFORMAT \
    BOLD("1")         \
    ".." BOLD("8") "|" BOLDITALICS("filename") "[" BOLD(".save") "]"
#define MAPCMDFORMAT1                                                   \
    BOLD("E")                                                           \
    BOLDITALICS("x")                                                    \
    BOLD("M")                                                           \
    BOLDITALICS("y")                                                    \
    "[" BOLD("B") "]|" BOLDITALICS("title") "|" BOLD("first") "|" BOLD( \
    "previous") "|" BOLD("next") "|" BOLD("last") "|" BOLD("random")
#define MAPCMDFORMAT2                                                         \
    BOLD("MAP")                                                               \
    BOLDITALICS("xy")                                                         \
    "|" BOLDITALICS("title") "|" BOLD("first") "|" BOLD("previous") "|" BOLD( \
    "next") "|" BOLD("last") "|" BOLD("random")
#define PLAYCMDFORMAT BOLDITALICS("soundeffect") "|" BOLDITALICS("music")
#define NAMECMDFORMAT \
    "[[" BOLD("un") "]" BOLD("friendly") " ]" BOLDITALICS("monster") " " BOLDITALICS("name")
#define PRINTCMDFORMAT \
    "[" BOLD("\x93") "]" BOLDITALICS("message") "[" BOLD("\x94") "]"
#define REMOVECMDFORMAT                                   \
    BOLD("decorations")                                   \
    "|" BOLD("corpses") "|" BOLD("bloodsplats") "|" BOLD( \
    "items") "|" BOLDITALICS("item") "|" BOLD("everything")
#define RESETCMDFORMAT BOLDITALICS("CVAR")
#define RESURRECTCMDFORMAT                                                  \
    BOLD("player")                                                          \
    "|" BOLD("all") "|[[" BOLD("un") "]" BOLD("friendly") " ]" BOLDITALICS( \
    "monster")
#define SAVECMDFORMAT \
    BOLD("1")         \
    ".." BOLD("8") "|" BOLDITALICS("filename") "[" BOLD(".save") "]"
#define SPAWNCMDFORMAT  \
    BOLDITALICS("item") \
    "|[[" BOLD("un") "]" BOLD("friendly") " ]" BOLDITALICS("monster")
#define TAKECMDFORMAT                                               \
    BOLD("ammo")                                                    \
    "|" BOLD("armor") "|" BOLD("health") "|" BOLD("keys") "|" BOLD( \
    "weapons") "|" BOLD("powerups") "|" BOLD("all") "|" BOLDITALICS("item")
#define TELEPORTCMDFORMAT \
    BOLDITALICS("x") " " BOLDITALICS("y") "[ " BOLDITALICS("z") "]"
...
#define WEAPONDESCRIPTION_SHAREWARE                             \
    "Your currently equipped weapon (" BOLD("fists") ", " BOLD( \
    "chainsaw") ", " BOLD("pistol") ", " BOLD("shotgun") ", " BOLD("chaingun") " or " BOLD("rocketlauncher") ")."
#define WEAPONDESCRIPTION_DOOM2                                                \
    "Your currently equipped weapon (" BOLD("fists") ", " BOLD(                \
    "chainsaw") ", " BOLD("pistol") ", " BOLD("shotgun") ", " BOLD("supershot" \
                                                                   "gun") ","  \
                                                                          " " BOLD("chaingun") ", " BOLD("rocketlauncher") ", " BOLD("plasmarifle") " or " BOLD("bfg9000") ")."
#define WEAPONDESCRIPTION_LEGACYOFRUST                                         \
    "Your currently equipped weapon (" BOLD("fists") ", " BOLD(                \
    "chainsaw") ", " BOLD("pistol") ", " BOLD("shotgun") ", " BOLD("supershot" \
                                                                   "gun") ","  \
                                                                          " " BOLD("chaingun") ", " BOLD("rocketlauncher") ", " BOLD("incinerator") " or " BOLD("calamityblade") ")."

#define DEADPLAYERWARNING1 \
    "You can't change this CVAR right now because you're dead."
#define DEADPLAYERWARNING2 \
    "%s can't change this CVAR right now because %s %s dead."
#define NEXTMAPWARNING1 \
    "You won't see the results of changing this CVAR until the next map."
#define NEXTMAPWARNING2 \
    "%s won't see the results of changing this CVAR until the next map."
#define NOGAMECCMDWARNING1 \
    "You can't use this CCMD right now because you're not playing a game."
#define NOGAMECCMDWARNING2 \
    "%s can't use this CCMD right now because %s %s playing a game."
#define NOGAMECVARWARNING1 \
    "You can't change this CVAR right now because you're not playing a game."
#define NOGAMECVARWARNING2 \
    "%s can't change this CVAR right now because %s %s playing a game."
#define NIGHTMAREWARNING1                                                 \
    "You can't change this CVAR right now because you're playing a game " \
    "in " ITALICS("Nightmare!")
#define NIGHTMAREWARNING2                                               \
    "%s can't change this CVAR right now because %s %s playing a game " \
    "in " ITALICS("Nightmare!")

#define INTEGERCVARWITHDEFAULT                                        \
    "It is currently set to " BOLD("%s") " and is " BOLD("%s") " by " \
                                                               "default."
#define INTEGERCVARWITHNODEFAULT "It is currently set to " BOLD("%s") "."
#define INTEGERCVARISDEFAULT \
    "It is currently set to its default of " BOLD("%s") "."
#define DEGREESCVARWITHDEFAULT                                \
    "It is currently set to " BOLD("%i") "\xB0 and is " BOLD( \
    "%i") "\xB0 by default."
#define DEGREESCVARISDEFAULT \
    "It is currently set to its default of " BOLD("%i") "\xB0."
#define PERCENTCVARWITHDEFAULT                              \
    "It is currently set to " BOLD("%s%%") " and is " BOLD( \
    "%s%%") " by default."
#define PERCENTCVARWITHNODEFAULT "It is currently set to " BOLD("%s%%") "."
#define PERCENTCVARISDEFAULT \
    "It is currently set to its default of " BOLD("%s%%") "."
#define STRINGCVARWITHDEFAULT                                 \
    "It is currently set to " BOLD("\"%s\"") " and is " BOLD( \
    "\"%s\"") " by default."
#define STRINGCVARWITHNODEFAULT "It is currently set to " BOLD("%s%s%s") "."
#define STRINGCVARISDEFAULT \
    "It is currently set to its default of " BOLD("\"%s\"") "."
#define TIMECVARWITHNODEFAULT1      \
    "It is currently set to " BOLD( \
    MONOSPACED("%02i") ":" MONOSPACED("%02i") "." MONOSPACED("%02i")) "."
#define TIMECVARWITHNODEFAULT2                                      \
    "It is currently set to " BOLD(MONOSPACED("%i") ":" MONOSPACED( \
    "%02i") ":" MONOSPACED("%02i") "." MONOSPACED("%02i")) "."
...
const control_t controls[] = { { "escape", keyboardcontrol, KEY_ESCAPE },
    { "F12", keyboardcontrol, KEY_F12 }, { "printscreen", keyboardcontrol, KEY_PRINTSCREEN },
    { "delete", keyboardcontrol, KEY_DELETE },
    { "insert", keyboardcontrol, KEY_INSERT }, { "tilde", keyboardcontrol, '`' },
    ...
    { "+", keyboardcontrol, '=' }, { "backspace", keyboardcontrol, KEY_BACKSPACE },
    ...
    { "]", keyboardcontrol, ']' }, { "\\", keyboardcontrol, '\\' },
    { "a", keyboardcontrol, 'a' }, { "s", keyboardcontrol, 's' },
    { "d", keyboardcontrol, 'd' }, { "f", keyboardcontrol, 'f' },
    { "g", keyboardcontrol, 'g' }, { "h", keyboardcontrol, 'h' },
    { "j", keyboardcontrol, 'j' }, { "k", keyboardcontrol, 'k' },
    { "l", keyboardcontrol, 'l' }, { ";", keyboardcontrol, ';' },
    { "'", keyboardcontrol, '\'' }, { "enter", keyboardcontrol, KEY_ENTER },
    { "shift", keyboardcontrol, KEY_SHIFT }, { "z", keyboardcontrol, 'z' },
    { "x", keyboardcontrol, 'x' }, { "c", keyboardcontrol, 'c' },
    { "v", keyboardcontrol, 'v' }, { "b", keyboardcontrol, 'b' },
    { "n", keyboardcontrol, 'n' }, { "m", keyboardcontrol, 'm' },
    { ",", keyboardcontrol, ',' }, { ".", keyboardcontrol, '.' },
    { "/", keyboardcontrol, '/' }, { "ctrl", keyboardcontrol, KEY_CTRL },
    { "alt", keyboardcontrol, KEY_ALT }, { "space", keyboardcontrol, KEY_SPACE },
    ...
    { "numpad0", keyboardcontrol, KEYP_0 }, { "numpad1", keyboardcontrol, KEYP_1 },
    { "numpad2", keyboardcontrol, KEYP_2 }, { "numpad3", keyboardcontrol, KEYP_3 },
    { "numpad4", keyboardcontrol, KEYP_4 }, { "numpad5", keyboardcontrol, KEYP_5 },
    { "numpad6", keyboardcontrol, KEYP_6 }, { "numpad7", keyboardcontrol, KEYP_7 },
    { "numpad8", keyboardcontrol, KEYP_8 }, { "numpad9", keyboardcontrol, KEYP_9 },
...
action_t actions[] = { { "+alwaysrun", true, false, alwaysrun_action_func, &keyboardalwaysrun,
                       &keyboardalwaysrun2, &mousealwaysrun, &controlleralwaysrun, NULL },
    { "+automap", false, false, automap_action_func, &keyboardautomap,
    &keyboardautomap2, &mouseautomap, &controllerautomap, NULL },
    { "+back", true, false, back_action_func, &keyboardback, &keyboardback2,
    &mouseback, &controllerback, NULL },
    { "+bfg9000", true, false, bfg9000_action_func, &keyboardbfg9000,
    &keyboardbfg90002, &mousebfg9000, &controllerbfg9000, NULL },
    { "+chaingun", true, false, chaingun_action_func, &keyboardchaingun,
    &keyboardchaingun2, &mousechaingun, &controllerchaingun, NULL },
    { "+chainsaw", true, false, chainsaw_action_func, &keyboardchainsaw,
    &keyboardchainsaw2, &mousechainsaw, &controllerchainsaw, NULL },
    { "+clearmark", true, true, clearmark_action_func, &keyboardclearmark,
    &keyboardclearmark2, &mouseclearmark, &controllerclearmark, NULL },
    { "+console", false, false, console_action_func, &keyboardconsole,
    &keyboardconsole2, &mouseconsole, &controllerconsole, NULL },
    { "+fire", true, false, fire_action_func, &keyboardfire, &keyboardfire2,
    &mousefire, &controllerfire, NULL },
    { "+fists", true, false, fists_action_func, &keyboardfists, &keyboardfists2,
    &mousefists, &controllerfists, NULL },
    { "+followmode", true, true, followmode_action_func, &keyboardfollowmode,
    &keyboardfollowmode2, &mousefollowmode, &controllerfollowmode, NULL },
    { "+forward", true, false, forward_action_func, &keyboardforward,
    &keyboardforward2, &mouseforward, &controllerforward, NULL },
    { "+freelook", true, false, NULL, &keyboardfreelook, &keyboardfreelook2,
    &mousefreelook, &controllerfreelook, NULL },
    { "+grid", true, true, grid_action_func, &keyboardgrid, &keyboardgrid2,
    &mousegrid, &controllergrid, NULL },
    { "+jump", true, false, jump_action_func, &keyboardjump, &keyboardjump2,
    &mousejump, &controllerjump, NULL },
    { "+left", true, false, left_action_func, &keyboardleft, &keyboardleft2,
    &mouseleft, &controllerleft, NULL },
    { "+mark", true, true, mark_action_func, &keyboardmark, &keyboardmark2,
    &mousemark, &controllermark, NULL },
    { "+maxzoom", true, true, maxzoom_action_func, &keyboardmaxzoom,
    &keyboardmaxzoom2, &mousemaxzoom, &controllermaxzoom, NULL },
    { "+menu", true, false, menu_action_func, &keyboardmenu, &keyboardmenu2,
    &mousemenu, &controllermenu, NULL },
    { "+nextweapon", true, false, nextweapon_action_func, &keyboardnextweapon,
    &keyboardnextweapon2, &mousenextweapon, &controllernextweapon, NULL },
    { "+path", true, false, path_action_func, &keyboardpath, &keyboardpath2,
    &mousepath, &controllerpath, NULL },
    { "+pistol", true, false, pistol_action_func, &keyboardpistol,
    &keyboardpistol2, &mousepistol, &controllerpistol, NULL },
    { "+plasmarifle", true, false, plasmarifle_action_func, &keyboardplasmarifle,
    &keyboardplasmarifle2, &mouseplasmarifle, &controllerplasmarifle, NULL },
    { "+prevweapon", true, false, prevweapon_action_func, &keyboardprevweapon,
    &keyboardprevweapon2, &mouseprevweapon, &controllerprevweapon, NULL },
    { "+right", true, false, right_action_func, &keyboardright, &keyboardright2,
    &mouseright, &controllerright, NULL },
    { "+rocketlauncher", true, false, rocketlauncher_action_func, &keyboardrocketlauncher,
    &keyboardrocketlauncher2, &mouserocketlauncher, &controllerrocketlauncher, NULL },
    { "+rotatemode", true, true, rotatemode_action_func, &keyboardrotatemode,
    &keyboardrotatemode2, &mouserotatemode, &controllerrotatemode, NULL },
    { "+run", true, false, NULL, &keyboardrun, &keyboardrun2, &mouserun, &controllerrun, NULL },
    { "+screenshot", false, false, screenshot_action_func, &keyboardscreenshot,
    &keyboardscreenshot2, &mousescreenshot, &controllerscreenshot, NULL },
    { "+shotgun", true, false, shotgun_action_func, &keyboardshotgun,
    &keyboardshotgun2, &mouseshotgun, &controllershotgun, NULL },
    { "+strafe", true, false, NULL, &keyboardstrafe, &keyboardstrafe2,
    &mousestrafe, &controllerstrafe, NULL },
    { "+strafeleft", true, false, strafeleft_action_func, &keyboardstrafeleft,
    &keyboardstrafeleft2, &mousestrafeleft, &controllerstrafeleft, NULL },
    { "+straferight", true, false, straferight_action_func, &keyboardstraferight,
    &keyboardstraferight2, &mousestraferight, &controllerstraferight, NULL },
    { "+supershotgun", true, false, supershotgun_action_func, &keyboardsupershotgun,
    &keyboardsupershotgun2, &mousesupershotgun, &controllersupershotgun, NULL },
    { "+use", true, false, use_action_func, &keyboarduse, &keyboarduse2,
    &mouseuse, &controlleruse, &controlleruse2 },
    { "+weapon1", true, false, weapon1_action_func, &keyboardweapon1,
    &keyboardweapon1_2, &mouseweapon1, &controllerweapon1, NULL },
    { "+weapon2", true, false, weapon2_action_func, &keyboardweapon2,
    &keyboardweapon2_2, &mouseweapon2, &controllerweapon2, NULL },
    { "+weapon3", true, false, weapon3_action_func, &keyboardweapon3,
    &keyboardweapon3_2, &mouseweapon3, &controllerweapon3, NULL },
    { "+weapon4", true, false, weapon4_action_func, &keyboardweapon4,
    &keyboardweapon4_2, &mouseweapon4, &controllerweapon4, NULL },
    { "+weapon5", true, false, weapon5_action_func, &keyboardweapon5,
    &keyboardweapon5_2, &mouseweapon5, &controllerweapon5, NULL },
    { "+weapon6", true, false, weapon6_action_func, &keyboardweapon6,
    &keyboardweapon6_2, &mouseweapon6, &controllerweapon6, NULL },
    { "+weapon7", true, false, weapon7_action_func, &keyboardweapon7,
    &keyboardweapon7_2, &mouseweapon7, &controllerweapon7, NULL },
    { "+zoomin", true, true, zoomin_action_func, &keyboardzoomin,
    &keyboardzoomin2, &mousezoomin, &controllerzoomin, NULL },
    { "+zoomout", true, true, zoomout_action_func, &keyboardzoomout,
    &keyboardzoomout2, &mousezoomout, &controllerzoomout, NULL },
...
static void r_scale_func2(char* cmd, char* parms);
...
static int C_LookupValueFromAlias(const char* text, const valuealiastype_t valuealiastype)
{
    for(int i = 0; *valuealiases[i].text; i++)
        if(valuealiastype == valuealiases[i].type &&
        M_StringCompare(text, valuealiases[i].text))
...
#define CCMD(name, alt1, alt2, cond, func, parms, form, desc)                  \
    { #name, #alt1, #alt2, cond, func, parms, CT_CCMD, CF_NONE, 0, NULL, 0, 0, \
        0, form, desc, 0, 0 }
#define CMD_CHEAT(name, parms)                                                \
    { #name, "", "", cheat_func1, NULL, parms, CT_CHEAT, CF_NONE, 0, NULL, 0, \
        0, 0, "", "", 0, 0 }
#define CVAR_BOOL(name, alt1, alt2, cond, func, flags, aliases, desc)       \
    { #name, #alt1, #alt2, cond, func, 1, CT_CVAR, (CF_BOOLEAN | flags), 0, \
        &name, aliases, false, true, "", desc, name##_default, 0 }
#define CVAR_INT(name, alt1, alt2, cond, func, flags, aliases, desc)        \
    { #name, #alt1, #alt2, cond, func, 1, CT_CVAR, (CF_INTEGER | flags), 0, \
        &name, aliases, name##_min, name##_max, "", desc, name##_default, 0 }
#define CVAR_FLOAT(name, alt1, alt2, cond, func, flags, desc)                    \
    { #name, #alt1, #alt2, cond, func, 1, CT_CVAR, (CF_FLOAT | flags), 0, &name, \
        0, (int)name##_min, (int)name##_max, "", desc, name##_default, 0 }
#define CVAR_FLOAT2(name, alt1, alt2, cond, func, flags, desc)            \
    { #name, #alt1, #alt2, cond, func, 1, CT_CVAR, (CF_FLOAT | flags), 0, \
        &name, 0, 0, 0, "", desc, name##_default, 0 }
#define CVAR_STR(name, alt1, alt2, cond, func, flags, length, desc)     \
    { #name, #alt1, #alt2, cond, func, 1, CT_CVAR, (CF_STRING | flags), \
        length, &name, 0, 0, 0, "", desc, 0, name##_default }
#define CVAR_TIME(name, alt1, alt2, cond, func, desc)                          \
    { #name, #alt1, #alt2, cond, func, 1, CT_CVAR, (CF_TIME | CF_READONLY), 0, \
        &name, 0, 0, 0, "", desc, 0, "" }
#define CVAR_OTHER(name, alt1, alt2, cond, func, desc)                       \
    { #name, #alt1, #alt2, cond, func, 1, CT_CVAR, CF_OTHER, 0, &name, 0, 0, \
        0, "", desc, 0, name##_default }
...
consolecmd_t consolecmds[] = {
    ...
    true,
    ALIASCMDFORMAT,
    "Creates an " BOLDITALICS(
    "alias") " that executes a string of " BOLDITALICS("commands") "."),
    CVAR_BOOL(alwaysrun, "", "", bool_cvars_func1, alwaysrun_func2, CF_NONE, BOOLVALUEALIAS, "Toggles you to always run instead of walk."),
    CVAR_INT(am_allmapcdwallcolor,
    am_allmapcdwallcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of unmapped lines in the automap indicating a change in a "
    "ceiling's height once you have a computer area map "
    "power-up (" BOLD("0") " to " BOLD("255") ")."),
    CVAR_INT(am_allmapfdwallcolor,
    am_allmapfdwallcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of unmapped lines in the automap indicating a change in a "
    "floor's height once you have a computer area map "
    "power-up (" BOLD("0") " to " BOLD("255") ")."),
    CVAR_INT(am_allmapwallcolor,
    am_allmapwallcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of unmapped solid walls in the automap once you have a computer "
    "area map power-up (" BOLD("0") " to " BOLD("255") ")."),
    CVAR_BOOL(am_antialiasing, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles anti-aliasing in the automap."),
    CVAR_BOOL(am_author, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles displaying the map's author (if available) in the automap."),
    CVAR_INT(am_backcolor,
    am_backcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of the automap's background (" BOLD("0") " to " BOLD(
    "255") ")."),
    CVAR_INT(am_bloodsplatcolor,
    am_bloodsplatcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of blood splats in the automap when you cheat (" BOLD(
    "0") " to " BOLD("255") ")."),
    CVAR_INT(am_bluedoorcolor,
    am_bluedoorcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of doors in the automap unlocked with a blue keycard or skull "
    "key (" BOLD("0") " to " BOLD("255") ")."),
    CVAR_INT(am_bluekeycolor,
    am_bluekeycolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of blue keycards and skull keys in the automap when you cheat "
    "(" BOLD("0") " to " BOLD("255") ")."),
    CVAR_INT(am_cdwallcolor,
    am_cdwallcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of lines in the automap indicating a change in a ceiling's "
    "height (" BOLD("0") " to " BOLD("255") ")."),
    CVAR_INT(am_corpsecolor,
    am_corpsecolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of corpses in the automap when you cheat (" BOLD(
    "0") " to " BOLD("255") ")."),
    CVAR_BOOL(am_correctaspectratio, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles aspect ratio correction in the automap."),
    CVAR_INT(am_crosshaircolor,
    am_crosshaircolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of the crosshair in the automap when follow mode is off (" BOLD(
    "0") " to " BOLD("255") ")."),
    CVAR_BOOL(am_dynamic, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles dynamically updating the automap while it is open."),
    CVAR_INT(am_fdwallcolor,
    am_fdwallcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of lines in the automap indicating a change in a floor's height "
    "(" BOLD("0") " to " BOLD("255") ")."),
    CVAR_BOOL(am_followmode, "", "", game_cvar_func1, am_followmode_func2, CF_MAPRESET, BOOLVALUEALIAS, "Toggles follow mode in the automap."),
    CVAR_BOOL(am_grid, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the grid in the automap."),
    CVAR_INT(am_gridcolor,
    am_gridcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    ...
    CVAR_BOOL(am_mousepanning, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles panning using the mouse in the automap when follow mode is off."),
    CVAR_BOOL(am_path, "", "", bool_cvars_func1, am_path_func2, CF_NONE, BOOLVALUEALIAS, "Toggles your path in the automap."),
    CVAR_INT(am_pathcolor,
    am_pathcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of your path in the automap (" BOLD("0") " to " BOLD(
    "255") ")."),
    CVAR_INT(am_pathlength,
    "",
    "",
    am_pathlength_func1,
    am_pathlength_func2,
    ...
    "The length of your path in the automap (" BOLD("short") ", " BOLD(
    "medium") ", " BOLD("long") " or " BOLD("endless") ")."),
    CVAR_INT(am_playercolor,
    am_playercolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of your arrow in the automap (" BOLD("0") " to " BOLD(
    "255") ")."),
    CVAR_BOOL(am_playerstats, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles your stats in the automap."),
    CVAR_INT(am_playerstatscolor,
    am_playerstatscolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of your stats in the automap (" BOLD("0") " to " BOLD(
    "255") ")."),
    CVAR_INT(am_reddoorcolor,
    am_reddoorcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of doors in the automap unlocked with a red keycard or skull "
    "key (" BOLD("0") " to " BOLD("255") ")."),
    CVAR_INT(am_redkeycolor,
    am_redkeycolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of red keycards and skull keys in the automap when you cheat "
    "(" BOLD("0") " to " BOLD("255") ")."),
    CVAR_BOOL(am_rotatemode, "", "", bool_cvars_func1, am_rotatemode_func2, CF_NONE, BOOLVALUEALIAS, "Toggles rotate mode in the automap."),
    ...
    CF_NONE,
    NOVALUEALIAS,
    "The color of teleporter lines in the automap (" BOLD("0") " to " BOLD(
    "255") ")."),
    CVAR_INT(am_thingcolor,
    am_thingcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    ...
    CF_NONE,
    NOVALUEALIAS,
    "The color of lines in the automap indicating no change in height (" BOLD(
    "0") " to " BOLD("255") ")."),
    CVAR_INT(am_wallcolor,
    am_wallcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of solid walls in the automap (" BOLD("0") " to " BOLD(
    "255") ")."),
    CVAR_INT(am_yellowdoorcolor,
    am_yellowdoorcolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of doors in the automap unlocked with a yellow keycard or skull "
    "key (" BOLD("0") " to " BOLD("255") ")."),
    CVAR_INT(am_yellowkeycolor,
    am_yellowkeycolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The color of yellow keycards and skull keys in the automap when you cheat "
    "(" BOLD("0") " to " BOLD("255") ")."),
    CVAR_INT(ammo, "", "", player_cvars_func1, player_cvars_func2, CF_NONE, NOVALUEALIAS, "The amount of ammo you have for your currently equipped weapon."),
    CVAR_BOOL(animatedstats, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles animating your health, armor and ammo in the status bar and widescreen HUD when they change."),
    CVAR_INT(armor,
    armour,
    "",
    player_cvars_func1,
    ...
    CF_NONE,
    ARMORTYPEVALUEALIAS,
    "Your armor type (" BOLD("none") ", " BOLD("green") " or " BOLD(
    "blue") ")."),
    CVAR_BOOL(autoaim, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles vertical autoaiming as you fire your weapon while using freelook."),
    CVAR_BOOL(autoload, "", "", bool_cvars_func1, bool_cvars_func2, CF_PISTOLSTART, BOOLVALUEALIAS, "Toggles automatically loading the last savegame when you die."),
    CVAR_BOOL(autosave, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles automatically saving the game at the start of each map."),
    CVAR_BOOL(autoswitch, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles automatically switching your weapon when picking up a new one or better ammo."),
    CVAR_BOOL(autotilt, "", "", bool_cvars_func1, autotilt_func2, CF_NONE, BOOLVALUEALIAS, "Toggles automatically tilting your view when going up or down a flight of stairs."),
    CVAR_BOOL(autouse, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles automatically using doors and switches in front of you."),
    CCMD(bind,
    "",
    "",
    null_func1,
    ...
    true,
    BINDCMDFORMAT,
    "Binds an " BOLDITALICS("+action") " or a string of " BOLDITALICS(
    "commands") " to a " BOLDITALICS("control") "."),
    CCMD(bindlist, "", "", null_func1, bindlist_func2, false, "", "Lists all controls bound to an " BOLDITALICS("+action") " or a string of commands."),
    CVAR_BOOL(centerweapon, centreweapon, "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles centering your weapon when fired."),
    CCMD(clear, "", "", null_func1, clear_func2, false, "", "Clears the console."),
    CCMD(cmdlist, "", ccmdlist, null_func1, cmdlist_func2, true, "[" BOLDITALICS("searchstring") "]", "Lists all console commands."),
    CCMD(condump, "", "", condump_func1, condump_func2, true, "[" BOLDITALICS("filename") "[" BOLD(".txt") "]]", "Dumps the contents of the console to a file."),
    CVAR_INT(con_edgecolor,
    con_edgecolour,
    "",
    int_cvars_func1,
    int_cvars_func2,
    CF_NONE,
    EDGECOLORVALUEALIAS,
    "The color of console's bottom edge (" BOLD("auto") ", or " BOLD(
    "0") " to " BOLD("255") ")."),
    CVAR_BOOL(con_timestampformat,
    "",
    "",
    con_timestampformat_func1,
    con_timestampformat_func2,
    CF_NONE,
    TIMESTAMPVALUEALIAS,
    "The format of the timestamps in the console (" BOLD(
    "standard") " or " BOLD("military") ")."),
    CVAR_BOOL(con_timestamps, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles timestamps in the console."),
    CVAR_INT(con_warninglevel,
    "",
    "",
    int_cvars_func1,
    int_cvars_func2,
    ...
    CF_NONE,
    CROSSHAIRVALUEALIAS,
    "Toggles your crosshair (" BOLD("none") ", " BOLD("cross") ", " BOLD(
    "an"
    "gl"
    "e") ", " BOLD("dot") ", " BOLD("bigcross") ", " BOLD("circle") ","
                                                                    " " BOLD(
                                                                    "bigcircle") ", " BOLD("chevro"
                                                                                           "n") ","
                                                                                                " " BOLD("chevrons") " or " BOLD(
                                                                                                "arcs") ")."),
    CVAR_INT(crosshaircolor,
    crosshaircolour,
    "",
    int_cvars_func1,
    color_cvars_func2,
    ...
    CCMD(cvarlist, "", "", null_func1, cvarlist_func2, true, "[" BOLDITALICS("searchstring") "]", "Lists all console variables."),
    CCMD(endgame, "", "", null_func1, endgame_func2, false, "", "Ends the game."),
    CVAR_BOOL(english,
    "",
    "",
    english_func1,
    ...
    CF_NONE,
    ENGLISHVALUEALIAS,
    "Toggles the use of American or British English (" BOLD(
    "american") " or " BOLD("british") ")."),
    CVAR_INT(episode,
    "",
    "",
    int_cvars_func1,
    ...
    CF_NONE,
    NOVALUEALIAS,
    "The currently selected " ITALICS("DOOM") " episode in the menu (" BOLD(
    "1") " to " BOLD("6") ")."),
    CCMD(exec, "", "", null_func1, exec_func2, true, EXECCMDFORMAT, "Executes all commands in a file."),
    CCMD(exitmap, "", "", alive_func1, exitmap_func2, false, "", "Exits the current map."),
    CVAR_INT(expansion,
    "",
    "",
    int_cvars_func1,
    ...
    CF_NONE,
    NOVALUEALIAS,
    "The currently selected " ITALICS(
    "DOOM II") " expansion in the menu (" BOLD("1") " or " BOLD("2") ")."),
    CCMD(explode,
    "",
    "",
    kill_func1,
    ...
    CF_NONE,
    NOVALUEALIAS,
    "The color of your face's background in the status bar (" BOLD(
    "0") " to " BOLD("255") ")."),
    CVAR_BOOL(fade, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles a fading effect when transitioning between some screens."),
    CCMD(fastmonsters, "", "", nightmare_func1, fastmonsters_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles fast monsters."),
    CVAR_BOOL(flashkeys, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles flashing the keycard or skull key that is needed when you try to open a locked door."),
    CVAR_BOOL(freelook, mouselook, "", bool_cvars_func1, freelook_func2, CF_NONE, BOOLVALUEALIAS, "Toggles freely looking up and down using the mouse or a controller."),
    CCMD(freeze, "", "", alive_func1, freeze_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles freeze mode."),
    CVAR_TIME(game.time, "", "", null_func1, time_cvars_func2, "The amount of time " ITALICS(DOOMRETRO_NAME) " has been running."),
    CCMD(give,
    "",
    "",
    give_func1,
    ...
    true,
    GIVECMDFORMAT,
    "Gives " BOLD("ammo") ", " BOLD("armor") ", " BOLD("health") ", " BOLD(
    "key"
    "s") ", " BOLD("weapons") ", " BOLD("powerups") ", or " BOLD("all") " or "
                                                                        "certai"
                                                                        "n"
                                                                        " " BOLDITALICS("items") " to you."),
    CCMD(god, "", "", alive_func1, god_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles god mode."),
    CVAR_BOOL(groupmessages, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the grouping of identical player messages."),
    CVAR_INT(health,
    "",
    "",
    player_cvars_func1,
    ...
    CMD_CHEAT(idbeholda, false), CMD_CHEAT(idbeholdi, false),
    CMD_CHEAT(idbeholdl, false), CMD_CHEAT(idbeholdr, false), CMD_CHEAT(idbeholds, false),
    CMD_CHEAT(idbeholdv, false), CMD_CHEAT(idchoppers, false),
    CMD_CHEAT(idclev, true), CMD_CHEAT(idclip, false), CMD_CHEAT(iddqd, false),
    CMD_CHEAT(iddt, false), CMD_CHEAT(idfa, false), CMD_CHEAT(idkfa, false),
    CMD_CHEAT(idmus, true), CMD_CHEAT(idmypos, false), CMD_CHEAT(idspispopd, false),
    CCMD(if,
    "",
    "",
    null_func1,
    ...
    true,
    IFCMDFORMAT,
    "Executes a string of " BOLDITALICS("commands") " if a " BOLDITALICS(
    "CVAR") " equals a " BOLDITALICS("value") "."),
    CVAR_BOOL(infighting, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles infighting amongst monsters once you die."),
    CCMD(infiniteammo,
    "",
    "",
    game_ccmd_func1,
    ...
    CVAR_BOOL(infiniteheight, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles giving you and everything else in the current map infinite height."),
    CVAR_BOOL(joy_analog, joy_analogue, "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles whether movement using a controller's thumbsticks is analog or digital."),
    CVAR_FLOAT(joy_deadzone_left,
    "",
    "",
    joy_deadzone_cvars_func1,
    joy_deadzone_cvars_func2,
    CF_PERCENT,
    "The dead zone of a controller's left thumbstick (" BOLD("0%") " to " BOLD("30%") ")."),
    CVAR_FLOAT(joy_deadzone_right,
    "",
    "",
    joy_deadzone_cvars_func1,
    joy_deadzone_cvars_func2,
    ...
    CVAR_BOOL(joy_invertyaxis, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles inverting the vertical axis of a controller's right thumbstick when you look up or down."),
    CVAR_INT(joy_rumble_barrels,
    "",
    "",
    int_cvars_func1,
    int_cvars_func2,
    CF_PERCENT,
    NOVALUEALIAS,
    "The amount a controller rumbles when you are near an exploding barrel "
    "(" BOLD("0%") " to " BOLD("200%") ")."),
    CVAR_INT(joy_rumble_damage,
    "",
    "",
    int_cvars_func1,
    int_cvars_func2,
    CF_PERCENT,
    NOVALUEALIAS,
    "The amount a controller rumbles when you take damage (" BOLD(
    "0%") " to " BOLD("200%") ")."),
    CVAR_BOOL(joy_rumble_fall, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles rumbling a controller when you land after a fall."),
    CVAR_BOOL(joy_rumble_pickup, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles rumbling a controller when you pick something up."),
    CVAR_INT(joy_rumble_weapons,
    "",
    "",
    int_cvars_func1,
    int_cvars_func2,
    CF_PERCENT,
    NOVALUEALIAS,
    "The amount a controller rumbles when you fire your weapon (" BOLD(
    "0%") " to " BOLD("200%") ")."),
    CVAR_FLOAT(joy_sensitivity_horizontal,
    "",
    "",
    float_cvars_func1,
    joy_sensitivity_cvars_func2,
    CF_NONE,
    "The horizontal sensitivity of a controller's thumbsticks (" BOLD(
    "0") " to " BOLD("128") ")."),
    CVAR_FLOAT(joy_sensitivity_vertical,
    "",
    "",
    float_cvars_func1,
    joy_sensitivity_cvars_func2,
    CF_NONE,
    "The vertical sensitivity of a controller's thumbsticks (" BOLD(
    "0") " to " BOLD("128") ")."),
    CVAR_BOOL(joy_swapthumbsticks, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles swapping a controller's left and right thumbsticks."),
    CVAR_INT(joy_thumbsticks,
    "",
    "",
    int_cvars_func1,
    int_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The number of thumbsticks on a controller (" BOLD("1") " or " BOLD(
    "2") ")."),
    CCMD(kill,
    "",
    "",
    ...
    true,
    KILLCMDFORMAT,
    "Kills the " BOLD("player") ", " BOLD(
    "all") " monsters or a type of " BOLDITALICS("monster") "."),
    CCMD(license, licence, "", null_func1, license_func2, false, "", "Shows the " ITALICS(DOOMRETRO_LICENSE ".")),
    CCMD(load, "", "", null_func1, load_func2, true, LOADCMDFORMAT, "Loads a savegame."),
    CVAR_BOOL(m_acceleration, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the acceleration of mouse movement."),
    CVAR_BOOL(m_invertyaxis, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles inverting the mouse's vertical axis when using freelook."),
    CVAR_BOOL(m_novertical, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles no vertical movement of the mouse."),
    CVAR_BOOL(m_pointer, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the mouse pointer in the menu."),
    CVAR_FLOAT(m_sensitivity,
    "",
    "",
    float_cvars_func1,
    float_cvars_func2,
    ...
    CCMD(map, "", warp, map_func1, map_func2, true, MAPCMDFORMAT1, "Warps you to another map."),
    CCMD(maplist, "", "", null_func1, maplist_func2, false, "", "Lists all of the maps available to play."),
    CCMD(mapstats, "", "", null_func1, mapstats_func2, false, "", "Shows stats about the current map."),
    CVAR_TIME(game.stats.maptime, "", "", null_func1, time_cvars_func2, "The amount of time you have been in the current map."),
    CVAR_BOOL(melt, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles a melting effect when transitioning between some screens."),
    CVAR_BOOL(menuhighlight, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the highlighting of items selected in the menu."),
    CVAR_BOOL(menushadow, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles shadows cast by items in the menu."),
    CVAR_BOOL(menuspin, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles spinning your view in the menu's background."),
    CVAR_BOOL(messages, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles displaying player messages at the top of the screen."),
    CVAR_INT(movebob,
    "",
    "",
    int_cvars_func1,
    ...
    CF_PERCENT,
    NOVALUEALIAS,
    "The amount your view bobs as you move (" BOLD("0%") " to " BOLD(
    "100%") ")."),
    CCMD(name, "", "", name_func1, name_func2, true, NAMECMDFORMAT, "Gives a " BOLDITALICS("name") " to the " BOLDITALICS("monster") " nearest to you."),
    CVAR_BOOL(negativehealth,
    "",
    "",
    bool_cvars_func1,
    bool_cvars_func2,
    CF_NONE,
    BOOLVALUEALIAS,
    "Toggles allowing your health to be less than " BOLD(
    "0%") " when you die."),
    CCMD(newgame, "", "", null_func1, newgame_func2, true, "", "Starts a new game."),
    CCMD(noclip, "", "", game_ccmd_func1, noclip_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles no clipping mode."),
    CCMD(nomonsters, "", "", null_func1, nomonsters_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles the presence of monsters in maps."),
    CCMD(notarget, "", "", game_ccmd_func1, notarget_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles monsters not targeting you."),
    CVAR_BOOL(obituaries, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles displaying obituaries when you or monsters are killed."),
    CCMD(pistolstart, "", "", null_func1, pistolstart_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles you starting each map with 100% health, no armor, and only your pistol with 50 bullets."),
    CCMD(play, "", "", play_func1, play_func2, true, PLAYCMDFORMAT, "Plays a " BOLDITALICS("sound effect") " or " BOLDITALICS("music") " lump."),
    CVAR_INT(playergender,
    "",
    "",
    playergender_func1,
    playergender_func2,
    ...
    CVAR_STR(playername, "", "", null_func1, str_cvars_func2, CF_NONE, 16, "Your name."),
    CCMD(playerstats, "", "", null_func1, playerstats_func2, false, "", "Shows stats about you."),
    CCMD(print, "", "", game_ccmd_func1, print_func2, true, PRINTCMDFORMAT, "Prints a player \"" BOLDITALICS("message") "\"."),
    CCMD(quit, "", exit, null_func1, quit_func2, false, "", "Quits to the " DESKTOP "."),
    CVAR_BOOL(r_althud, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles an alternate heads-up display when in widescreen."),
    CVAR_BOOL(r_althudfont, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles displaying messages in an alternate font when the alternate HUD is displayed."),
    CVAR_BOOL(r_antialiasing, "", "", bool_cvars_func1, r_antialiasing_func2, CF_NONE, BOOLVALUEALIAS, "Toggles anti-aliasing when the graphic detail is low."),
    CVAR_INT(r_berserkeffect,
    "",
    "",
    int_cvars_func1,
    int_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The intensity of the red effect when you have a berserk power-up and your "
    "fists equipped (" BOLD("0") " to " BOLD("8") ")."),
    CVAR_INT(r_blood,
    "",
    "",
    r_blood_func1,
    ...
    CF_NONE,
    BLOODVALUEALIAS,
    "The colors of the blood spilled by you and monsters (" BOLD(
    "all") ", " BOLD("none") ", " BOLD("red") ", " BOLD("green") " or"
                                                                 " " BOLD("nofu"
                                                                          "zz") ")."),
    CVAR_BOOL(r_blood_gibs, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles spawning blood when monsters are gibbed."),
    CVAR_BOOL(r_blood_melee, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles spawning blood during melee attacks from monsters."),
    CVAR_INT(r_bloodsplats_max,
    "",
    "",
    int_cvars_func1,
    int_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The maximum number of blood splats allowed in each map (" BOLD(
    "0") " to " BOLD("1,048,576") ")."),
    CVAR_INT(r_bloodsplats_total, "", "", int_cvars_func1, int_cvars_func2, CF_READONLY, NOVALUEALIAS, "The total number of blood splats in the current map."),
    CVAR_BOOL(r_bloodsplats_translucency,
    "",
    "",
    bool_cvars_func1,
    r_bloodsplats_translucency_func2,
    CF_NONE,
    BOOLVALUEALIAS,
    "Toggles the translucency of blood splats."),
    CVAR_BOOL(r_brightmaps, "", "", bool_cvars_func1, r_brightmaps_func2, CF_NONE, BOOLVALUEALIAS, "Toggles brightmaps on some wall textures."),
    CVAR_BOOL(r_buildnodes, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles building nodes at runtime via NanoBSP."),
    CVAR_BOOL(r_corpses_color, r_corpses_colour, "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles randomly colored marine corpses."),
    CVAR_BOOL(r_corpses_gib, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles some corpses gibbing when barrels or rockets explode nearby."),
    CVAR_BOOL(r_corpses_mirrored, "", "", bool_cvars_func1, r_corpses_mirrored_func2, CF_NONE, BOOLVALUEALIAS, "Toggles randomly mirrored corpses."),
    CVAR_BOOL(r_corpses_moreblood, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles blood splats spawned around corpses at the start of each map."),
    CVAR_BOOL(r_corpses_nudge, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles corpses and the items they drop being nudged when walked over."),
    CVAR_BOOL(r_corpses_slide, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles corpses sliding when barrels or rockets explode nearby."),
    CVAR_BOOL(r_corpses_smearblood, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles corpses leaving blood splats behind as they slide."),
    CVAR_BOOL(r_damageeffect, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the red effect when you take damage."),
    CVAR_BOOL(r_detail,
    "",
    "",
    r_detail_func1,
    ...
    CVAR_BOOL(r_diskicon, r_discicon, "", bool_cvars_func1, r_diskicon_func2, CF_NONE, BOOLVALUEALIAS, "Toggles showing a disk icon when loading and saving."),
    CVAR_BOOL(r_ditheredlighting, "", "", bool_cvars_func1, r_ditheredlighting_func2, CF_NONE, BOOLVALUEALIAS, "Toggles dithered lighting cast on textures and sprites."),
    CVAR_INT(r_extralighting,
    "",
    "",
    int_cvars_func1,
    int_cvars_func2,
    CF_PERCENT,
    NOVALUEALIAS,
    "The extra lighting applied to the current map (" BOLD("0%") " to " BOLD(
    "100%") ")."),
    CVAR_BOOL(r_fixmaperrors,
    "",
    "",
    bool_cvars_func1,
    r_fixmaperrors_func2,
    CF_NEXTMAP,
    BOOLVALUEALIAS,
    "Toggles fixing many mapping errors in the official " ITALICS(
    "DOOM") " and " ITALICS("DOOM II") " WADs."),
    CVAR_BOOL(r_fixspriteoffsets, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles fixing sprite offsets."),
    CVAR_BOOL(r_floatbob, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles some power-ups bobbing up and down."),
    CVAR_INT(r_fov,
    "",
    "",
    int_cvars_func1,
    ...
    r_gamma_func2,
    CF_NONE,
    "The screen's gamma correction level (" BOLD("off") ", or " BOLD(
    "0.50") " to " BOLD("2.0") ")."),
    CVAR_BOOL(r_graduallighting, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles gradual lighting under doors and crushing sectors."),
    CVAR_BOOL(r_homindicator, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles a flashing \"Hall Of Mirrors\" indicator."),
    CVAR_BOOL(r_hud, "", "", bool_cvars_func1, r_hud_func2, CF_NONE, BOOLVALUEALIAS, "Toggles a heads-up display when in widescreen."),
    CVAR_BOOL(r_hud_translucency, "", "", bool_cvars_func1, r_hud_translucency_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the translucency of the heads-up display when in widescreen."),
    CVAR_BOOL(r_linearskies, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles horizontally linear skies."),
    CVAR_BOOL(r_liquid_bob, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the bobbing of liquid sectors."),
    CVAR_BOOL(r_liquid_bobsprites, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the bobbing of sprites in liquid sectors."),
    CVAR_BOOL(r_liquid_clipsprites, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles clipping the bottom of sprites in liquid sectors."),
    CVAR_BOOL(r_liquid_current, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles a slight current being applied to liquid sectors."),
    CVAR_BOOL(r_liquid_lowerview, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles lowering your view when you are in a liquid sector."),
    CVAR_BOOL(r_liquid_swirl, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the swirl of liquid sectors."),
    CVAR_OTHER(r_lowpixelsize,
    "",
    "",
    null_func1,
    r_lowpixelsize_func2,
    "The size of each pixel when the graphic detail is low (" BOLD(
    ITALICS("width") "\xD7" ITALICS("height")) ")."),
    CVAR_BOOL(r_mirroredweapons, "", "", bool_cvars_func1, r_mirroredweapons_func2, CF_NONE, BOOLVALUEALIAS, "Toggles randomly mirroring the weapons dropped by monsters."),
    CVAR_BOOL(r_percolumnlighting, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles per-column lighting cast on monsters."),
    CVAR_BOOL(r_pickupeffect, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the gold effect when you pick something up."),
    CVAR_BOOL(r_playersprites, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles showing your weapon."),
    CVAR_BOOL(r_radsuiteffect, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the green effect while you wear a radiation shielding suit power-up."),
    CVAR_BOOL(r_randomstartframes, "", "", bool_cvars_func1, r_randomstartframes_func2, CF_NEXTMAP, BOOLVALUEALIAS, "Toggles randomizing the start frames of certain sprites."),
    CVAR_BOOL(r_rockettrails, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the trail of smoke behind rockets fired by you and cyberdemons."),
    CVAR_BOOL(r_rockettrails_translucency,
    "",
    "",
    bool_cvars_func1,
    r_rockettrails_translucency_func2,
    CF_NONE,
    BOOLVALUEALIAS,
    "Toggles the translucency of the trail of smoke behind rockets fired by "
    "you and cyberdemons."),
    CVAR_INT(r_scale,
    "",
    "",
    ...
    CF_NONE,
    NOVALUEALIAS,
    "The render scale factor (" BOLD("1") " to " BOLD("6") ")."),
    CVAR_INT(r_screensize,
    "",
    "",
    int_cvars_func1,
    r_screensize_func2,
    ...
    CVAR_BOOL(r_shadows, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles sprites casting shadows."),
    CVAR_BOOL(r_shadows_translucency, "", "", bool_cvars_func1, r_shadows_translucency_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the translucency of shadows cast by sprites."),
    CVAR_BOOL(r_shake_barrels, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles shaking your view when you are near an exploding barrel."),
    CVAR_BOOL(r_shake_berserk, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles shaking your view when you have a berserk power-up and punch something."),
    CVAR_BOOL(r_shake_damage, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles shaking the screen when you take damage."),
    CVAR_BOOL(r_sprites_translucency, "", "", bool_cvars_func1, r_sprites_translucency_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the translucency of certain sprites."),
    CVAR_BOOL(r_textures, "", "", bool_cvars_func1, r_textures_func2, CF_NONE, BOOLVALUEALIAS, "Toggles showing all textures."),
    CVAR_BOOL(r_textures_translucency,
    "",
    "",
    bool_cvars_func1,
    r_textures_translucency_func2,
    CF_NONE,
    BOOLVALUEALIAS,
    "Toggles the translucency of certain " ITALICS(
    "BOOM-") "compatible wall textures."),
    CCMD(readme, "", "", null_func1, readme_func2, false, "", "Shows the accompanying readme file for the currently loaded PWAD."),
    CCMD(regenhealth, "", "", game_ccmd_func1, regenhealth_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles regenerating your health by 1% every second when it's less than 100%."),
    CCMD(releasenotes,
    "",
    "",
    null_func1,
    ...
    true,
    REMOVECMDFORMAT,
    "Removes all " BOLD("decorations") ", " BOLD("corpses") ", " BOLD(
    "blood"
    "splat"
    "s") ", " BOLD("items") ", certain " BOLDITALICS("item"
                                                     "s") ", or " BOLD("everyth"
                                                                       "ing") "."),
    CCMD(reset, "", "", null_func1, reset_func2, true, RESETCMDFORMAT, "Resets a " BOLDITALICS("CVAR") " to its default."),
    CCMD(resetall, "", "", null_func1, resetall_func2, false, "", "Resets all CVARs and bound controls to their defaults."),
    CCMD(respawnitems, "", "", null_func1, respawnitems_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles respawning items."),
    CCMD(respawnmonsters, "", "", nightmare_func1, respawnmonsters_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles respawning monsters."),
    CCMD(restartmap, "", "", game_ccmd_func1, restartmap_func2, false, "", "Restarts the current map."),
    CCMD(resurrect,
    "",
    "",
    resurrect_func1,
    ...
    true,
    RESURRECTCMDFORMAT,
    "Resurrects the " BOLD("player") ", " BOLD(
    "all") " monsters, or a type of " BOLDITALICS("monster") "."),
    ...
    CF_NONE,
    NOVALUEALIAS,
    "The number of sound effects that can be played at the same time (" BOLD(
    "8") " to " BOLD("64") ")."),
    CVAR_BOOL(s_fullsfx, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles playing sound effects in full as things are removed from the map."),
    CVAR_BOOL(s_lowermenumusic, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles lowering the music's volume in the menu and console."),
    CVAR_BOOL(s_musicinbackground,
    "",
    "",
    bool_cvars_func1,
    bool_cvars_func2,
    CF_NONE,
    BOOLVALUEALIAS,
    "Toggles continuing to play music in the background when " ITALICS(
    DOOMRETRO_NAME) "'s window loses focus."),
    CVAR_INT(s_musicvolume,
    "",
    "",
    s_volume_cvars_func1,
    s_volume_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The volume level of music (" BOLD("0") " to " BOLD("31") ")."),
    CVAR_BOOL(s_randommusic, "", "", bool_cvars_func1, s_randommusic_func2, CF_NONE, BOOLVALUEALIAS, "Toggles randomizing the music for each map."),
    CVAR_INT(s_sfxvolume,
    "",
    "",
    s_volume_cvars_func1,
    s_volume_cvars_func2,
    CF_NONE,
    NOVALUEALIAS,
    "The volume level of sound effects (" BOLD("0") " to " BOLD("31") ")."),
    CVAR_BOOL(s_stereo, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles playing sound effects in mono or stereo."),
    CCMD(save, "", "", alive_func1, save_func2, true, SAVECMDFORMAT, "Saves the game."),
    CVAR_INT(savegame,
    "",
    "",
    int_cvars_func1,
    ...
    CVAR_BOOL(secretmessages, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles displaying a message when you find a secret."),
    CVAR_INT(skilllevel,
    "",
    "",
    int_cvars_func1,
    ...
    true,
    SPAWNCMDFORMAT,
    "Spawns an " BOLDITALICS("item") " or " BOLDITALICS(
    ...
    CF_PERCENT,
    NOVALUEALIAS,
    "The amount your view and weapon bob up and down when you stand still "
    "(" BOLD("0%") " to " BOLD("100%") ")."),
    CVAR_INT(sucktime,
    "",
    "",
    ...
    CF_NONE,
    SUCKSVALUEALIAS,
    "The amount of time you must complete a map before you \"SUCK\" (" BOLD(
    "off") ", or " BOLD("1") " to " BOLD("24") " hours)."),
    CCMD(take,
    "",
    "",
    take_func1,
    ...
    true,
    TAKECMDFORMAT,
    "Takes " BOLD("ammo") ", " BOLD("armor") ", " BOLD("health") ", " BOLD(
    "key"
    "s") ", " BOLD("weapons") ", " BOLD("powerups") ", or " BOLD("all") " or "
                                                                        "certai"
                                                                        "n"
                                                                        " " BOLDITALICS("items") " away from you."),
    CCMD(teleport,
    "",
    "",
    teleport_func1,
    ...
    true,
    TELEPORTCMDFORMAT,
    "Teleports you to (" BOLDITALICS("x") ", " BOLDITALICS(
    "y") ", " BOLDITALICS("z") ") in the current map."),
    CCMD(thinglist, "", "", game_ccmd_func1, thinglist_func2, false, "", "Lists all things in the current map."),
    CCMD(timer,
    "",
    "",
    null_func1,
    ...
    CVAR_BOOL(tossdrop, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles tossing items dropped by monsters when they die."),
    CVAR_INT(turbo,
    "",
    "",
    turbo_func1,
    ...
    CCMD(vanilla, "", "", null_func1, vanilla_func2, true, "[" BOLD("on") "|" BOLD("off") "]", "Toggles vanilla mode."),
    CVAR_STR(version, "", "", null_func1, str_cvars_func2, CF_READONLY, 16, ITALICS(DOOMRETRO_NAME "'s") " version."),
    CVAR_INT(vid_aspectratio,
    "",
    "",
    vid_aspectratio_func1,
    vid_aspectratio_func2,
    CF_NONE,
    RATIOVALUEALIAS,
    "The aspect ratio of the display when in widescreen (" BOLD(
    "16:9") ", " BOLD("16:10") ", " BOLD("21:9") ", " BOLD("32:9") " or"
                                                                   " " BOLD(
                                                                   "auto") ")"
                                                                           "."),
    CVAR_INT(vid_blue,
    ...
    CVAR_BOOL(vid_borderlesswindow, "", "", bool_cvars_func1, vid_borderlesswindow_func2, CF_NONE, BOOLVALUEALIAS, "Toggles using a borderless window when fullscreen."),
    CVAR_INT(vid_brightness,
    "",
    "",
    int_cvars_func1,
    vid_brightness_func2,
    CF_PERCENT,
    NOVALUEALIAS,
    ...
    CF_NONE,
    CAPVALUEALIAS,
    "The number of frames at which to cap the framerate (" BOLD(
    "off") ", or " BOLD("35") " to " BOLD("1,000") "). "
                                                   "There is no "
                                                   "interpolation between "
                                                   "frames when this CVAR "
                                                   "is " BOLD("35") "."),
    CVAR_INT(vid_contrast,
    "",
    "",
    int_cvars_func1,
    vid_contrast_func2,
...
#if !defined(_WIN32)
    CVAR_STR(vid_driver, "", "", null_func1, str_cvars_func2, CF_NONE, 16, "The video driver used to play " ITALICS(DOOMRETRO_NAME) "."),
#endif
    CVAR_BOOL(vid_fullscreen, "", "", bool_cvars_func1, vid_fullscreen_func2, CF_NONE, BOOLVALUEALIAS, "Toggles between fullscreen and a window."),
    CVAR_INT(vid_green,
    "",
    "",
    int_cvars_func1,
    ...
    CVAR_BOOL(vid_pillarboxes, "", "", bool_cvars_func1, vid_pillarboxes_func2, CF_NONE, BOOLVALUEALIAS, "Toggles using the pillarboxes either side of the screen for certain effects when not in widescreen."),
    CVAR_INT(vid_red,
    "",
    "",
    int_cvars_func1,
    ...
    CF_PERCENT,
    NOVALUEALIAS,
    "The intensity of red on the screen (" BOLD("-100%") " to " BOLD(
    "100%") ")."),
    CVAR_INT(vid_saturation,
    "",
    "",
    int_cvars_func1,
    vid_saturation_func2,
    CF_PERCENT,
    NOVALUEALIAS,
    "The screen's saturation (" BOLD("-100%") " to " BOLD("100%") ")."),
#if defined(_WIN32)
    CVAR_STR(vid_scaleapi,
    "",
    "",
    vid_scaleapi_func1,
    vid_scaleapi_func2,
    CF_NONE,
    16,
    "The API used to scale every frame (" BOLD("\"direct3d\"") ", " BOLD(
    "\"opengl\"") " or " BOLD("\"software\"") ")."),
#else
    CVAR_STR(vid_scaleapi,
    "",
    "",
    ...
    CF_NONE,
    16,
    "The API used to scale every frame (" BOLD("\"opengl\"") ", " BOLD(
    "\"opengles\"") ", " BOLD("\"opengles2\"") " or " BOLD("\"software\"") ")"
                                                                           "."),
#endif
    CVAR_STR(vid_scalefilter,
    "",
    "",
    vid_scalefilter_func1,
    vid_scalefilter_func2,
    CF_NONE,
    16,
    "The filter applied when scaling every frame (" BOLD(
    "\"nearest\"") ", " BOLD("\"linear\"") " or " BOLD("\"nearest_linear\"") ")"
                                                                             "."),
    CVAR_OTHER(vid_screenresolution,
    "",
    "",
    null_func1,
    vid_screenresolution_func2,
    "The screen's resolution when fullscreen (" BOLD("desktop") " or " BOLD(
    ITALICS("width") "\xD7" ITALICS("height")) ")."),
    CVAR_BOOL(vid_showfps, "", "", bool_cvars_func1, vid_showfps_func2, CF_NONE, BOOLVALUEALIAS, "Toggles showing the number of frames per second."),
    ...
    CF_NONE,
    VSYNCVALUEALIAS,
    "Toggles vertical sync with the display's refresh rate (" BOLD(
    "on") " or " BOLD("off") ")."),
#else
    CVAR_INT(vid_vsync,
    "",
    ...
    VSYNCVALUEALIAS,
    "Toggles vertical sync with the display's refresh rate (" BOLD(
    "on") ", " BOLD("off") " or " BOLD("adaptive") ")."),
#endif
    CVAR_BOOL(vid_widescreen, "", "", bool_cvars_func1, vid_widescreen_func2, CF_NONE, BOOLVALUEALIAS, "Toggles widescreen."),
    CVAR_OTHER(vid_windowpos,
    "",
    vid_windowposition,
    null_func1,
    vid_windowpos_func2,
    ...
    CVAR_OTHER(vid_windowsize,
    "",
    "",
    null_func1,
    vid_windowsize_func2,
    "The size of the window on the desktop (" BOLD(
    ITALICS("width") "\xD7" ITALICS("height")) ")."),
    CVAR_STR(wadfolder, "", "", null_func1, str_cvars_func2, CF_NONE, MAX_PATH, "The folder the currently loaded WAD is in."),
    CVAR_INT(weapon,
    "",
    "",
    weapon_func1,
    ...
    WEAPONVALUEALIAS,
    "Your currently equipped weapon (" BOLD("fists") ", " BOLD(
    "chainsaw") ", " BOLD("pistol") ", " BOLD("shotgun") ", " BOLD("chaingu"
                                                                   "n") ","
                                                                        " " BOLD("rocketlauncher") ", " BOLD(
                                                                        "pla"
                                                                        "sma"
                                                                        "rif"
                                                                        "le") " or " BOLD("bfg9000") ")."),
    ...
    CF_PERCENT,
    NOVALUEALIAS,
    "The amount your weapon bobs up and down as you move (" BOLD(
    "0%") " to " BOLD("100%") ")."),
    CVAR_BOOL(weaponbounce, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the bounce of your weapon when you land after a fall."),
    CVAR_BOOL(weaponrecoil, "", "", bool_cvars_func1, weaponrecoil_func2, CF_NONE, BOOLVALUEALIAS, "Toggles the recoil of your weapon when you fire it."),
    CCMD(wiki, help, "", null_func1, wiki_func2, false, "", "Opens the " ITALICS(DOOMRETRO_WIKINAME ".")),
...
{
    return ((game.keydown[keyboardrun] || game.keydown[keyboardrun2] ||
            mousebuttons[mouserun] || (controllerbuttons & controllerrun)) ^
    alwaysrun);
}

static bool strafe(void)
{
    return (game.keydown[keyboardstrafe] || game.keydown[keyboardstrafe2] ||
    mousebuttons[mousestrafe] || (controllerbuttons & controllerstrafe));
}
...
static void clearmark_action_func(void)
{
    if(game.state == GS_LEVEL && (automapactive))
        AM_ClearMarks();
}
...
{
    if(game.state == GS_LEVEL &&
    (!viewplayer->weaponowned[wp_chainsaw] || viewplayer->powers[pw_strength]))
...
static void C_ShowDescription(int index)
{
    ...
    if(consolecmds[index].type == CT_CCMD)
        ...
        C_Output("This CVAR %s%s",
        (M_StringStartsWith(description, "toggles") ?
        "" :
        ((consolecmds[index].flags & CF_READONLY) ? "is " : "changes ")),
        description);
}
...
static void C_ShowFormat(int index)
{
    ...
    M_StringCopy(name,
    (english == english_american || M_StringCompare(consolecmds[index].altspelling, EMPTYVALUE) ?
    consolecmds[index].name :
    consolecmds[index].altspelling),
    sizeof(name));
...
static void C_ShowWarning(int index)
{
    ...
    else if((flags & CF_NEXTMAP) && game.state == GS_LEVEL)
...
static bool cheat_func1(char* cmd, char* parms)
{
    if(M_StringCompare(cmd, cheat_clev.sequence))
    {
        ...
        (game.mission != pack_nerve || mapcmdmap <= 9));
    ...
    else if(M_StringCompare(cmd, cheat_mus.sequence) && !nomusic && s_musicvolume)
    {
        ...
        return (game.skill != sk_nightmare && (automapactive));
...
bool IsControlBound(const controltype_t type, const int control)
{
    for(int i = 0; *actions[i].action; i++)
        if(type == keyboardcontrol)
        {
            ...
            controls[control].value == *(int*)actions[i].keyboard1)
                return true;

            if(actions[i].keyboard2 &&
            controls[control].value == *(int*)actions[i].keyboard2)
                return true;
        }
        ...
        else if(type == controllercontrol)
        {
            ...
            controls[control].value == *(int*)actions[i].controller1)
                return true;

            if(actions[i].controller2 &&
            controls[control].value == *(int*)actions[i].controller2)
                return true;
        }
...
static int GetControlWithAction(int action)
{
    ...
    while(controls[control].type)
    {
        ...
        (actions[action].mouse1 &&
        controls[control].value == *(int*)actions[action].mouse1) ||
        (actions[action].controller1 &&
        controls[control].value == *(int*)actions[action].controller1) ||
        (actions[action].controller2 &&
        controls[control].value == *(int*)actions[action].controller2))
            return control;
...
static void C_UnbindDuplicates(const int keep, const controltype_t type, const int control)
{
    for(int i = 0; *actions[i].action; i++)
        if(i != keep && actions[i].automaponly == actions[keep].automaponly)
        {
            if(type == keyboardcontrol)
            {
                ...
                controls[control].value == *(int*)actions[i].keyboard1)
                {
                    if(strlen(controls[i].control) == 1)
                        C_Warning(1,
                        "Controls may only be bound to one action. The "
                        "duplicate " BOLD("%s") " action has therefore been "
                                                "unbound from the " BOLD("'%s'") " key.",
            ...
            {
                if(actions[i].mouse1 &&
                controls[control].value == *(int*)actions[i].mouse1)
                {
                    C_Warning(1,
                    "Controls may only be bound to one action. The "
                    "duplicate " BOLD(
                    "%s") " action has therefore been unbound from " BOLD("%s") ".",
                    actions[i].action, controls[control].control);
...
void bind_func2(char* cmd, char* parms)
{
    ...
    char parm1[128]             = "";
    char parm2[128]             = "";
    const bool freelookcontrols = (keyboardfreelook || keyboardfreelook2 ||
    controllerfreelook || mousefreelook != -1);
    ...
    if(*controls[i].control)
    {
        if(M_StringCompare(cmd, "unbind"))
        {
            while(*actions[action].action)
            {
                ...
                case keyboardcontrol:
                    ...
                    controls[i].value == *(int*)actions[action].keyboard1)
                    {
                        if(!nobindoutput)
                            C_Output(
                            "The " BOLD("%s") " action has been unbound from "
                                              "the " BOLD("%s") " control.",
                ...
                case controllercontrol:
                    ...
                    controls[i].value == *(int*)actions[action].controller1)
                    {
                        if(!nobindoutput)
                            C_Output(
                            "The " BOLD("%s") " action has been unbound from "
                    ...
                    controls[i].value == *(int*)actions[action].controller2)
                    {
                        if(!nobindoutput)
                            C_Output(
                            "The " BOLD("%s") " action has been unbound from "
            ...
            *mouseactionlist[controls[i].value])
            {
                C_Output(BOLD("\"%s\"") " has been unbound from the " BOLD("%s") " control.",
        ...
        else if(!*parm2)
        {
            while(*actions[action].action)
            {
                ...
                else if(controls[i].type == controllercontrol)
                {
                    ...
                    controls[i].value == *(int*)actions[action].controller1)
                        C_Output(actions[action].action);
                    else if(actions[action].controller2 &&
                    controls[i].value == *(int*)actions[action].controller2)
                        C_Output(actions[action].action);
                }
        ...
        else
        {
            ...
            if(*actions[action].action)
            {
                    ...
                    if(actions[action].keyboard1)
                    {
                        ...
                        *(int*)actions[action].keyboard1 != controls[i].value)
                        ...
                        if(M_StringCompare(actions[action].action, "+screenshot"))
                        {
                            ...
                            keyboardscreenshot2 == KEY_PRINTSCREEN)
                            {
                ...
                case controllercontrol:
                    if(actions[action].controller1)
                    {
                        if(actions[action].controller2 && *(int*)actions[action].controller1 &&
                        *(int*)actions[action].controller1 != controls[i].value)
                        {
                            if(*(int*)actions[action].controller2)
                            {
                                *(int*)actions[action].controller2 =
                ...
                if(bound)
                {
                    if(!nobindoutput)
                    {
                        if(strlen(controls[i].control) == 1)
                            C_Output(
                            "The " BOLD("%s") " action was bound to the " BOLD("'%s'") " key.",
                            parm2, controls[i].control);
                        else
                            C_Output(
                            "The " BOLD("%s") " action was bound to the " BOLD("%s") " control.",
                            parm2, controls[i].control);
                    }
                }
                else
                {
                    if(strlen(controls[i].control) == 1)
                        C_Warning(0,
                        "The " BOLD("%s") " action can't be bound to the " BOLD("'%s'") " key.",
                        parm2, controls[i].control);
                    else
                        C_Warning(0,
                        "The " BOLD("%s") " action can't be bound to the " BOLD("%s") " control.",
                        parm2, controls[i].control);
            ...
            else
            {
                ...
                {
                    M_StripQuotes(parm2);
                    M_StringCopy(keyactionlist[controls[i].value], parm2,
                    sizeof(keyactionlist[0]));
                    M_SaveCVARs();
                ...
                {
                    M_StripQuotes(parm2);
                    M_StringCopy(mouseactionlist[controls[i].value], parm2,
                    sizeof(mouseactionlist[0]));
                    M_SaveCVARs();
            ...
            if(M_StringCompare(parms, actions[action].action))
            {
                if(actions[action].keyboard1 && *(int*)actions[action].keyboard1)
                {
                    ...
                    if(strlen(controls[control].control) == 1)
                        C_Output(
                        "The " BOLD("%s") " action has been unbound "
                                          "from the " BOLD("'%s'") " control.",
                        actions[action].action, controls[control].control);
                    else
                        C_Output(
                        "The " BOLD(
                        "%s") " action has been unbound from the " BOLD("%s") " control.",
                        actions[action].action, controls[control].control);
                ...
                {
                    C_Output(
                    "The " BOLD("%s") " action has been unbound from the " BOLD("%s") " control.",
                    actions[action].action,
                    controls[GetControlWithAction(action)].control);
                    *(int*)actions[action].mouse1 = -1;
                }
    ...
    if(freelookcontrols !=
    (keyboardfreelook || keyboardfreelook2 || controllerfreelook || mousefreelook != -1))
    {
        if(game.state == GS_LEVEL)
        {
...
//
static void
C_DisplayBinds(const char* action, const int value, const controltype_t type, const int* tabs)
{
...
static void bindlist_func2(char* cmd, char* parms)
{
    ...
    {
        if(actions[i].keyboard1)
            C_DisplayBinds(actions[i].action, *(int*)actions[i].keyboard1,
            keyboardcontrol, tabs);

        if(actions[i].keyboard2)
            C_DisplayBinds(actions[i].action, *(int*)actions[i].keyboard2,
            keyboardcontrol, tabs);
    }
    ...
    for(int i = 0; controls[i].type; i++)
    {
        ...
        if(controls[i].type == keyboardcontrol && keyactionlist[value][0])
        {
            ...
            if(strlen(control) == 1)
                C_TabbedOutput(tabs, "'%s'\t\"%s\"",
                (control[0] == '=' ? "+" : control), keyactionlist[value]);
            else
    ...
    {
        if(actions[i].controller1)
            C_DisplayBinds(actions[i].action, *(int*)actions[i].controller1,
            controllercontrol, tabs);

        if(actions[i].controller2)
            C_DisplayBinds(actions[i].action, *(int*)actions[i].controller2,
            controllercontrol, tabs);
    }
}
...
static void cmdlist_func2(char* cmd, char* parms)
{
    ...
    for(int i = 0, count = 0; *consolecmds[i].name; i++)
        if(consolecmds[i].type == CT_CCMD)
        {
            ...
            M_StringCopy(name,
            (english == english_american || M_StringCompare(consolecmds[i].altspelling, EMPTYVALUE) ?
            consolecmds[i].name :
            consolecmds[i].altspelling),
            sizeof(name));
            ...
            if(M_StringCompare(name, "map"))
                M_snprintf(format, sizeof(format), BOLD("map") " %s",
                (game.mission == doom ? MAPCMDFORMAT1 : MAPCMDFORMAT2));
            else
                M_snprintf(format, sizeof(format), BOLD("%s") " %s", name,
                consolecmds[i].format);
...
static void condump_func2(char* cmd, char* parms)
{
    ...
    if(!*parms)
    {
        ...
        M_snprintf(filename, sizeof(filename), "%s" DIR_SEPARATOR_S "%s.txt",
        consolefolder, cmd);
    ...
    if((file = FS_OpenFile(filename, FS_WRITE, FS_TRUE)))
    {
        ...
        for(int i = 1; i < numconsolestrings - 1; i++)
        {
            ...
            else
            {
                ...
                if(type == playermessagestring || type == playerwarningstring)
                {
                    ...
                    (con_timestampformat == con_timestampformat_standard ? 90 : 92) - outpos;
                    struct tm timestamp = console[i].timestamp;

                    for(unsigned int j = (type == playermessagestring ? 0 : 2);
                    j < spaces; j++)
                        FS_PutChar(' ', file);
...
static void cvarlist_func2(char* cmd, char* parms)
{
    const int tabs[MAXTABS] = { 190, 310 };
    ...
    for(int i = 0, count = 0; *consolecmds[i].name; i++)
        if(consolecmds[i].type == CT_CVAR)
        {
            ...
            if(M_StringCompare(name, stringize(ammo)))
            {
                ...
                {
                    int value =
                    viewplayer->ammo[weaponinfo[viewplayer->readyweapon].ammotype];

                    if(value == consolecmds[i].defaultnumber)
                        C_TabbedOutput(tabs, BOLD("%s") "\t" BOLD("%i") "\t%s",
                        name, value, description);
                    else
                        C_TabbedOutput(tabs, BOLD("%s") "\t" BOLDER("%i") "\t%s",
                        name, value, description);
                }
                else
                    C_TabbedOutput(tabs, BOLD("%s") "\t" BOLD("%i") "\t%s",
            ...
            else if(M_StringCompare(name, stringize(weapon)))
            {
                if(game.mode == shareware)
                    M_StringCopy(description, WEAPONDESCRIPTION_SHAREWARE,
                    sizeof(description));
                else if(game.mission != doom)
            ...
            else if(M_StringCompare(name, stringize(r_fov)))
            {
                ...
                if(value == consolecmds[i].defaultnumber)
                    ...
                    C_TabbedOutput(tabs, BOLD("%s") "\t" BOLDER("%i") "\xB0\t%s",
                    name, value, description);
            }
            ...
            else if(consolecmds[i].flags & CF_FLOAT)
            {
                ...
                C_TabbedOutput(tabs, BOLD("%s") "\t" BOLD("%s") "\t%s", name,
                *(char**)consolecmds[i].variable, description);
            ...
            else if(consolecmds[i].flags & CF_TIME)
            {
                ...
                if(!tics)
                    C_TabbedOutput(tabs,
                    BOLD("%s") "\t" BOLD(MONOSPACED("%02i") ":" MONOSPACED(
                    "%02i") "." MONOSPACED("%02i")) "\t%s",
                    name, minutes, seconds % 60, milliseconds / 10, description);
                else if(!hours)
                    C_TabbedOutput(tabs,
                    BOLD("%s") "\t" BOLDER(MONOSPACED("%02i") ":" MONOSPACED(
                    "%02i") "." MONOSPACED("%02i")) "\t%s",
                    name, minutes, seconds % 60, milliseconds / 10, description);
                else
                    C_TabbedOutput(tabs,
                    BOLD("%s") "\t" BOLDER(
                    MONOSPACED("%i") ":" MONOSPACED("%02i") ":" MONOSPACED(
                    "%02i") "." MONOSPACED("%02i")) "\t%s",
...
static void endgame_func2(char* cmd, char* parms)
{
    if(game.state != GS_LEVEL && game.state != GS_INTERMISSION)
    {
        const int i = C_GetIndex(cmd);
...
void exec_func2(char* cmd, char* parms)
{
    ...
    else
    {
        ...
        if(!(file = FS_OpenFile(filename, FS_READ, FS_TRUE)))
        {
        ...
        C_Output("%s line%s have been parsed in " BOLD("%s") ".", temp,
        (linecount == 1 ? "" : "s"), leafname(parms));
        free(temp);
    }
}
    ...
    else
    {
        ...
        else if(M_StringCompare(parm, "weapons") || M_StringCompare(parm, "allweapons"))
        {
            ...
            else
            {
                if(M_StringCompare(playername, playername_default))
                    ...
                    C_Warning(0, "%s already has all %s weapons.", playername,
                    pronoun(possessive));
        ...
        M_StringCompare(parm, "ammunition") || M_StringCompare(parm, "fullammunition"))
        {
            if(P_GiveFullAmmo())
            {
                ...
                if(M_StringCompare(playername, playername_default))
                    C_PlayerMessage(
                    "You have been given full ammo for all your weapons.");
                else
                    C_PlayerMessage(
                    "%s has been given full ammo for all %s weapons.",
                    playername, pronoun(possessive));
            ...
            else if(P_GiveBackpack(false, false) && P_GiveFullAmmo())
            {
                ...
                if(M_StringCompare(playername, playername_default))
                    C_PlayerMessage("You have been given a backpack and full "
                                    "ammo for all your weapons.");
                else
                    C_PlayerMessage("%s has been given a backpack and full "
                                    "ammo for all %s weapons.",
                    playername, pronoun(possessive));
        ...
        M_StringCompare(parm, "armour") || M_StringCompare(parm, "fullarmour"))
        {
            if(P_GiveArmor(blue_armor_class, false))
            {
                ...
                if(M_StringCompare(playername, playername_default))
                    ...
                    C_PlayerMessage("%s has been given full %s.", playername,
                    (english == english_american ? "armor" : "armour"));
            ...
            else
            {
                if(M_StringCompare(playername, playername_default))
                    ...
                    C_Warning(0, "%s already has full %s.", playername,
                    (english == english_american ? "armor" : "armour"));
        ...
        else if(M_StringCompare(parm, "keys") || M_StringCompare(parm, "allkeys"))
        {
            if(P_GiveAllCards())
            {
                ...
                if(M_StringCompare(playername, playername_default))
                    C_PlayerMessage(
                    "You have been given all keycards and skull keys.");
                else
                    C_PlayerMessage(
                    "%s has been given all keycards and skull keys.", playername);
        ...
        else
        {
            for(int i = 0, num = -1; i < NUMMOBJTYPES; i++)
            {
                bool result = false;
                char* temp1 =
                (*mobjinfo[i].name1 ? removenonalpha(mobjinfo[i].name1) : NULL);
                char* temp2 =
                (*mobjinfo[i].name2 ? removenonalpha(mobjinfo[i].name2) : NULL);
                char* temp3 =
                (*mobjinfo[i].name3 ? removenonalpha(mobjinfo[i].name3) : NULL);
                ...
                (sscanf(parm, "%10i", &num) == 1 && num == mobjinfo[i].doomednum && num != -1)))
                {
                    if(game.mode != commercial && (i == MT_SUPERSHOTGUN || i == MT_MEGA))
                        C_Warning(0, "%s can't be given %s %s in " ITALICS("%s") "!",
                        (M_StringCompare(playername, playername_default) ?
                        "You" :
                        playername),
                        (isvowel(mobjinfo[i].name1[0]) ? "an" : "a"),
                        mobjinfo[i].name1, game.description);
                    else if(game.mode == shareware &&
                    (i == MT_MISC7 || i == MT_MISC8 || i == MT_MISC9 || i == MT_MISC20 ||
                    i == MT_MISC21 || i == MT_MISC25 || i == MT_MISC28))
                    {
                        if(M_StringCompare(playername, playername_default))
                            C_Warning(0,
                            "You can't be given %s %s in the shareware version "
                            "of " ITALICS("DOOM") "! "
                                                  "You can buy the full "
                                                  "version on " ITALICS("Steam") ", etc.",
                            (isvowel(mobjinfo[i].name1[0]) ? "an" : "a"),
                            mobjinfo[i].name1);
                        else
                            C_Warning(0,
                            "%s can't be given %s %s in the shareware version "
                            "of " ITALICS(
                            "DOOM") "! "
                    ...
                    else
                    {
                        ...
                        if(viewplayer->health <= 0)
                        {
                            if(M_StringCompare(playername, playername_default))
                                ...
                                playername, (isvowel(mobjinfo[i].name1[0]) ? "an" : "a"),
                                mobjinfo[i].name1, pronoun(personal),
                                (playergender == playergender_other ? "are" : "is"));
                        }
                        else if(P_TouchSpecialThing(thing, viewplayer->mo, false, false))
                        {
                            ...
                            {
                                if(M_StringCompare(playername, playername_default))
                                    C_PlayerMessage("You have been given %s.",
                                    mobjinfo[i].name1);
                                else
                                    C_PlayerMessage("%s has been given %s.",
                                    playername, mobjinfo[i].name1);
                            }
                            else
                            {
                                if(M_StringCompare(playername, playername_default))
                                    C_PlayerMessage(
                                    "You have been given %s %s.",
                                    (isvowel(mobjinfo[i].name1[0]) ? "an" : "a"),
                                    mobjinfo[i].name1);
                                else
                                    C_PlayerMessage("%s has been given %s %s.", playername,
                                    (isvowel(mobjinfo[i].name1[0]) ? "an" : "a"),
                                    mobjinfo[i].name1);
                            }
...
{
    return ((value && M_StringCompare(toggle, "on")) ||
    (!value && M_StringCompare(toggle, "off")));
}
        ...
        if(M_StringCompare(parm1, consolecmds[i].name))
        {
            ...
            else if(consolecmds[i].type == CT_CVAR)
            {
                if(consolecmds[i].flags & CF_BOOLEAN)
                {
                    ...
                    value == *(bool*)consolecmds[i].variable);
                }
                else if(consolecmds[i].flags & CF_INTEGER)
                {
                    ...
                    if(value != INT_MIN || sscanf(parms, "%10i", &value) == 1)
                        condition =
                        (value != INT_MIN && value == *(int*)consolecmds[i].variable);
                }
                else if(consolecmds[i].flags & CF_FLOAT)
                {
                    float value = FLT_MIN;
                    ...
                    if(sscanf(parms, "%10f", &value) == 1)
                        condition =
                        (value != FLT_MIN && value == *(float*)consolecmds[i].variable);
                }
                else
...
static bool kill_func1(char* cmd, char* parms)
{
    ...
    else if(M_StringCompare(parm, "monster") ||
    M_StringCompare(parm, "monsters") || M_StringCompare(parm, "all") ||
    ...
    M_StringCompare(parm, "blood") || M_StringCompare(parm, "bloodsplat") ||
    M_StringCompare(parm, "bloodsplats") || M_StringCompare(parm, "everything"))
        result = true;
    else
    {
        for(int i = 0, num = -1; i < NUMMOBJTYPES; i++)
            if(*mobjinfo[i].name1)
            {
                ...
                char* temp2 =
                (*mobjinfo[i].plural1 ? removenonalpha(mobjinfo[i].plural1) : NULL);
                char* temp3 =
                (*mobjinfo[i].name2 ? removenonalpha(mobjinfo[i].name2) : NULL);
                char* temp4 =
                (*mobjinfo[i].plural2 ? removenonalpha(mobjinfo[i].plural2) : NULL);
                char* temp5 =
                (*mobjinfo[i].name3 ? removenonalpha(mobjinfo[i].name3) : NULL);
                char* temp6 =
                (*mobjinfo[i].plural3 ? removenonalpha(mobjinfo[i].plural3) : NULL);
        ...
        if(!result)
            for(thinker_t* th            = thinkers[th_mobj].cnext;
            th != &thinkers[th_mobj]; th = th->cnext)
            {
...
static void kill_func2(char* cmd, char* parms)
{
    ...
    {
        char buffer[1024];
        char* killed = (M_StringCompare(cmd, "explode") ?
        "exploded" :
        ...
        (*playername && M_StringCompare(parm, playername)))
        {
            if(viewplayer->cheats & CF_GODMODE)
            {
                if(M_StringCompare(playername, playername_default))
                    ...
                    C_Warning(0, "%s can't kill %s in god mode!", playername,
                    pronoun(reflexive));
            ...
            if(viewplayer->powers[pw_invulnerability])
            {
                if(M_StringCompare(playername, playername_default))
                    ...
                    playername, pronoun(reflexive), pronoun(personal),
            ...
            if(viewplayer->cheats & CF_BUDDHA)
            {
                if(M_StringCompare(playername, playername_default))
                    ...
                    C_Warning(0, "%s can't kill %s in buddha mode!", playername,
                    pronoun(reflexive));
        ...
        else
        {
            const bool friends =
            (M_StringCompare(parm, "friend") || M_StringCompare(parm, "friends") ||
            ((M_StringCompare(parm, "monster") || M_StringCompare(parm, "monsters")) &&
            killcmdfriendly));
            const bool enemies =
            (M_StringCompare(parm, "monster") || M_StringCompare(parm, "monsters"));
            ...
            if(friends || enemies || all)
            {
                for(int i = 0; i < numsectors; i++)
                    for(mobj_t* thing = sectors[i].thinglist; thing;
                    thing             = thing->snext)
                    {
                        ...
                        {
                            if((thing->flags2 & MF2_MONSTERMISSILE) || thing->type == MT_ROCKET ||
                            ...
                            else if(thing->health > 0)
                            {
                                ...
                                if(type == MT_PAIN)
                                {
                                    ...
                                    stat_monsterskilled[MT_PAIN] =
                                    SafeAdd(stat_monsterskilled[MT_PAIN], 1);

                                    if(!(flags & MF_FRIEND))
                                        viewplayer->killcount++;

                                    stat_monsterskilled_total =
                                    SafeAdd(stat_monsterskilled_total, 1);
                                    kills++;
                                }
                                else if((flags & MF_SHOOTABLE) && type != MT_PLAYER &&
                                type != MT_BARREL)
                                {
                                    thing->flags2 |= MF2_MASSACRE;
                                    massacre = true;

                                    P_DamageMobj(thing, viewplayer->mo,
                                    viewplayer->mo, thing->health, false, false);
                                    massacre = false;
                                    kills++;
                                }
                            }
                ...
                if(kills)
                {
                    ...
                    if(M_StringCompare(playername, playername_default))
                    {
                        if(kills == 1)
                            ...
                            "You %s the only %smonster in this map!", killed,
                            (friends ? "friendly " : ""));
                        else
                            M_snprintf(buffer, sizeof(buffer),
                            "You %s all %s %smonsters in this map!", killed,
                            temp, (friends ? "friendly " : ""));
                    }
                    else
                    {
                        if(kills == 1)
                            M_snprintf(buffer, sizeof(buffer),
                            "%s %s the only %smonster in this map!", playername,
                            killed, (friends ? "friendly " : ""));
                        else
                            M_snprintf(buffer, sizeof(buffer),
                            "%s %s all %s %smonsters in this map!", playername,
                    ...
                    C_Warning(0, "There are no %smonsters to %s.",
                    (friends ? "friendly " : ""), cmd);
            }
            ...
            else if(M_StringCompare(parm, "everything"))
            {
                for(int i = 0; i < numsectors; i++)
                    ...
                    thing             = thing->snext)
                    {
                        ...
                        if(((flags & MF_SHOOTABLE) && !thing->player) ||
                        (flags & MF_CORPSE) || (flags2 & MF2_DECORATION))
                        {
                            P_SpawnMobj(thing->x, thing->y, thing->z, MT_TFOG);
                            S_StartSound(thing, sfx_telept);
                            P_RemoveMobj(thing);
                        ...
                        (flags2 & MF2_MONSTERMISSILE) || thing->type == MT_ROCKET ||
                        thing->type == MT_PLASMA || thing->type == MT_BFG)
                        {
                            P_SpawnMobj(thing->x, thing->y, thing->z, MT_IFOG);
                            S_StartSound(thing, sfx_itmbk);
                ...
                if(kills)
                {
                    if(M_StringCompare(playername, playername_default))
                        ...
                        M_snprintf(buffer, sizeof(buffer), "%s %s everything.",
                        playername, killed);
            ...
            else if(M_StringCompare(parm, "corpse") || M_StringCompare(parm, "corpses"))
            {
                ...
                if(kills)
                {
                    if(M_StringCompare(playername, playername_default))
                        ...
                        M_snprintf(buffer, sizeof(buffer), "%s %s all corpses.",
                        playername, killed);
            ...
            else if(M_StringCompare(parm, "blood") ||
            M_StringCompare(parm, "bloodsplat") || M_StringCompare(parm, "bloodsplats"))
            {
                if(r_bloodsplats_total)
                {
                    ...
                    if(M_StringCompare(playername, playername_default))
                        ...
                        M_snprintf(buffer, sizeof(buffer),
                        "%s %s all blood splats.", playername, killed);
            ...
            else if(killcmdmobj)
            {
                ...
                else
                {
                    ...
                    massacre = true;
                    P_DamageMobj(killcmdmobj, viewplayer->mo, viewplayer->mo,
                    killcmdmobj->health, false, false);
                    massacre = false;
                ...
                else
                {
                    if(game.mode != commercial)
                    {
                        if(killcmdtype >= ArchVile && killcmdtype <= MonsterSpawner)
                            ...
                            mobjinfo[type].plural1, game.description);
                        else if(game.mode == shareware &&
                        (killcmdtype == Cyberdemon || killcmdtype == SpiderMastermind))
                            C_Warning(0,
                            "There are no %s in the shareware version "
                            "of " ITALICS("DOOM") ". "
                                                  "You can buy the full "
                                                  "version on " ITALICS("Steam") ", etc.",
                            mobjinfo[type].plural1);
                        else
                            C_Warning(0, "There are no %s to %s.",
                            mobjinfo[type].plural1, cmd);
                    }
                    else
...
static void license_func2(char* cmd, char* parms)
{
    ...
    FS_OpenURI(DOOMRETRO_LICENSEURL, DOOMRETRO_LICENSE);
}
...
static void load_func2(char* cmd, char* parms)
{
    ...
    {
        M_snprintf(buffer, sizeof(buffer), "%s" DOOMRETRO_SAVEGAME,
        savegamefolder, parms[0] - '1');
        G_LoadGame(buffer);
    }
    else
    {
...
static bool map_func1(char* cmd, char* parms)
{
    ...
    else
    {
        ...
        else if((M_StringCompare(parm, "previous") || M_StringCompare(parm, "prev")) &&
        ...
        else if(M_StringCompare(parm, "next") && game.state != GS_TITLESCREEN)
        {
            if(game.mode == commercial)
            {
                if(game.map != (game.mission == pack_nerve ? 8 : 30))
                {
                    mapcmdepisode = game.episode;
                    mapcmdmap     = game.map + 1;
                    M_snprintf(mapcmdlump, sizeof(mapcmdlump), "MAP%02i", mapcmdmap);
        ...
        else if(M_StringCompare(parm, "last"))
        {
            ...
            else if(game.mode == retail)
            {
                if(!(game.episode == 4 && game.map == 8))
                {
                    mapcmdepisode = 4;
                    mapcmdmap     = 8;
        ...
        else if(M_StringCompare(parm, "random"))
        {
            ...
            {
                mapcmdepisode = game.episode;
                mapcmdmap     = M_BigRandomIntNoRepeat(
                1, (game.mission == pack_nerve ? 8 : 30), game.map);
                M_snprintf(mapcmdlump, sizeof(mapcmdlump), "MAP%02i", mapcmdmap);
                result = true;
            }
            else
            {
                mapcmdepisode = (game.mode == shareware ?
                1 :
                M_BigRandomIntNoRepeat(1,
                (game.mode == retail ? 4 : 3), game.episode));
                mapcmdmap = M_BigRandomIntNoRepeat(1, 8, game.map);
                M_snprintf(mapcmdlump, sizeof(mapcmdlump), "E%iM%i",
                mapcmdepisode, mapcmdmap);
                result = true;
            }
        }
        else
        {
            ...
            if(game.mode == commercial)
            {
                ...
                if(sscanf(parm, "MAP0%1i", &mapcmdmap) == 1 ||
                sscanf(parm, "MAP%2i", &mapcmdmap) == 1)
                {
                    if(!(game.mission == pack_nerve && mapcmdmap > 9))
                    {
                        if(game.state != GS_LEVEL && game.mission == pack_nerve)
                        {
                            game.mission = doom2;
                            expansion   = 1;
                        }
        ...
        if(!result)
        {
            for(int i = 0; i < numlumps; i++)
            {
                ...
                if(game.mode == commercial)
                {
                    ...
                    if(sscanf(mapcmdlump, "MAP0%1i", &mapcmdmap) != 1 &&
                    sscanf(mapcmdlump, "MAP%2i", &mapcmdmap) != 1)
                        continue;
                }
                else
                {
                    if(sscanf(mapcmdlump, "E%1iM%1iB", &mapcmdepisode, &mapcmdmap) == 2 &&
                    game.mode != shareware)
                ...
                replaced = (W_GetNumLumps(mapcmdlump) > 1 && !FREEDOOM);
                pwad = (lumpinfo[i]->wadfile->type == PWAD);
                M_StringCopy(mapinfoname,
                P_GetMapName(mapcmdepisode, mapcmdmap), sizeof(mapinfoname));
                ...
                case doom:
                    if(!replaced || pwad)
                    {
                        ...
                        mapinfoname :
                        *mapnames[(mapcmdepisode - 1) * 9 + mapcmdmap - 1]);
...
static void map_func2(char* cmd, char* parms)
{
    ...
    {
        C_ShowDescription(C_GetIndex(cmd));
        C_Output(BOLD("%s") " %s", cmd, (game.mission == doom ? MAPCMDFORMAT1 : MAPCMDFORMAT2));
        return;
    }

    if((samelevel = (game.episode == mapcmdepisode && game.map == mapcmdmap && !*speciallumpname)))
    ...
    game.episode = mapcmdepisode;

    if(game.mission == doom)
    {
    ...
    {
        G_DeferredInitNew(skilllevel - 1, game.episode, game.map);
        C_HideConsoleFast();
    }
...
static char* getauthor(int ep, int map, bool replaced)
{
    ...
    {
        if(!replaced && *authors[ep * 10 + map][game.mission])
            return authors[ep * 10 + map][game.mission];
    }
    else if(!replaced && *authors[map][game.mission])
        return authors[map][game.mission];
...
static void maplist_func2(char* cmd, char* parms)
{
    ...
    for(int i = numlumps - 1; i >= 0; i--)
    {
        ...
        {
            if(sscanf(lump, "E%1iM%i", &ep, &map) != 2)
                continue;
        }

        M_StringCopy(wadname, leafname(lumpinfo[i]->wadfile->path), sizeof(wadname));
        replaced = (W_GetNumLumps(lump) > 1 && !FREEDOOM);
        pwad     = (lumpinfo[i]->wadfile->type == PWAD);
        ...
        case doom:
            if(!replaced || pwad)
            {
                if(replaced && dehcount == 1 && !*mapinfoname)
                    M_snprintf(maps[count++], sizeof(maps[0]),
                    MONOSPACED("%s") "\t\x96\t%s\t%s", lump, author, wadname);
                else
                {
                    ...
                    else if(M_StringCompare(lump, "E1M8B"))
                    {
                        ...
                        temp1 = titlecase(
                        *mapinfoname ? mapinfoname : *mapnames[(ep - 1) * 9 + map - 1]);

                    removemapnum(temp1);
                    M_snprintf(maps[count++], sizeof(maps[0]),
                    MONOSPACED("%s") "\t" ITALICS("%.27s%s") "\t%s\t%s", lump,
                    temp1, (strlen(temp1) > 27 ? "..." : ""), author, wadname);
                    free(temp1);
                }
            }
        ...
        case pack_tnt:
            if(!replaced || pwad)
            {
                if(replaced && dehcount == 1 && !*mapinfoname)
                    M_snprintf(maps[count++], sizeof(maps[0]),
                    MONOSPACED("%s") "\t \x96\t%s", lump, author, wadname);
                else
                {
                    temp1 = titlecase(*mapinfoname ? mapinfoname : *mapnamest[map - 1]);
                    removemapnum(temp1);
                    M_snprintf(maps[count++], sizeof(maps[0]),
                    MONOSPACED("%s") "\t" ITALICS("%.27s%s") "\t%s", lump,
                    temp1, (strlen(temp1) > 27 ? "..." : ""), author, wadname);
                    free(temp1);
                }
            }
...
static int GetNumMaps(int lumpnum)
{
    ...
    for(int i = 0; i < numlumps; i++)
    {
        ...
        if(!strncmp(lump, "MAP", 3) && isdigit(lump[3]) && isdigit(lump[4]) &&
        strlen(lump) == 5)
        {
            int map;
            ...
            M_StringCompare(
            lumpinfo[lumpnum]->wadfile->path, lumpinfo[i]->wadfile->path))
                count++;
        }
        else if(lump[0] == 'E' && isdigit(lump[1]) && lump[2] == 'M' &&
        isdigit(lump[3]) && strlen(lump) == 4 &&
...
static void mapstats_func2(char* cmd, char* parms)
{
    struct
    {
        const char* title;
        const char* artist;
    } tntmusic[] = { { "Sadistic", "L.A. Sieben" },
        { "Smells Like Burning Corpse", "L.A. Sieben" },
        { "Message for the Archvile", "Bobby Prince" },
        { "Death's Bells", "L.A. Sieben" }, { "More", "Tom Mustaine" },
        { "Agony Rhapsody", "L.A. Sieben" }, { "Soldier Of Chaos", "Jonathan El-Bizri" },
        { "Into The Beast's Belly", "L.A. Sieben" }, { "Sadistic", "L.A. Sieben" },
        { "Infinite", "Tom Mustaine" }, { "Let's Kill At Will", "Jonathan El-Bizri" },
        { "The Dave D. Taylor Blues", "Bobby Prince" },
        { "Death's Bells", "L.A. Sieben" }, { "Cold Subtleness", "Jonathan El-Bizri" },
        { "Smells Like Burning Corpse", "L.A. Sieben" },
        { "Blood Jungle", "Jonathan El-Bizri" }, { "More", "Tom Mustaine" },
        { "Infinite", "Tom Mustaine" }, { "Countdown To Death", "Bobby Prince" },
        { "Horizon", "Tom Mustaine" }, { "Into Sandy's City", "Bobby Prince" },
        { "AimShootKill", "Tom Mustaine" }, { "Bye Bye American Pie", "Bobby Prince" },
        { "Between Levels", "Bobby Prince" }, { "DOOM", "Bobby Prince" },
        { "Blood Jungle", "Jonathan El-Bizri" }, { "Into The Beast's Belly", "L.A. Sieben" },
        { "AimShootKill", "Tom Mustaine" }, { "Death's Bells", "L.A. Sieben" },
        { "Into The Beast's Belly", "L.A. Sieben" },
        { "Legion Of The Lost", "L.A. Sieben" }, { "Into Sandy's City", "Bobby Prince" } };

    struct
    {
        const char* title;
        const char* artist;
    } legacyofrustmusic[] = { { "Welcome To Die", "Xaser Acheron" },
        { "The Shores Of Heaven", "Xaser Acheron" },
        { "Bilge Punks", "Xaser Acheron" }, { "Callous Regard", "Xaser Acheron" },
        { "They're All Going To Laugh At You", "Xaser Acheron" },
        { "Cloudy With A Chance Of Spiders", "Xaser Acheron" },
        { "Tactical Blasphemy", "Xaser Acheron" }, { "Opening To Hell", "Bobby Prince" },
        { "Bonk", "Xaser Acheron" }, { "Cliff Driver", "Xaser Acheron" },
        { "Wizard Science", "Xaser Acheron" }, { "Deja Vuvuzela", "Xaser Acheron" },
        { "Disgusto!", "Xaser Acheron" }, { "March Of The Vespers", "Xaser Acheron" },
        { "The Skeleton World", "Xaser Acheron" }, { "Hell Force Five", "Xaser Acheron" } };

    const int tabs[MAXTABS] = { 137 };
    char* temp;
    int lump = -1;
    int wadtype;
    const char* author       = P_GetMapAuthor(game.episode, game.map);
    const char* mapinfolabel = trimwhitespace(P_GetLabel(game.episode, game.map));
    char wadname[MAX_PATH];
    ...
    if(*mapinfolabel)
    {
        ...
        M_snprintf(lumpname, sizeof(lumpname), "MAP%02i", game.map);
    ...
    if(wadtype == IWAD)
    {
        ...
        {
            if(game.mission == pack_nerve)
                C_TabbedOutput(tabs, "Map\t%i of 9", game.map);
            else
                C_TabbedOutput(tabs, "Map\t%i of %i", game.map, 32);
        }
        else
            C_TabbedOutput(tabs, "Map\t%i of 9", game.map);
    }
    else
        C_TabbedOutput(tabs, "Map\t%i of %i", game.map, GetNumMaps(lump));
    ...
    if(!M_StringCompare(maptitle, mapnum))
    {
        ...
        else if(game.episode == 3 && game.map == 7)
        {
    ...
    else if(game.mission == doom)
    {
        ...
        else if(canmodify && *authors[game.episode * 10 + game.map][game.mission])
            C_TabbedOutput(tabs, "Author\t%s",
            authors[game.episode * 10 + game.map][game.mission]);
    }
    else if(canmodify && *authors[game.map][game.mission])
        C_TabbedOutput(tabs, "Author\t%s", authors[game.map][game.mission]);
    ...
    if(game.mode == commercial)
    {
        ...
        else
        {
            if(customepisodes)
            {
                if(**episodes[maptoepisode[game.map] - 1])
                {
                    temp = titlecase(*episodes[maptoepisode[game.map] - 1]);

                    if(maptoepisode[game.map] == 1 && EpiDef.numitems == 1)
                        C_TabbedOutput(tabs, "Episode\t" ITALICS("%s"), temp);
                    else
                        C_TabbedOutput(tabs, "Episode\t" ITALICS("%s") " (%i of %i)",
                        temp, maptoepisode[game.map], EpiDef.numitems);

                    free(temp);
                }
                else
                    C_TabbedOutput(tabs, "Episode\t%i of %i",
                    maptoepisode[game.map], EpiDef.numitems);
            }
        }
    }
    else
    {
        if(customepisodes)
        {
            if(**episodes[maptoepisode[game.map] - 1])
            {
                ...
                C_TabbedOutput(tabs, "Episode\t%i of %i", maptoepisode[game.map],
                EpiDef.numitems);
        }
        else
        {
            temp = titlecase(*episodes[game.episode - 1]);
            C_TabbedOutput(tabs, "Episode\t" ITALICS("%s") " (%i of %i)", temp, game.episode,
            (game.mode == retail ? 4 :
                                  (game.mode == shareware ? 1 : 3)));
            free(temp);
        }
    ...
    C_TabbedOutput(
    tabs, INDENT "MD5\t" MONOSPACED("%s"), MD5(lumpinfo[lump]->wadfile->path));

    if(wadtype == PWAD)
    {
        M_StringCopy(wadname,
        leafname(lumpinfo[W_GetLastNumForName("PLAYPAL")]->wadfile->path),
        sizeof(wadname));
    ...
    (mbfcompatible ?
    ITALICS("MBF") :
    (boomcompatible ? ITALICS("BOOM") : (numsegs < 32768 ? "Vanilla" : "Limit removing"))))));
    ...
    if(partime)
    {
        ...
        if(hours)
            C_TabbedOutput(tabs,
            "Par time\t" MONOSPACED("%02i") ":" MONOSPACED("%02i") ":" MONOSPACED("%02i"),
    ...
    temp = commify(game.stats.kills);
    C_TabbedOutput(tabs, INDENT "Monsters\t%s", temp);
    free(temp);

    temp = commify(game.stats.pickups);
    ...
    temp = commify(game.stats.barrels);
    C_TabbedOutput(tabs, INDENT "Barrels\t%s", temp);
    free(temp);

    if(game.stats.player1starts > 1)
    {
        temp = commify(game.stats.player1starts);
    ...
    temp = commify(game.stats.secrets);
    ...
    if(units == units_metric)
    {
        ...
        if(metricwidth < METERSPERKILOMETER &&
        metricheight < METERSPERKILOMETER && metricdepth < METERSPERKILOMETER)
        {
            ...
            C_TabbedOutput(tabs, "Dimensions\t%sx%sx%s %s", temp1, temp2, temp3,
            (english == english_american ? "meters" : "metres"));
            free(temp1);
            free(temp2);
            free(temp3);
        }
        else
        {
            ...
            C_TabbedOutput(tabs, "Dimensions\t%sx%sx%s %s", temp1, temp2, temp3,
            (english == english_american ? "kilometers" : "kilometres"));
            free(temp1);
            free(temp2);
            free(temp3);
        }
    ...
    if(mus_playing && !nomusic)
    {
        int lumps;
        char namebuf[9];
        const char* musicartist = P_GetMapMusicComposer(game.episode, game.map);
        const char* musictitle  = P_GetMapMusicTitle(game.episode, game.map);
        ...
        !M_StringCompare(mus_playing->title1, "n/a"))
            C_TabbedOutput(tabs, INDENT "Title\t" ITALICS("%s"), mus_playing->title1);
        else if(lumps == 1 && wadtype == IWAD && game.mission == pack_tnt)
            C_TabbedOutput(
            tabs, INDENT "Title\t" ITALICS("%s"), tntmusic[game.map - 1].title);
        else if(!M_StringCompare(mus_playing->title1, "n/a") &&
        (((game.mode == commercial || game.episode > 1) && lumps == 1 && wadtype == IWAD) ||
        (game.mode != commercial && game.episode == 1 && lumps == 2) ||
        game.mode == shareware || game.mission == pack_nerve))
            C_TabbedOutput(tabs, INDENT "Title\t" ITALICS("%s"), mus_playing->title1);
        ...
        if(*musicartist)
            ...
            C_TabbedOutput(tabs, INDENT "Artist\t%s", tntmusic[game.map - 1].artist);
        else if(((game.mode == commercial || game.episode > 1) && lumps == 1 && wadtype == IWAD) ||
        (game.mode != commercial && game.episode == 1 && lumps == 2) ||
        game.mode == shareware || game.mission == pack_nerve)
            C_TabbedOutput(tabs, INDENT "Artist\tBobby Prince");
            
        if(musictype == MUS_MUS)
            C_TabbedOutput(tabs, INDENT "Format\tDMX MUS");
        else if(musictype == MUS_MIDI)
            C_TabbedOutput(tabs, INDENT "Format\tGeneral MIDI");
        else if(musictype == MUS_MDTS)
            C_TabbedOutput(tabs, INDENT "Format\tMUDTracker");

        if(lumpinfo[mus_playing->lumpnum]->wadfile->type == PWAD)
        {
            C_TabbedOutput(tabs, INDENT "PWAD\t%s",
            leafname(lumpinfo[mus_playing->lumpnum]->wadfile->path));

            if(namebuf[0] == 'H' && namebuf[1] == '_')
                C_TabbedOutput(tabs, INDENT INDENT "Release date\tAugust 8, 2024");

            if(!M_StringCompare(lumpinfo[lump]->wadfile->path,
               lumpinfo[mus_playing->lumpnum]->wadfile->path))
...
static void name_func2(char* cmd, char* parms)
{
    ...
    else if(M_StringCompare(namecmdold, "player") || M_StringCompare(namecmdold, playername) ||
    ...
    else
    {
        ...
        for(thinker_t* th = thinkers[th_mobj].cnext; th != &thinkers[th_mobj];
        th                = th->cnext)
        {
            mobj_t* mobj          = (mobj_t*)th;
            ...
            if(((namecmdanymonster && (flags & MF_SHOOTABLE) && type != MT_BARREL && type != MT_PLAYER) ||
               type == namecmdtype) &&
            ((namecmdfriendly && (flags & MF_FRIEND)) || !namecmdfriendly) &&
            mobj->health > 0 && P_CheckSight(viewplayer->mo, mobj))
            {
        ...
        if(bestmobj)
        {
            ...
            (isvowel(namecmdold[0]) ? "An" : "A"),
            (namecmdfriendly ? "friendly " : ""), namecmdold);
    }
}
...
static void newgame_func2(char* cmd, char* parms)
{
    ...
    G_DeferredInitNew((skill_t)(skilllevel - 1),
    (game.mode == commercial ? expansion : episode), 1);
}
            ...
            if(!M_StringCompare(s_music[i].title1, s_music[i].title2))
            {
                ...
                if(*s_music[i].title3)
                {
                    ...
                    if(M_StringCompare(parm, titlebuf))
                    {
                        ...
                        if(W_CheckNumForName(namebuf) == -1)
                            M_snprintf(
                            namebuf, sizeof(namebuf), "d_%s", s_music[i].name2);
        ...
        if(units == units_imperial)
        {
            if(feet >= 1.0)
            {
                if(feet < FEETPERMILE)
                {
                    ...
                    M_snprintf(result, sizeof(result), "%s %s", temp,
                    (M_StringCompare(temp, "1") ? "foot" : "feet"));
                    free(temp);
                }
                else
                {
            ...
            if(meters >= 0.1)
            {
                if(meters < METERSPERKILOMETER)
                {
                    ...
                    if(!M_StringCompare(temp2, "0.0"))
                        M_snprintf(result, sizeof(result), "%s %s", temp2,
                        (english == english_american ? "meters" : "metres"));
                ...
                else
                {
                    ...
                    M_snprintf(result, sizeof(result), "%s %s", temp1,
                    (english == english_american ? "kilometers" : "kilometres"));
                    free(temp2);
                    free(temp1);
                }
                ...
                M_StringCopy(result,
                (english == english_american ? "0 meters" : "0 metres"), sizeof(result));
        }
    }
...
static void ShowMonsterKillStat_Game(const int tabs[MAXTABS], const mobjtype_t type)
{
    if(type > MT_NULL && type < NUMMOBJTYPES)
    {
        ...
        char* temp3 = commify(game.stats.monstercount[type]);
        char* temp4 = commifystat(stat_monsterskilled[type]);

        C_TabbedOutput(tabs, INDENT "%s\t%s of %s (%i%%)\t%s", temp1, temp2, temp3,
        (game.stats.monstercount[type] ? viewplayer->monsterskilled[type] * 100 / game.stats.monstercount[type] : 0),
        temp4);
...
static void C_PlayerStats_Game(void)
{
    ...
    int time1                    = game.stats.maptime / TICRATE;
    ...
    C_TabbedOutput(tabs, "Maps finished\t\x96\t%s of %s (%i%%)", temp1, temp2,
    (stat_mapsstarted ? stat_mapsfinished * 100 / stat_mapsstarted : 0));
    free(temp1);
    free(temp2);
    ...
    {
        temp1 = titlecase(*skilllevels[game.skill]);
    ...
    temp2 = commify(game.stats.kills);
    temp3 = commifystat(stat_monsterskilled_total);
    C_TabbedOutput(tabs, "Monsters %s %s\t%s of %s (%i%%)\t%s",
    (M_StringCompare(playername, playername_default) ? "you" : playername),
    s_KILLED, temp1, temp2, (game.stats.kills ? killcount * 100 / game.stats.kills : 0), temp3);
    free(temp1);
    free(temp2);
    free(temp3);
    ...
    temp3 = commify(game.stats.barrels);
    temp4 = commifystat(stat_barrelsexploded);
    C_TabbedOutput(tabs, "%s exploded\t%s of %s (%i%%)\t%s", temp1, temp2, temp3,
    (game.stats.barrels ? viewplayer->monsterskilled[MT_BARREL] * 100 / game.stats.barrels : 0), temp4);
    free(temp1);
    free(temp2);
    free(temp3);
    free(temp4);
    ...
    temp2 = commify(game.stats.items);
    temp3 = commifystat(stat_itemspickedup);
    C_TabbedOutput(tabs, "Items picked up\t%s of %s (%i%%)\t%s", temp1, temp2,
    (game.stats.items ? viewplayer->itemcount * 100 / game.stats.items : 0), temp3);
    free(temp1);
    free(temp2);
    free(temp3);

    temp1 = commify((int64_t)viewplayer->itemspickedup_ammo_bullets +
    viewplayer->itemspickedup_ammo_shells + viewplayer->itemspickedup_ammo_rockets +
    viewplayer->itemspickedup_ammo_cells);
    temp2 = commify(stat_itemspickedup_ammo[am_clip] +
    stat_itemspickedup_ammo[am_shell] + stat_itemspickedup_ammo[am_misl] +
    stat_itemspickedup_ammo[am_cell]);
    ...
    temp2 = commify(game.stats.secrets);
    temp3 = commifystat(stat_secretsfound);
    C_TabbedOutput(tabs, "Secrets found\t%s of %s (%i%%)\t%s", temp1, temp2,
    (game.stats.secrets ? viewplayer->secretcount * 100 / game.stats.secrets : 0), temp3);
    free(temp1);
    free(temp2);
    free(temp3);
    ...
    if(sucktime && hours1 >= sucktime)
    {
        if(hours2 >= 100)
            ...
            C_TabbedOutput(tabs,
            "Time played\t%s\t" MONOSPACED("%i") ":" MONOSPACED("%02i") ":" MONOSPACED("%02i"),
            s_STSTR_SUCKS, hours2, time2 / 60, time2 % 60);
        else
            C_TabbedOutput(tabs,
            "Time played\t%s\t" MONOSPACED("%02i") ":" MONOSPACED("%02i"),
    ...
    else if(hours1)
    {
        if(hours2 >= 100)
            C_TabbedOutput(tabs,
            "Time played\t" MONOSPACED("%i") ":" MONOSPACED(
            "%02i") ":" MONOSPACED("%02i") "\tOver %s hours!",
            hours1, time1 / 60, time1 % 60, temp2);
        else if(hours2)
            C_TabbedOutput(tabs,
            "Time played\t" MONOSPACED("%i") ":" MONOSPACED("%02i") ":" MONOSPACED(
            "%02i") "\t" MONOSPACED("%i") ":" MONOSPACED("%02i") ":" MONOSPACED("%02i") "",
    ...
    {
        if(hours2 >= 100)
            C_TabbedOutput(tabs, "Time played\t" MONOSPACED("%02i") ":" MONOSPACED("%02i") "\tOver %s hours!",
            time1 / 60, time1 % 60, temp2);
        else if(hours2)
            C_TabbedOutput(tabs,
            "Time played\t" MONOSPACED("%02i") ":" MONOSPACED("%02i") "\t" MONOSPACED(
            "%i") ":" MONOSPACED("%02i") ":" MONOSPACED("%02i"),
            time1 / 60, time1 % 60, hours2, time2 / 60, time2 % 60);
        else
            C_TabbedOutput(tabs,
            "Time played\t" MONOSPACED("%02i") ":" MONOSPACED(
            "%02i") "\t" MONOSPACED("%02i") ":" MONOSPACED("%02i"),
    ...
    viewplayer->shotssuccessful[wp_pistol] + viewplayer->shotssuccessful[wp_shotgun] +
    viewplayer->shotssuccessful[wp_supershotgun] +
    viewplayer->shotssuccessful[wp_chaingun] + viewplayer->shotssuccessful[wp_missile] +
    ...
    viewplayer->shotsfired[wp_chainsaw] + viewplayer->shotsfired[wp_pistol] +
    viewplayer->shotsfired[wp_shotgun] + viewplayer->shotsfired[wp_supershotgun] +
    viewplayer->shotsfired[wp_chaingun] + viewplayer->shotsfired[wp_missile] +
    ...
    stat_shotssuccessful[wp_chainsaw] + stat_shotssuccessful[wp_pistol] +
    stat_shotssuccessful[wp_shotgun] + stat_shotssuccessful[wp_supershotgun] +
    stat_shotssuccessful[wp_chaingun] + stat_shotssuccessful[wp_missile] +
    stat_shotssuccessful[wp_plasma] +
    stat_shotssuccessful[wp_bfg];
    temp3 = commify(shotssuccessful2);

    shotsfired2 = stat_shotsfired[wp_fist] + stat_shotsfired[wp_chainsaw] +
    stat_shotsfired[wp_pistol] + stat_shotsfired[wp_shotgun] +
    stat_shotsfired[wp_supershotgun] + stat_shotsfired[wp_chaingun] +
    ...
    temp1, temp2, (shotsfired1 ? shotssuccessful1 * 100 / shotsfired1 : 0), temp3,
    temp4, (shotsfired2 ? (int)(shotssuccessful2 * 100 / shotsfired2) : 0));
    free(temp1);
    free(temp2);
    free(temp3);
    free(temp4);
    ...
    C_TabbedOutput(tabs, INDENT "%s\t%s of %s (%i%%)\t%s of %s (%i%%)", temp1, temp2, temp3,
    (viewplayer->shotsfired[wp_fist] ?
    viewplayer->shotssuccessful[wp_fist] * 100 / viewplayer->shotsfired[wp_fist] :
    0),
    temp4, temp5,
    (stat_shotsfired[wp_fist] ?
    (int)(stat_shotssuccessful[wp_fist] * 100 / stat_shotsfired[wp_fist]) :
    0));
    free(temp1);
    free(temp2);
    free(temp3);
    ...
    viewplayer->shotssuccessful[wp_chainsaw] * 100 / viewplayer->shotsfired[wp_chainsaw] :
    0),
    temp4, temp5,
    (stat_shotsfired[wp_chainsaw] ?
    (int)(stat_shotssuccessful[wp_chainsaw] * 100 / stat_shotsfired[wp_chainsaw]) :
    0));
    free(temp1);
    free(temp2);
    free(temp3);
    ...
    viewplayer->shotssuccessful[wp_pistol] * 100 / viewplayer->shotsfired[wp_pistol] :
    0),
    temp4, temp5,
    (stat_shotsfired[wp_pistol] ?
    (int)(stat_shotssuccessful[wp_pistol] * 100 / stat_shotsfired[wp_pistol]) :
    0));
    free(temp1);
    free(temp2);
    free(temp3);
    ...
    viewplayer->shotssuccessful[wp_shotgun] * 100 / viewplayer->shotsfired[wp_shotgun] :
    0),
    temp4, temp5,
    (stat_shotsfired[wp_shotgun] ?
    (int)(stat_shotssuccessful[wp_shotgun] * 100 / stat_shotsfired[wp_shotgun]) :
    0));
    free(temp1);
    free(temp2);
    free(temp3);
    ...
    if(game.mode == commercial)
    {
        ...
        viewplayer->shotssuccessful[wp_supershotgun] * 100 / viewplayer->shotsfired[wp_supershotgun] :
        0),
        temp4, temp5,
        (stat_shotsfired[wp_supershotgun] ?
        (int)(stat_shotssuccessful[wp_supershotgun] * 100 / stat_shotsfired[wp_supershotgun]) :
        0));
        free(temp1);
        free(temp2);
        free(temp3);
    ...
    viewplayer->shotssuccessful[wp_chaingun] * 100 / viewplayer->shotsfired[wp_chaingun] :
    0),
    temp4, temp5,
    (stat_shotsfired[wp_chaingun] ?
    (int)(stat_shotssuccessful[wp_chaingun] * 100 / stat_shotsfired[wp_chaingun]) :
    0));
    free(temp1);
    free(temp2);
    free(temp3);
    ...
    viewplayer->shotssuccessful[wp_missile] * 100 / viewplayer->shotsfired[wp_missile] :
    0),
    temp4, temp5,
    (stat_shotsfired[wp_missile] ?
    (int)(stat_shotssuccessful[wp_missile] * 100 / stat_shotsfired[wp_missile]) :
    0));
    free(temp1);
    free(temp2);
    free(temp3);
    ...
    if(game.mode != shareware)
    {
        ...
        temp1, temp2, temp3,
        (viewplayer->shotsfired[wp_plasma] ?
        viewplayer->shotssuccessful[wp_plasma] * 100 / viewplayer->shotsfired[wp_plasma] :
        0),
        temp4, temp5,
        (stat_shotsfired[wp_plasma] ?
        (int)(stat_shotssuccessful[wp_plasma] * 100 / stat_shotsfired[wp_plasma]) :
        0));
        free(temp1);
        free(temp2);
        free(temp3);
        ...
        temp1, temp2, temp3,
        (viewplayer->shotsfired[wp_bfg] ?
        viewplayer->shotssuccessful[wp_bfg] * 100 / viewplayer->shotsfired[wp_bfg] :
        0),
        temp4, temp5,
        (stat_shotsfired[wp_bfg] ?
        (int)(stat_shotssuccessful[wp_bfg] * 100 / stat_shotsfired[wp_bfg]) :
        0));
        free(temp1);
        free(temp2);
        free(temp3);
    ...
    temp1 = titlecase(
    weaponinfo[(favoriteweapon1 == wp_nochange ? viewplayer->readyweapon : favoriteweapon1)]
    .name);
    temp2 = titlecase(
    weaponinfo[(favoriteweapon2 == wp_nochange ? viewplayer->readyweapon : favoriteweapon2)]
    .name);
...
static void C_PlayerStats_NoGame(void)
{
    ...
    else
    {
        ...
        if(hours1)
            C_TabbedOutput(tabs,
            "Time played\t\x96\t" MONOSPACED("%i") ":" MONOSPACED("%02i") ":" MONOSPACED("%02i"),
            hours1, time1 / 60, time1 % 60);
        else
            C_TabbedOutput(tabs,
            "Time played\t\x96\t" MONOSPACED("%02i") ":" MONOSPACED("%02i"),
            time1 / 60, time1 % 60);
    }
    ...
    shotsfired = stat_shotsfired[wp_fist] + stat_shotsfired[wp_chainsaw] +
    stat_shotsfired[wp_pistol] + stat_shotsfired[wp_shotgun] +
    stat_shotsfired[wp_supershotgun] + stat_shotsfired[wp_chaingun] +
    stat_shotsfired[wp_missile] +
    stat_shotsfired[wp_plasma] +
    ...
    C_TabbedOutput(tabs, "Shots successful/fired\t\x96\t%s of %s (%i%%)", temp1,
    temp2, (shotsfired ? (int)(shotssuccessful * 100 / shotsfired) : 0));
    free(temp1);
    free(temp2);
    ...
    C_TabbedOutput(tabs, INDENT "%s\t\x96\t%s of %s (%i%%)", temp1, temp2, temp3,
    (stat_shotsfired[wp_fist] ?
    (int)(stat_shotssuccessful[wp_fist] * 100 / stat_shotsfired[wp_fist]) :
    0));
    free(temp1);
...
static void readme_func2(char* cmd, char* parms)
{
    ...
    else
    {
        ...
        if(!M_FileExists(readme))
            ...
            FS_OpenURI(readme, leafname(readme));
...
static void releasenotes_func2(char* cmd, char* parms)
{
    ...
    FS_OpenURI(DOOMRETRO_RELEASENOTESURL, "release notes");
}
...
static void reset_func2(char* cmd, char* parms)
{
    ...
    M_StringCompare(parms, "armour") || M_StringCompare(parms, "armortype") ||
    M_StringCompare(parms, "armourtype") || M_StringCompare(parms, "health") ||
    ...
    for(int i = 0; *consolecmds[i].name; i++)
    {
        ...
        if(consolecmds[i].type == CT_CVAR && !(flags & CF_READONLY))
        {
            ...
            if(flags & CF_BOOLEAN)
            {
                char* temp1 = C_LookupAliasFromValue(
                (bool)consolecmds[i].defaultnumber, consolecmds[i].aliases);
                ...
                if(*(bool*)consolecmds[i].variable != (bool)consolecmds[i].defaultnumber)
                {
                    ...
                    C_Output("The " BOLD("%s") " CVAR has been reset to its "
                                               "default of " BOLD("%s") ".",
                    ...
                    C_Warning(0,
                    "The " BOLD(
                    "%s") " CVAR is already set to its default of " BOLD("%s") ".",
                    consolecmds[i].name, temp1);
            ...
            {
                char* temp1 = C_LookupAliasFromValue(
                (int)consolecmds[i].defaultnumber, consolecmds[i].aliases);
            ...
            {
                char* temp = M_StringJoin(parms, " ",
                (*consolecmds[i].defaultstring ? consolecmds[i].defaultstring : EMPTYVALUE),
                NULL);

                if(!M_StringCompare(*(char**)consolecmds[i].variable,
                   consolecmds[i].defaultstring))
                {
                    ...
                    C_Warning(0,
                    "The " BOLD("%s") " CVAR is already set to its default "
                                      "of " BOLD("\"%s\"") ".",
                    consolecmds[i].name, consolecmds[i].defaultstring);
            }
        }
...
static void C_VerifyResetAll(const int key)
{
    ...
    if(key == 'y')
    {
        ...
        for(int i = 0; *consolecmds[i].name; i++)
        {
            ...
            if(consolecmds[i].type == CT_CVAR && !(flags & CF_READONLY))
            {
                if(M_StringCompare(name, "ammo") || M_StringCompare(name, "armor") ||
                M_StringCompare(name, "armour") || M_StringCompare(name, "armortype") ||
                M_StringCompare(name, "armourtype") ||
                M_StringCompare(name, "health") || M_StringCompare(name, "weapon"))
                    continue;
        ...
        keyboardmaxzoom2        = KEYMAXZOOM2_DEFAULT;
        ...
        keyboardweapon1_2       = KEYWEAPON1_2_DEFAULT;
        keyboardweapon2         = KEYWEAPON2_DEFAULT;
        keyboardweapon2_2       = KEYWEAPON2_2_DEFAULT;
        keyboardweapon3         = KEYWEAPON3_DEFAULT;
        keyboardweapon3_2       = KEYWEAPON3_2_DEFAULT;
        keyboardweapon4         = KEYWEAPON4_DEFAULT;
        keyboardweapon4_2       = KEYWEAPON4_2_DEFAULT;
        keyboardweapon5         = KEYWEAPON5_DEFAULT;
        keyboardweapon5_2       = KEYWEAPON5_2_DEFAULT;
        keyboardweapon6         = KEYWEAPON6_DEFAULT;
        keyboardweapon6_2       = KEYWEAPON6_2_DEFAULT;
        keyboardweapon7         = KEYWEAPON7_DEFAULT;
        keyboardweapon7_2       = KEYWEAPON7_2_DEFAULT;
...
static void resetall_func2(char* cmd, char* parms)
{
    ...
    M_snprintf(resetallstring,
    sizeof(resetallstring), "Are you sure you want to reset all CVARs\nand controls to their defaults?\n\n%s",
    line2);
...
static bool resurrect_func1(char* cmd, char* parms)
{
    ...
    M_StringCompare(parm, "all") || M_StringCompare(parm, "friend") ||
    M_StringCompare(parm, "friends") || M_StringCompare(parm, "friendly monster") ||
    M_StringCompare(parm, "friendly monsters"))
        result = true;
    else
    {
        for(int i = 0, num = -1; i < NUMMOBJTYPES; i++)
...
static void resurrect_func2(char* cmd, char* parms)
{
    ...
    else
    {
        ...
        {
            bool friends = (M_StringCompare(parm, "friend") ||
            M_StringCompare(parm, "friends") || M_StringCompare(parm, "friendly monster") ||
            M_StringCompare(parm, "friendly monsters"));
            bool enemies =
            (M_StringCompare(parm, "monster") || M_StringCompare(parm, "monsters"));
            ...
            if(friends || enemies || all)
            {
                ...
                if(resurrected)
                {
                    ...
                    M_snprintf(buffer, sizeof(buffer),
                    "%s%s dead monster%s in this map %s been resurrected.",
                    (resurrected == 1 ? "The " : "All "), temp,
                    (resurrected == 1 ? "" : "s"), (resurrected == 1 ? "has" : "have"));
                    C_Output(buffer);
                    C_HideConsole();
                    HU_SetPlayerMessage(buffer, false, false);
                    free(temp);
            ...
            else if(resurrectcmdmobj)
            {
                ...
                if((resurrectcmdmobj->flags & MF_CORPSE) &&
                !(resurrectcmdmobj->flags2 & MF2_DECORATION) &&
                resurrectcmdmobj->type != MT_PLAYER &&
                resurrectcmdmobj->info->raisestate != S_NULL)
            ...
            else
            {
                ...
                else
                {
                    ...
                    C_Warning(0, "There are no dead %s to resurrect.",
                    mobjinfo[type].plural1);
                }
            }
        }
...
static void spawn_func2(char* cmd, char* parms)
{
    ...
    else
    {
        ...
        if(game.mode != commercial)
        {
            if(spawncmdtype >= ArchVile && spawncmdtype <= MonsterSpawner)
            {
                ...
                C_Warning(0, "%s can't be spawned in " ITALICS("%s") ".", buffer, game.description);
                spawn = false;
            }

            if(game.mode == shareware &&
            (spawncmdtype == SpiderMastermind || spawncmdtype == Cyberdemon ||
            spawncmdtype == CellPack || spawncmdtype == HelperDog || spawncmdtype == PlasmaRifle ||
            spawncmdtype == BFG9000 || spawncmdtype == Berserk || spawncmdtype == Cell))
            {
                M_StringCopy(buffer, mobjinfo[type].plural1, sizeof(buffer));
                ...
                buffer[0] = toupper(buffer[0]);
                C_Warning(0,
                "%s can't be spawned in the shareware version of " ITALICS(
                "DOOM") ". "
            ...
            else
            {
                ...
                if((thing = P_SpawnMapThing(&mthing, true)))
                {
                    ...
                    if(flags & MF_SHOOTABLE)
                    {
                        ...
                        {
                            fog        = P_SpawnMobj(x, y,
                                   ((flags & MF_NOGRAVITY) ? thing->z : ONFLOORZ), MT_TFOG);
                    ...
                    else
                    {
                        ...
                        {
                            fog        = P_SpawnMobj(x, y,
                                   ((flags & MF_SPAWNCEILING) ?
                                   ONCEILINGZ :
                                   ((thing->flags2 & MF2_FLOATBOB) ? thing->floorz + 14 * FRACUNIT : ONFLOORZ)),
                                   MT_IFOG);
                            fog->angle = thing->angle;
    ...
    else
    {
        ...
        if(M_StringCompare(parm, "all") || M_StringCompare(parm, "everything"))
        {
            ...
            if(viewplayer->health > initial_health)
            {
                ...
                viewplayer->health - initial_health, false, false);
                healthcvar = false;
                result     = true;
            }
            ...
            for(int i = 0; i < NUMPOWERS; i++)
                ...
                {
                    viewplayer->powers[i] =
                    (i == pw_allmap || i == pw_strength ? 0 : STARTFLASHING);
                    result = true;
                }
        ...
        {
            if(viewplayer->health > 0 && !(viewplayer->cheats & CF_GODMODE) &&
        ...
        M_StringCompare(parm, "armour") || M_StringCompare(parm, "allarmour"))
        {
            if(viewplayer->armor)
            {
                ...
                C_Warning(0, "%s doesn't have any %s!", playername,
                (english == english_american ? "armor" : "armour"));
        }
        else if(M_StringCompare(parm, "keys") || M_StringCompare(parm, "allkeys"))
        {
            ...
            if(result)
            {
                P_LookForCards();
                C_PlayerWarning(
                "All keycards and skull keys have been taken from %s!",
                (M_StringCompare(playername, playername_default) ? "you" : playername));
                C_HideConsole();
            }
            else if(M_StringCompare(playername, playername_default))
        ...
        else if(M_StringCompare(parm, "keycards") || M_StringCompare(parm, "allkeycards"))
        {
            ...
            viewplayer->cards[it_redcard] > 0 || viewplayer->cards[it_yellowcard] > 0)
            {
        ...
        else if(M_StringCompare(parm, "skullkeys") || M_StringCompare(parm, "allskullkeys"))
        {
            ...
            viewplayer->cards[it_redskull] > 0 || viewplayer->cards[it_yellowskull] > 0)
            {
            ...
            for(int i = 0, num = -1; i < NUMMOBJTYPES; i++)
            {
                ...
                (sscanf(parm, "%10i", &num) == 1 && num == mobjinfo[i].doomednum && num != -1)))
                {
                    if(P_TakeSpecialThing(i))
                    {
                        ...
                        C_Warning(0, "%s doesn't have %s %s!", playername,
                        (isvowel(mobjinfo[i].name1[0]) ? "an" : "a"),
                        mobjinfo[i].name1);
                }
    ...
    else
    {
        ...
        if(sscanf(parms, "%10i %10i %10i", &x, &y, &z) >= 2)
        {
            ...
            else if(P_TeleportMove(mo, x, y, z, false))
            {
                ...
                viewplayer->viewz = mo->z + viewplayer->v_viewheight;
                ...
                {
                    if(M_StringCompare(playername, playername_default))
                        C_PlayerMessage("You were teleported to (%i, %i).",
                        x >> FRACBITS, y >> FRACBITS);
                    else
                        C_PlayerMessage("%s was teleported to (%i, %i).",
...
static void thinglist_func2(char* cmd, char* parms)
{
    ...
    th                = th->cnext)
    {
        ...
        if(mobj == viewplayer->mo)
            ...
            ((flags & MF_CORPSE) && !(mobj->flags2 & MF2_DECORATION) ?
            "dead " :
            ((flags & MF_FRIEND) && mobj->type != MT_PLAYER ?
            "friendly " :
            ((flags & MF_DROPPED) ? "dropped " : ""))),
            (mobj->type == MT_PLAYER ? "voodoo doll" :
                                       (*mobj->info->name1 ? mobj->info->name1 : "\x96")));

        temp = sentencecase(name);

        if(mobj->id >= 0)
            C_TabbedOutput(tabs, MONOSPACED("%4i") ".\t%s\t(%i, %i, %i)\t%i\xB0",
            mobj->id, temp, mobj->x >> FRACBITS, mobj->y >> FRACBITS,
            mobj->z >> FRACBITS, (angle == 360 ? 0 : angle));
        else
            C_TabbedOutput(tabs, "\t%s\t(%i, %i, %i)\t%i\xB0", temp, mobj->x >> FRACBITS,
            mobj->y >> FRACBITS, mobj->z >> FRACBITS, (angle == 360 ? 0 : angle));
            ...
            else
            {
                ...
                if(timer)
                    C_Output("The timer has been %s to %s minute%s. "
                             "%s will automatically exit each map once the "
                             "timer runs out.",
...
static void toggle_func2(char* cmd, char* parms)
{
    ...
    for(int i = 0; *consolecmds[i].name; i++)
    {
        ...
        if(consolecmds[i].type == CT_CVAR &&
        M_StringCompare(parms, consolecmds[i].name) && !(flags & CF_READONLY) &&
        (flags & CF_BOOLEAN))
        {
            char* temp1 = C_LookupAliasFromValue(
            !(*(bool*)consolecmds[i].variable), consolecmds[i].aliases);
            char* temp2 = M_StringJoin(parms, " ", temp1, NULL);
...
static void wiki_func2(char* cmd, char* parms)
{
    ...
    FS_OpenURI(DOOMRETRO_WIKIURL, DOOMRETRO_WIKINAME);
}
...
static void bool_cvars_func2(char* cmd, char* parms)
{
    for(int i = 0; *consolecmds[i].name; i++)
        if(M_StringCompare(cmd, consolecmds[i].name) &&
        consolecmds[i].type == CT_CVAR && (consolecmds[i].flags & CF_BOOLEAN))
        {
            ...
            {
                char* temp1 = C_LookupAliasFromValue(
                *(bool*)consolecmds[i].variable, BOOLVALUEALIAS);
                ...
                {
                    char* temp2 = C_LookupAliasFromValue(
                    (bool)consolecmds[i].defaultnumber, BOOLVALUEALIAS);
...
static bool float_cvars_func1(char* cmd, char* parms)
{
    ...
    for(int i = 0; *consolecmds[i].name; i++)
        if(M_StringCompare(cmd, consolecmds[i].name) &&
        consolecmds[i].type == CT_CVAR && (consolecmds[i].flags & CF_FLOAT))
        {
            float value;
    ...
    for(int i = 0; *consolecmds[i].name; i++)
        ...
        consolecmds[i].type == CT_CVAR && (consolecmds[i].flags & CF_FLOAT))
        {
            if(*parms && !(consolecmds[i].flags & CF_READONLY))
            {
                ...
                if(sscanf(parms, "%10f", &value) == 1 &&
                value != *(float*)consolecmds[i].variable)
                {
            ...
            else
            {
                ...
                if(*(float*)consolecmds[i].variable == (float)consolecmds[i].defaultnumber)
                    C_Output(((consolecmds[i].flags & CF_READONLY) ? INTEGERCVARWITHNODEFAULT :
                                                                     INTEGERCVARISDEFAULT),
                    temp1);
                else
                {
                    char* temp2 = striptrailingzero(consolecmds[i].defaultnumber, 1);

                    C_Output(((consolecmds[i].flags & CF_READONLY) ?
                             INTEGERCVARWITHNODEFAULT :
                             INTEGERCVARWITHDEFAULT),
                    temp1, temp2);
                    free(temp2);
                }
...
static bool int_cvars_func1(char* cmd, char* parms)
{
    ...
    for(int i = 0; *consolecmds[i].name; i++)
        if(M_StringCompare(cmd, consolecmds[i].name) &&
        consolecmds[i].type == CT_CVAR && (consolecmds[i].flags & CF_INTEGER))
        {
    ...
    for(int i = 0; *consolecmds[i].name; i++)
        ...
        consolecmds[i].type == CT_CVAR && (consolecmds[i].flags & CF_INTEGER))
        {
            if(*parms && !(consolecmds[i].flags & CF_READONLY))
            {
                ...
                if((value != INT_MIN || sscanf(parms, "%10i", &value) == 1) &&
                value != *(int*)consolecmds[i].variable)
                {
            ...
            else
            {
                ...
                {
                    char* temp1 = C_LookupAliasFromValue(
                    *(int*)consolecmds[i].variable, consolecmds[i].aliases);
...
static void str_cvars_func2(char* cmd, char* parms)
{
    for(int i = 0; *consolecmds[i].name; i++)
        if(M_StringCompare(cmd, consolecmds[i].name) &&
        consolecmds[i].type == CT_CVAR && (consolecmds[i].flags & CF_STRING))
        {
            ...
            else
            {
                ...
                else if(M_StringCompare(*(char**)consolecmds[i].variable,
                        consolecmds[i].defaultstring))
                    C_Output(STRINGCVARISDEFAULT, *(char**)consolecmds[i].variable);
                else
                    C_Output(STRINGCVARWITHDEFAULT,
...
static void time_cvars_func2(char* cmd, char* parms)
{
    for(int i = 0; *consolecmds[i].name; i++)
        if(M_StringCompare(cmd, consolecmds[i].name) &&
        consolecmds[i].type == CT_CVAR && (consolecmds[i].flags & CF_TIME))
        {
            int tics               = *(int*)consolecmds[i].variable;
            int seconds            = tics / TICRATE;
            const int milliseconds = (tics % TICRATE) * (1000 / TICRATE);
            ...
            if(hours)
                C_Output(TIMECVARWITHNODEFAULT2, hours, minutes, seconds % 60,
                milliseconds / 10);
            else
...
static void am_pathlength_func2(char* cmd, char* parms)
{
    ...
    else
    {
        ...
        {
            char* temp2 =
            C_LookupAliasFromValue(am_pathlength_default, PATHLENGTHVALUEALIAS);
...
{
    return (!*parms ||
    (C_LookupValueFromAlias(parms, ARMORTYPEVALUEALIAS) != INT_MIN && game.state == GS_LEVEL));
}
...
static void armortype_func2(char* cmd, char* parms)
{
    ...
    {
        char* temp = C_LookupAliasFromValue(
        (game.state == GS_LEVEL ? viewplayer->armortype : armortype_default), ARMORTYPEVALUEALIAS);
        const int i = C_GetIndex(cmd);
...
static void autotilt_func2(char* cmd, char* parms)
{
    ...
    if(autotilt != autotilt_old && game.state == GS_LEVEL)
    {
        suppresswarnings = true;
        R_InitSkyMap();
        suppresswarnings = false;
...
static void con_timestampformat_func2(char* cmd, char* parms)
{
    if(*parms)
    {
        ...
        if((value == con_timestampformat_military || value == con_timestampformat_standard) &&
        value != con_timestampformat)
        {
    ...
    else
    {
        ...
        {
            char* temp2 =
            C_LookupAliasFromValue(con_timestampformat_default, TIMESTAMPVALUEALIAS);
...
static void episode_func2(char* cmd, char* parms)
{
    ...
    if(episode != episode_old && game.mode != commercial)
        EpiDef.laston = MIN(episode,
                        (game.mode == retail ? 4 :
                                              (game.mode == shareware ? 1 : 3))) -
        1;
}
...
static void expansion_func2(char* cmd, char* parms)
{
    ...
    if(expansion != expansion_old && game.mode == commercial)
    {
        ExpDef.laston = 0;

        if(game.state != GS_LEVEL)
            game.mission = (expansion == 2 ? pack_nerve : doom2);
    }
}
...
static void freelook_func2(char* cmd, char* parms)
{
    ...
    if(freelook != freelook_old && game.state == GS_LEVEL)
    {
        suppresswarnings = true;
        R_InitSkyMap();
        suppresswarnings = false;
...
static bool joy_deadzone_cvars_func1(char* cmd, char* parms)
{
    ...
    return (!*parms || sscanf(parms, "%10f%%", &value) == 1 ||
    sscanf(parms, "%10f", &value) == 1);
}
    ...
    if(*parms)
    {
        ...
        if(sscanf(parms, "%10f%%", &value) == 1 || sscanf(parms, "%10f", &value) == 1)
        {
            if(M_StringCompare(cmd, stringize(joy_deadzone_left)))
            {
                ...
                {
                    joy_deadzone_left =
                    BETWEENF(joy_deadzone_left_min, value, joy_deadzone_left_max);
            ...
            {
                joy_deadzone_right =
                BETWEENF(joy_deadzone_right_min, value, joy_deadzone_right_max);
...
static bool player_cvars_func1(char* cmd, char* parms)
{
    return (!*parms || (int_cvars_func1(cmd, parms) && game.state == GS_LEVEL));
}
...
static void player_cvars_func2(char* cmd, char* parms)
{
    ...
    if(M_StringCompare(cmd, stringize(ammo)))
    {
        ...
        if(*parms)
        {
            ...
            value != viewplayer->ammo[ammotype] && viewplayer->health > 0)
            {
                ...
                if((value = MIN(value, viewplayer->maxammo[ammotype])) >
                viewplayer->ammo[ammotype])
                {
        ...
        {
            char* temp = commify(game.state == GS_LEVEL ?
    ...
    else if(M_StringCompare(cmd, stringize(armor)))
    {
        ...
        {
            char* temp = commify(game.state == GS_LEVEL ? viewplayer->armor : armor_default);
    ...
    !(viewplayer->cheats & CF_GODMODE) && !viewplayer->powers[pw_invulnerability])
    {
        if(*parms)
        {
            ...
            {
                value = BETWEEN(((viewplayer->cheats & CF_BUDDHA) ? 1 : HUD_NUMBER_MIN),
                value, maxhealth);
                ...
                if(viewplayer->health <= 0)
                {
                    ...
                    else
                    {
                        ...
                        if(M_StringCompare(playername, playername_default))
                            M_StringCopy(
                            buffer, "You resurrected yourself!", sizeof(buffer));
                        else
                            M_snprintf(buffer, sizeof(buffer),
                            "%s resurrected %s!", playername, pronoun(reflexive));
        ...
        {
            char* temp = commify(game.state == GS_LEVEL ?
            (negativehealth && minuspatch && !viewplayer->health ? viewplayer->negativehealth :
                                                                   viewplayer->health) :
            health_default);
...
static void r_blood_func2(char* cmd, char* parms)
{
    if(*parms)
    {
        ...
        if(value != INT_MIN && r_blood != value)
        {
            ...
            for(int i = 0; i < numsectors; i++)
                for(bloodsplat_t* splat = sectors[i].splatlist; splat;
                splat                   = splat->next)
    ...
    if(*parms)
    {
        ...
        if((value == 0 || value == 1) && value != r_corpses_mirrored)
        {
            ...
            for(int i = 0; i < numsectors; i++)
                for(mobj_t* thing = sectors[i].thinglist; thing; thing = thing->snext)
                {
                    if((thing->flags & MF_CORPSE) && !(thing->flags2 & MF2_NOMIRROREDCORPSE) &&
                    thing->type != MT_PAIN)
                    {
...
static void r_fixmaperrors_func2(char* cmd, char* parms)
{
    if(*parms)
    {
        ...
        if((value == 0 || value == 1) && value != r_fixmaperrors)
        {
            ...
            if(game.state == GS_LEVEL && !togglingvanilla && !resettingcvar)
            {
                if(M_StringCompare(playername, playername_default))
                    C_Warning(0, NEXTMAPWARNING1);
                else
        ...
        if((value == 0 || value == 1) && value != r_mirroredweapons)
        {
            ...
            for(int i = 0; i < numsectors; i++)
                for(mobj_t* thing = sectors[i].thinglist; thing; thing = thing->snext)
                {
                    ...
                    if(((type >= MT_MISC25 && type <= MT_SUPERSHOTGUN) &&
...
static void r_randomstartframes_func2(char* cmd, char* parms)
{
    ...
    else
    {
        ...
        {
            char* temp2 =
            C_LookupAliasFromValue(r_randomstartframes_default, BOOLVALUEALIAS);
...
static void r_scale_func2(char* cmd, char* parms)
{
    if(*parms)
    {
        ...
        if(strlen(parms) == 1 && value >= r_scale_min &&
        value <= r_scale_max && value != r_scale)
        {
            if(R_ResizeRenderState(value))
            {
                r_scale = value;
                I_RestartGraphics(false);
                M_SaveCVARs();
                ...
                C_Warning(0, "Failed to resize render state to scale %d.", value);
        }
    }
    else
    {
        char* temp1 = commify(r_scale);
        const int i = C_GetIndex(cmd);

        C_ShowDescription(i);

        if(r_scale == r_scale_default)
            C_Output(INTEGERCVARISDEFAULT, temp1);
        else
        {
            char* temp2 = commify(r_scale_default);
...
static void r_screensize_func2(char* cmd, char* parms)
{
    if(*parms)
    {
        ...
        if(strlen(parms) == 1 && value >= r_screensize_min &&
        value <= r_screensize_max && value != r_screensize)
        {
            r_screensize = value;
            S_StartSound(NULL, sfx_stnmov);
            R_SetViewSize(r_screensize);
...
static void r_sprites_translucency_func2(char* cmd, char* parms)
{
    ...
    else
    {
        ...
        {
            char* temp2 =
            C_LookupAliasFromValue(r_sprites_translucency_default, BOOLVALUEALIAS);
...
static void r_textures_translucency_func2(char* cmd, char* parms)
{
    ...
    else
    {
        ...
        {
            char* temp2 =
            C_LookupAliasFromValue(r_textures_translucency_default, BOOLVALUEALIAS);
...
static void s_randommusic_func2(char* cmd, char* parms)
{
    ...
    if(s_randommusic != s_randommusic_old && game.state == GS_LEVEL)
        S_Start();
}
...
static bool s_volume_cvars_func1(char* cmd, char* parms)
{
    ...
    return ((M_StringCompare(cmd, stringize(s_musicvolume)) &&
            value >= s_musicvolume_min && value <= s_musicvolume_max) ||
    (M_StringCompare(cmd, stringize(s_sfxvolume)) && value >= s_sfxvolume_min &&
    value <= s_sfxvolume_max));
}
...
static void s_volume_cvars_func2(char* cmd, char* parms)
{
    if(*parms)
    {
        ...
        {
            s_musicvolume = value;
            if(s_musicvolume < s_musicvolume_min)
                s_musicvolume = s_musicvolume_min;
            else if(s_musicvolume > s_musicvolume_max)
                s_musicvolume = s_musicvolume_max;
        ...
        {
            s_sfxvolume = value;
            if(s_sfxvolume < s_sfxvolume_min)
                s_sfxvolume = s_sfxvolume_min;
            else if(s_sfxvolume > s_sfxvolume_max)
                s_sfxvolume = s_sfxvolume_max;
            M_SaveCVARs();
        }
    }
...
static bool sucktime_func1(char* cmd, char* parms)
{
    return (C_LookupValueFromAlias(parms, SUCKSVALUEALIAS) != INT_MIN ||
...
#if !defined(_WIN32)
    || M_StringCompare(parms, vid_scaleapi_opengles) || M_StringCompare(parms, vid_scaleapi_opengles2)
#endif
...
static bool weapon_func1(char* cmd, char* parms)
{
    if(!*parms)
        return true;
    else if(game.state != GS_LEVEL || viewplayer->pendingweapon != wp_nochange ||
    viewplayer->health <= 0)
        return false;
    else
    {
        ...
        return (value != INT_MIN && value != viewplayer->readyweapon &&
...
static void weapon_func2(char* cmd, char* parms)
{
    ...
    {
        char* temp = C_LookupAliasFromValue(
        (game.state == GS_LEVEL ? viewplayer->readyweapon : weapon_default), WEAPONVALUEALIAS);
        char description[255];
        ...
        if(game.mode == shareware)
            ...
            M_StringCopy(description, consolecmds[C_GetIndex(cmd)].description,
            sizeof(description));

...
#define CONSOLEEDGECOLOR1 176
#define CONSOLEEDGECOLOR2 182
...
#define CONSOLEHEIGHT \
    ((game.state == GS_TITLESCREEN ? video.screen_height : video.screen_height / 2) - 5)

#define CONSOLELINES (game.state == GS_TITLESCREEN ? 27 : 13)
#define CONSOLETEXTX (vid_widescreen ? MAX(video.max_widescreen_delta - 18, 10) : 10)
...
#define CONSOLESCROLLBARHEIGHT \
    (CONSOLEHEIGHT - (game.state == GS_TITLESCREEN ? 26 : 22))
#define CONSOLESCROLLBARX (video.screen_width - CONSOLETEXTX - CONSOLESCROLLBARWIDTH)

#define CONSOLETEXTPIXELWIDTH \
    (video.screen_width - CONSOLETEXTX * 2 - (scrollbardrawn ? CONSOLESCROLLBARWIDTH + 15 : 10))

#define CONSOLEINPUTX CONSOLETEXTX
#define CONSOLEINPUTY (CONSOLEHEIGHT - 16)

#define CONSOLEINPUTPIXELWIDTH (video.screen_width - CONSOLETEXTX * 2 - 2)

#define OVERLAYTEXTX (vid_widescreen ? video.max_widescreen_delta - 18 : 14)
#define OVERLAYTEXTY \
    (vid_widescreen && r_screensize == r_screensize_max ? 17 : 11)
#define OVERLAYLINEHEIGHT 14
#define OVERLAYSPACING 7
#define OVERLAYFPSGRAPHWIDTH 44
#define OVERLAYFPSGRAPHHEIGHT 8

...
#include "render/r_patch.h"
#include "render/r_state.h"

// Runtime values - use render.lookdir_max and render.lookdirs
#define LOOKDIRMAX render.lookdir_max
#define LOOKDIRS   render.lookdirs

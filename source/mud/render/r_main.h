...
extern int v_viewwindowx;
extern int v_viewwindowy;

extern int r_centerx;
extern int r_centery;

extern fixed_t r_centerxfrac;
extern fixed_t r_centeryfrac;
extern fixed_t r_projection;
extern fixed_t r_viewheightfrac;

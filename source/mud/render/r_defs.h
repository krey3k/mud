...
typedef struct line_s
{
    ...
    int r_validcount; // cph: if == game.time, r_flags already done
...
enum
{
    ...
    OffsetTargetFloorTextureByLineDirection                             = 2048,
    OffsetTargetCeilingTextureByLineDirection                           = 2049,
    OffsetTargetFloorAndCeilingTextureByLineDirection                   = 2050,
    RotateTargetFloorTextureByLineAngle                                 = 2051,
    RotateTargetCeilingTextureByLineAngle                               = 2052,
    RotateTargetFloorAndCeilingTextureByLineAngle                       = 2053,
    OffsetThenRotateTargetFloorTextureByLineDirectionAndAngle           = 2054,
    OffsetThenRotateTargetCeilingTextureByLineDirectionAndAngle         = 2055,
    OffsetThenRotateTargetFloorAndCeiilngTextureByLineDirectionAndAngle = 2056,
    W1_ChangeMusicAndMakeItLoopOnlyIfATrackIsDefined                    = 2057,
    WR_ChangeMusicAndMakeItLoopOnlyIfATrackIsDefined                    = 2058,
    S1_ChangeMusicAndMakeItLoopOnlyIfATrackIsDefined                    = 2059,
    SR_ChangeMusicAndMakeItLoopOnlyIfATrackIsDefined                    = 2060,
    G1_ChangeMusicAndMakeItLoopOnlyIfATrackIsDefined                    = 2061,
    GR_ChangeMusicAndMakeItLoopOnlyIfATrackIsDefined                    = 2062,
    W1_ChangeMusicAndMakeItPlayOnlyOnceAndStopAllMusicAfter             = 2063,
    WR_ChangeMusicAndMakeItPlayOnlyOnceAndStopAllMusicAfter             = 2064,
    S1_ChangeMusicAndMakeItPlayOnlyOnceAndStopAllMusicAfter             = 2065,
    SR_ChangeMusicAndMakeItPlayOnlyOnceAndStopAllMusicAfter             = 2066,
    G1_ChangeMusicAndMakeItPlayOnlyOnceAndStopAllMusicAfter             = 2067,
    GR_ChangeMusicAndMakeItPlayOnlyOnceAndStopAllMusicAfter             = 2068,
    W1_ExitToTheNextMapAndResetInventory                                = 2069,
    S1_ExitToTheNextMapAndResetInventory                                = 2070,
    G1_ExitToTheNextMapAndResetInventory                                = 2071,
    W1_ExitToTheSecretMapAndResetInventory                              = 2072,
    S1_ExitToTheSecretMapAndResetInventory                              = 2073,
    G1_ExitToTheSecretMapAndResetInventory                              = 2074,
    SetTheTargetSectorsColormap                                         = 2075,
    W1_SetTheTargetSectorsColormap                                      = 2076,
    WR_SetTheTargetSectorsColormap                                      = 2077,
    S1_SetTheTargetSectorsColormap                                      = 2078,
    SR_SetTheTargetSectorsColormap                                      = 2079,
    G1_SetTheTargetSectorsColormap                                      = 2080,
    GR_SetTheTargetSectorsColormap                                      = 2081,
    ScrollBothFrontAndBackSidedefsTexturesAccordingToTheLinesLeftDirection = 2082,
    ScrollBothFrontAndBackSidedefsTexturesAccordingToTheLinesRightDirection = 2083,
    ScrollBothFrontAndBackSidedefsTexturesAccordingTheTargetSectorsScrollValuesDividedBy8 = 2084,
    ScrollBothFrontAndBackSidedefsTexturesAccordingTheTargetSectorsMovementDividedBy8 = 2085,
    ScrollBothFrontAndBackSidedefsTexturesAndAccelerateTheScrollValueByTheTargetSectorsMovementDividedBy8 =
    2086,
    W1_ChangeMusicAndMakeItLoop_ResetToLoopingDefaultIfNoTrackDefined = 2087,
    WR_ChangeMusicAndMakeItLoop_ResetToLoopingDefaultIfNoTrackDefined = 2088,
    S1_ChangeMusicAndMakeItLoop_ResetToLoopingDefaultIfNoTrackDefined = 2089,
    SR_ChangeMusicAndMakeItLoop_ResetToLoopingDefaultIfNoTrackDefined = 2090,
    G1_ChangeMusicAndMakeItLoop_ResetToLoopingDefaultIfNoTrackDefined = 2091,
    GR_ChangeMusicAndMakeItLoop_ResetToLoopingDefaultIfNoTrackDefined = 2092,
    W1_ChangeMusicAndMakeItPlayOnlyOnce_ResetToLoopingDefaultIfNoTrackDefined = 2093,
    WR_ChangeMusicAndMakeItPlayOnlyOnce_ResetToLoopingDefaultIfNoTrackDefined = 2094,
    S1_ChangeMusicAndMakeItPlayOnlyOnce_ResetToLoopingDefaultIfNoTrackDefined = 2095,
    SR_ChangeMusicAndMakeItPlayOnlyOnce_ResetToLoopingDefaultIfNoTrackDefined = 2096,
    G1_ChangeMusicAndMakeItPlayOnlyOnce_ResetToLoopingDefaultIfNoTrackDefined = 2097,
    GR_ChangeMusicAndMakeItPlayOnlyOnce_ResetToLoopingDefaultIfNoTrackDefined = 2098,

    NUMLINESPECIALS = 2098
};
...
typedef struct seg_s
{
    ...
    // Required for node construction using NanoBSP
    struct seg_s* next;
} seg_t;
...
// NOTE: top and bottom arrays are dynamically allocated based on max_width.
// The pad fields provide sentinel values for [minx-1] and [maxx+1] access.
//

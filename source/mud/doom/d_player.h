...
typedef struct player_s
{
    ...
    fixed_t v_viewheight;

    // Bob/squat speed.
    fixed_t deltaviewheight;

    // killough 10/98: used for realistic bobbing (i.e. not simply overall
    // speed) mo->momx and mo->momy represent true momenta experienced by
    // player. This only represents the thrust that the player applies himself.

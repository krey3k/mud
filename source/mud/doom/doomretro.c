...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    else if(msg == WM_GETMINMAXINFO)
    {
        ...
        (vid_widescreen ? V_WIDEVANILLAWIDTH : V_VANILLAWIDTH) + video.window_border_width;
        minmaxinfo->ptMinTrackSize.y = V_ACTUALVANILLAHEIGHT + video.window_border_height;

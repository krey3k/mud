...
// doomdef.h - Core DOOM definitions and types
//
// This header provides fundamental game definitions used throughout the codebase.
// It should remain lightweight and avoid platform-specific dependencies.
//
// For platform interfaces, include the specific headers directly:
//   i_video.h    - Video/display interface
//   i_sound.h    - Sound effects interface
//   i_music.h    - Music playback interface
//   i_input.h    - Input handling interface
//   m_controls.h - Control bindings

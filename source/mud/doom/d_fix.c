...
vertexfix_t vertexfix[] = {
    ...
    { doom, 2, 6, 646, 64, 2008, 66, 2006 }, { doom, 2, 6, 647, 112, 1960, 111, 1961 },
    { doom, 2, 6, 648, -368, 1960, -367, 1961 },
    { doom, 2, 6, 649, -320, 2008, -322, 2006 },

    { doom, 2, 7, 255, 2880, 624, 2880, 629 }, { doom, 2, 7, 378, 3824, 640, 3828, 640 },
    { doom, 2, 7, 379, 3840, 624, 3840, 629 }, { doom, 2, 7, 379, 2896, 640, 2892, 640 },
    { doom, 2, 7, 381, 2896, 640, 2892, 640 }, { doom, 2, 7, 393, 1944, 1024, 1952, 1024 },
...
linefix_t linefix[] = {
    // mission,    episode, map, linedef, side, toptexture, middletexture, bottomtexture,
    // offset, rowoffset, flags,                     special, tag

    { doom, 1, 1, 159, 1, "", "", "", DEFAULT, DEFAULT, ML_SECRET, DEFAULT, DEFAULT },
    { doom, 1, 1, 471, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_LowerToLowestFloor_ChangesTexture, DEFAULT },
    ...
    { doom, 1, 1, 482, 1, "", "", "", DEFAULT, DEFAULT,
    (ML_DONTDRAW | ML_SECRET), DEFAULT, DEFAULT },
    { doom, 1, 1, 483, 1, "", "", "", DEFAULT, DEFAULT,
    (ML_DONTDRAW | ML_SECRET), DEFAULT, DEFAULT },
    ...
    { doom, 2, 2, 536, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    DR_Door_Yellow_OpenWaitClose, DEFAULT },
    { doom, 2, 2, 547, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    DR_Door_Yellow_OpenWaitClose, DEFAULT },
    ...
    { doom, 3, 6, 298, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Teleport_MonstersOnly, DEFAULT },
    { doom, 3, 6, 299, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Teleport_MonstersOnly, DEFAULT },
    ...
    { doom, 3, 9, 24, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    DR_Door_OpenWaitClose_AlsoMonsters, DEFAULT },
    ...
    { doom, 4, 3, 735, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToLowestCeiling, DEFAULT },
    ...
    { doom2, 1, 1, 334, 1, "", "MIDBARS3", "BROWNGRN", DEFAULT, DEFAULT,
    DEFAULT, DEFAULT, DEFAULT },
    { doom2, 1, 1, 335, 1, "", "MIDBARS3", "BROWNGRN", DEFAULT, DEFAULT,
    DEFAULT, DEFAULT, DEFAULT },
    { doom2, 1, 1, 369, 1, "", "MIDBARS3", "BROWNGRN", DEFAULT, DEFAULT,
    DEFAULT, DEFAULT, DEFAULT },
    ...
    { doom2, 1, 8, 270, 1, "COMPTALL", "", "", DEFAULT, DEFAULT,
    ML_DONTPEGBOTTOM, DEFAULT, DEFAULT },
    { doom2, 1, 8, 276, 1, "COMPTALL", "", "", DEFAULT, DEFAULT,
    ML_DONTPEGBOTTOM, DEFAULT, DEFAULT },
    ...
    { doom2, 1, 10, 786, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    DR_Door_OpenWaitClose_AlsoMonsters, DEFAULT },
    ...
    { doom2, 1, 13, 879, 1, "BROWN144", "MIDBRONZ", "", DEFAULT, DEFAULT,
    DEFAULT, DEFAULT, DEFAULT },
    ...
    { doom2, 1, 14, 1259, 1, "BSTONE2", "", "BSTONE2", DEFAULT, DEFAULT,
    DEFAULT, DEFAULT, DEFAULT },
    ...
    { doom2, 1, 22, 120, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    S1_Floor_RaiseToNextHighestFloor_ChangesTexture, DEFAULT },
    ...
    { doom2, 1, 22, 530, 0, "METAL2", "", "METAL2", DEFAULT, DEFAULT,
    ML_DRAWASWALL, DEFAULT, DEFAULT },
    { doom2, 1, 22, 539, 0, "METAL2", "", "METAL2", DEFAULT, DEFAULT,
    ML_DRAWASWALL, DEFAULT, DEFAULT },
    { doom2, 1, 22, 542, 0, "METAL2", "", "METAL2", DEFAULT, DEFAULT,
    ML_DRAWASWALL, DEFAULT, DEFAULT },
    { doom2, 1, 22, 543, 0, "METAL2", "", "METAL2", DEFAULT, DEFAULT,
    ML_DRAWASWALL, DEFAULT, DEFAULT },
    { doom2, 1, 22, 544, 0, "METAL2", "", "METAL2", DEFAULT, DEFAULT,
    ML_DRAWASWALL, DEFAULT, DEFAULT },
    { doom2, 1, 22, 545, 0, "METAL2", "", "METAL2", DEFAULT, DEFAULT,
    ML_DRAWASWALL, DEFAULT, DEFAULT },
    { doom2, 1, 22, 548, 0, "METAL2", "", "METAL2", DEFAULT, DEFAULT,
    ML_DRAWASWALL, DEFAULT, DEFAULT },
    ...
    { doom2, 1, 27, 727, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    SR_Floor_LowerTo8AboveHighestFloor, DEFAULT },
    { doom2, 1, 27, 810, 1, "", "", "WOODVERT", DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT },
    { doom2, 1, 27, 814, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    DR_Door_Red_OpenWaitClose, DEFAULT },
    ...
    { doom2, 1, 28, 584, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 585, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 586, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 587, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 588, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 589, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 590, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 591, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 592, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 593, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 594, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    { doom2, 1, 28, 595, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor, 5 },
    ...
    { pack_plut, 1, 12, 230, 1, "", "MIDGRATE", "", DEFAULT, DEFAULT,
    ML_BLOCKING, DEFAULT, DEFAULT },
    ...
    { pack_plut, 1, 30, 730, 0, "ROCKRED1", "", "ROCKRED1", DEFAULT, DEFAULT,
    DEFAULT, DEFAULT, DEFAULT },
    ...
    { pack_tnt, 1, 7, 999, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor_Fast, 16 },
    { pack_tnt, 1, 7, 1000, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor_Fast, 16 },
    { pack_tnt, 1, 7, 1001, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor_Fast, 16 },
    { pack_tnt, 1, 7, 1002, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor_Fast, 16 },
    { pack_tnt, 1, 7, 1003, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor_Fast, 16 },
    { pack_tnt, 1, 7, 1004, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor_Fast, 16 },
    { pack_tnt, 1, 7, 1005, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor_Fast, 16 },
    { pack_tnt, 1, 7, 1006, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor_Fast, 16 },
    { pack_tnt, 1, 7, 1007, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    W1_Floor_RaiseToNextHighestFloor_Fast, 16 },
    ...
    { pack_tnt, 1, 31, 138, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    S1_Floor_LowerToLowestFloor, DEFAULT },
    { pack_tnt, 1, 31, 279, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    S1_Floor_LowerToLowestFloor, DEFAULT },
    ...
    { pack_tnt, 1, 31, 2527, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    S1_Floor_LowerToLowestFloor, DEFAULT },
    { pack_tnt, 1, 31, 2528, 1, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    S1_Floor_LowerToLowestFloor, DEFAULT },
    ...
    { pack_tnt, 1, 32, 872, 0, "", "", "", DEFAULT, DEFAULT, DEFAULT,
    SR_Door_OpenStay_Fast, DEFAULT },
...
sectorfix_t sectorfix[] = {
    ...
    { pack_plut, 1, 16, 95, "", "", DEFAULT, DEFAULT,
    DamageNegative10Or20PercentHealth, DEFAULT, DEFAULT },
    { pack_plut, 1, 16, 96, "", "", DEFAULT, DEFAULT,
    DamageNegative10Or20PercentHealth, DEFAULT, DEFAULT },
...
thingfix_t thingfix[] = {
    ...
    { doom2, 1, 15, 301, HeavyWeaponDude, 1488, -1984, 1488, -1984, DEFAULT,
    (MTF_NORMAL | MTF_HARD) },
    ...
    { doom2, 1, 19, 112, TeleportDestination, -912, -880, -912, -880, DEFAULT,
    (MTF_EASY | MTF_NORMAL | MTF_HARD) },
    ...
    { doom2, 1, 31, 265, WolfensteinSS, -4576, 1952, -4576, 1952, DEFAULT,
    (MTF_NORMAL | MTF_HARD) },
    ...
    { pack_tnt, 1, 31, 470, YellowKeycard, -2727, -1976, -2727, -1976, DEFAULT,
    (MTF_EASY | MTF_NORMAL | MTF_HARD) },

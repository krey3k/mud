...
#define HUD_HEALTH_X (video.max_widescreen_delta + 2)
#define HUD_HEALTH_Y (video.screen_height - 32)
#define HUD_HEALTH_MIN 20
#define HUD_HEALTH_WAIT 250
#define HUD_HEALTH_HIGHLIGHT_WAIT 250

#define HUD_ARMOR_X (video.max_widescreen_delta + 71)
#define HUD_ARMOR_Y HUD_HEALTH_Y
#define HUD_ARMOR_HIGHLIGHT_WAIT 250

#define HUD_KEYS_X (video.screen_width - video.max_widescreen_delta - 35)
#define HUD_KEYS_Y HUD_HEALTH_Y

#define HUD_AMMO_X (video.screen_width - video.max_widescreen_delta + 2)
...
#define ALTHUD_LEFT_X (video.max_widescreen_delta + 9)
#define ALTHUD_RIGHT_X (video.screen_width - video.max_widescreen_delta - 136)
#define ALTHUD_Y (video.screen_height - 41)

...
// m_config.h - Configuration Variables (CVARs)
//
// This header declares all configurable game settings. Variables are grouped by category:
//   - General gameplay settings
//   - Automap settings (am_*)
//   - Console settings (con_*)
//   - Controller/Joystick settings (joy_*)
//   - Mouse settings (m_*)
//   - Rendering settings (r_*)
//   - Sound/Music settings (s_*)
//   - Video/Display settings (vid_*)
//   - Player statistics (stat_*)
...
#define r_buildnodes_default true
...
#define r_gamma_max gammalevels[V_GAMMALEVELS - 1]
...
#define r_scale_min 1
#define r_scale_default 2
#define r_scale_max 6
...
#define s_musicvolume_default 31
#define s_musicvolume_max 31

#define s_randommusic_default false

#define s_sfxvolume_min 0
#define s_sfxvolume_default 31
#define s_sfxvolume_max 31
...
// =============================================================================
// KEYBOARD CONTROL DEFAULTS (KEY*_DEFAULT)
// =============================================================================
...
// =============================================================================
// MOUSE CONTROL DEFAULTS (MOUSE*_DEFAULT)
// =============================================================================
...
// =============================================================================
// CONTROLLER CONTROL DEFAULTS (CONTROLLER*_DEFAULT)
// =============================================================================

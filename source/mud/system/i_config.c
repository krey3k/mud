...
bool r_buildnodes                = r_buildnodes_default;
...
#define CVAR_BOOL(name1, name2, cvar, alias) \
    { #name1, #name2, &cvar, DEFAULT_BOOL, alias }
#define CVAR_INT(name1, name2, cvar, alias) \
    { #name1, #name2, &cvar, DEFAULT_INT32, alias }
#define CVAR_INT_PERCENT(name1, name2, cvar, alias) \
    { #name1, #name2, &cvar, DEFAULT_INT32_PERCENT, alias }
#define CVAR_FLOAT(name1, name2, cvar, alias) \
    { #name1, #name2, &cvar, DEFAULT_FLOAT, alias }
#define CVAR_FLOAT_PERCENT(name1, name2, cvar, alias) \
    { #name1, #name2, &cvar, DEFAULT_FLOAT_PERCENT, alias }
#define CVAR_STRING(name1, name2, cvar, alias) \
    { #name1, #name2, &cvar, DEFAULT_STRING, alias }
#define CVAR_OTHER(name1, name2, cvar, alias) \
    { #name1, #name2, &cvar, DEFAULT_OTHER, alias }
#define STAT_INT_UNSIGNED(name1, name2, cvar, alias) \
    { #name1, #name2, &cvar, DEFAULT_UINT64, alias }

static default_t cvars[] = { COMMENT("; CVARs"),
    ...
    CVAR_BOOL(r_buildnodes, r_buildnodes, r_buildnodes, BOOLVALUEALIAS),
    ...
    CVAR_INT(r_scale, r_scale, r_scale, NOVALUEALIAS),
    ...
    CVAR_INT(s_musicvolume, s_musicvolume, s_musicvolume, NOVALUEALIAS),
    CVAR_BOOL(s_randommusic, s_randommusic, s_randommusic, BOOLVALUEALIAS),
    CVAR_INT(s_sfxvolume, s_sfxvolume, s_sfxvolume, NOVALUEALIAS),
    ...
    BLANKLINE, COMMENT("; player stats"),
    ...
    STAT_INT_UNSIGNED(itemspickedup_ammo_bullets,
    stat_itemspickedup_ammo_bullets,
    stat_itemspickedup_ammo[am_clip],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(itemspickedup_ammo_shells,
    stat_itemspickedup_ammo_shells,
    stat_itemspickedup_ammo[am_shell],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(itemspickedup_ammo_rockets,
    stat_itemspickedup_ammo_rockets,
    stat_itemspickedup_ammo[am_misl],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(itemspickedup_ammo_cells,
    ...
    STAT_INT_UNSIGNED(monsterskilled_infighting,
    stat_monsterskilled_infighting,
    stat_monsterskilled_infighting,
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_arachnotrons,
    stat_monsterskilled_arachnotrons,
    stat_monsterskilled[MT_BABY],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_archviles,
    stat_monsterskilled_archviles,
    stat_monsterskilled[MT_VILE],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_banshees,
    stat_monsterskilled_banshees,
    stat_monsterskilled[MT_BANSHEE],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_baronsofhell,
    stat_monsterskilled_baronsofhell,
    stat_monsterskilled[MT_BRUISER],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_cacodemons,
    stat_monsterskilled_cacodemons,
    stat_monsterskilled[MT_HEAD],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_chaingunners,
    stat_monsterskilled_heavyweapondudes,
    stat_monsterskilled[MT_CHAINGUY],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_cyberdemons,
    stat_monsterskilled_cyberdemons,
    stat_monsterskilled[MT_CYBORG],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_ghouls,
    stat_monsterskilled_ghouls,
    stat_monsterskilled[MT_GHOUL],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_hellknights,
    stat_monsterskilled_hellknights,
    stat_monsterskilled[MT_KNIGHT],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_imps, stat_monsterskilled_imps, stat_monsterskilled[MT_TROOP], NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_lostsouls,
    stat_monsterskilled_lostsouls,
    stat_monsterskilled[MT_SKULL],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_mancubi,
    stat_monsterskilled_mancubi,
    stat_monsterskilled[MT_FATSO],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_mindweavers,
    stat_monsterskilled_mindweavers,
    stat_monsterskilled[MT_MINDWEAVER],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_painelementals,
    stat_monsterskilled_painelementals,
    stat_monsterskilled[MT_PAIN],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_pinkydemons,
    stat_monsterskilled_demons,
    stat_monsterskilled[MT_SERGEANT],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_revenants,
    stat_monsterskilled_revenants,
    stat_monsterskilled[MT_UNDEAD],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_shocktroopers,
    stat_monsterskilled_shocktroopers,
    stat_monsterskilled[MT_SHOCKTROOPER],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_shotgunguys,
    stat_monsterskilled_shotgunguys,
    stat_monsterskilled[MT_SHOTGUY],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_spectres,
    stat_monsterskilled_spectres,
    stat_monsterskilled[MT_SHADOWS],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_spidermasterminds,
    stat_monsterskilled_spidermasterminds,
    stat_monsterskilled[MT_SPIDER],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_tyrants,
    stat_monsterskilled_tyrants,
    stat_monsterskilled[MT_TYRANT],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_vassagos,
    stat_monsterskilled_vassagos,
    stat_monsterskilled[MT_VASSAGO],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(monsterskilled_zombiemen,
    stat_monsterskilled_zombiemen,
    stat_monsterskilled[MT_POSSESSED],
    NOVALUEALIAS),
    ...
    STAT_INT_UNSIGNED(shotsfired_supershotgun,
    ...
    STAT_INT_UNSIGNED(shotsfired_rocketlauncher,
    ...
    STAT_INT_UNSIGNED(shotssuccessful_chainsaw,
    stat_shotssuccessful_chainsaw,
    stat_shotssuccessful[wp_chainsaw],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(shotssuccessful_pistol,
    stat_shotssuccessful_pistol,
    stat_shotssuccessful[wp_pistol],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(shotssuccessful_shotgun,
    stat_shotssuccessful_shotgun,
    stat_shotssuccessful[wp_shotgun],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(shotssuccessful_supershotgun,
    stat_shotssuccessful_supershotgun,
    stat_shotssuccessful[wp_supershotgun],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(shotssuccessful_chaingun,
    stat_shotssuccessful_chaingun,
    stat_shotssuccessful[wp_chaingun],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(shotssuccessful_rocketlauncher,
    stat_shotssuccessful_rocketlauncher,
    stat_shotssuccessful[wp_missile],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(shotssuccessful_plasmarifle,
    stat_shotssuccessful_plasmarifle,
    stat_shotssuccessful[wp_plasma],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(shotssuccessful_bfg9000,
    stat_shotssuccessful_bfg9000,
    stat_shotssuccessful[wp_bfg],
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(shotssuccessful_incinerator,
    stat_shotssuccessful_incinerator,
    stat_shotssuccessful_incinerator,
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(shotssuccessful_calamityblade,
    stat_shotssuccessful_calamityblade,
    stat_shotssuccessful_calamityblade,
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(skilllevel_imtooyoungtodie,
    stat_skilllevel_imtooyoungtodie,
    stat_skilllevel_imtooyoungtodie,
    NOVALUEALIAS),
    STAT_INT_UNSIGNED(skilllevel_heynottoorough,
    stat_skilllevel_heynottoorough,
    stat_skilllevel_heynottoorough,
    NOVALUEALIAS),
...
valuealias_t valuealiases[] = { { "none", armortype_none, ARMORTYPEVALUEALIAS },
    { "green", armortype_green, ARMORTYPEVALUEALIAS },
    { "blue", armortype_blue, ARMORTYPEVALUEALIAS },
    { "none", r_blood_none, BLOODVALUEALIAS }, { "red", r_blood_red, BLOODVALUEALIAS },
    { "all", r_blood_all, BLOODVALUEALIAS }, { "green", r_blood_green, BLOODVALUEALIAS },
    { "nofuzz", r_blood_nofuzz, BLOODVALUEALIAS }, { "off", 0, BOOLVALUEALIAS },
    { "0", 0, BOOLVALUEALIAS }, { "false", 0, BOOLVALUEALIAS },
    { "no", 0, BOOLVALUEALIAS }, { "on", 1, BOOLVALUEALIAS }, { "1", 1, BOOLVALUEALIAS },
    { "true", 1, BOOLVALUEALIAS }, { "yes", 1, BOOLVALUEALIAS },
    { "off", 0, CAPVALUEALIAS }, { "none", crosshair_none, CROSSHAIRVALUEALIAS },
    ...
    { "low", r_detail_low, DETAILVALUEALIAS }, { "high", r_detail_high, DETAILVALUEALIAS },
    ...
    { "off", 1, GAMMAVALUEALIAS }, { "other", playergender_other, GENDERVALUEALIAS },
    ...
    { "off", 0, SUCKSVALUEALIAS }, { "imperial", units_imperial, UNITSVALUEALIAS },
...
#endif
    { "off", vid_vsync_off, VSYNCVALUEALIAS }, { "on", vid_vsync_on, VSYNCVALUEALIAS },
    { "fists", wp_fist, WEAPONVALUEALIAS }, { "pistol", wp_pistol, WEAPONVALUEALIAS },
    { "shotgun", wp_shotgun, WEAPONVALUEALIAS }, { "chaingun", wp_chaingun, WEAPONVALUEALIAS },
    ...
    { "supershotgun", wp_supershotgun, WEAPONVALUEALIAS }, { "", 0, NOVALUEALIAS } };

static void SaveBind(fs_file* file, const char* control, const char* action)
{
    if(action[0] == '+')
    {
        if(strlen(control) == 1)
            FS_Print(file, "bind '%s' %s\n", (control[0] == '=' ? "+" : control), action);
        else
            FS_Print(file, "bind %s %s\n", control, action);
    }
    else
...
static void SaveBindByValue(fs_file* file, char* action, int value, controltype_t type)
{
...
void M_SaveCVARs(void)
{
    ...
    if(!(file = FS_OpenFile(configfile, FS_WRITE, FS_TRUE)))
    {
        static bool warning;
    ...
    for(int i = 0; i < numcvars; i++)
    {
        ...
        if(cvars[i].name[0] == ';')
        {
            FS_PutString(cvars[i].name, file);
            continue;
        }

        // Print the name
        FS_Print(file, "%-*s ", widestcvar, cvars[i].name);
        ...
        case DEFAULT_BOOL:
        {
            ...
            for(int j = 0; *valuealiases[j].text; j++)
                if(value == valuealiases[j].value &&
                cvars[i].valuealiastype == valuealiases[j].type)
                {
                    FS_PutString(valuealiases[j].text, file);
                    alias = true;
                    break;
                }
        ...
        case DEFAULT_STRING:
            ...
            M_StringCompare(cvars[i].name, stringize(version)))
                FS_PutString(*(char**)cvars[i].location, file);
            else
                FS_Print(file, "\"%s\"", *(char**)cvars[i].location);
    ...
    for(int i = 0; *actions[i].action; i++)
    {
        if(actions[i].controller1 && *(int*)actions[i].controller1)
            SaveBindByValue(file, actions[i].action,
            *(int*)actions[i].controller1, controllercontrol);

        if(actions[i].controller2 && *(int*)actions[i].controller2)
            SaveBindByValue(file, actions[i].action,
            *(int*)actions[i].controller2, controllercontrol);
    }
...
static int ParseBoolParameter(const char* cvar, const char* value, const int valuealiastype)
{
    ...
    for(int i = 0; *valuealiases[i].text; i++)
        if(M_StringCompare(value, valuealiases[i].text) &&
        valuealiastype == valuealiases[i].type)
    ...
    C_Warning(0,
    "The " BOLD("%s") " CVAR in " BOLD(
    DOOMRETRO_CONFIGFILE) " is invalid and has been reset "
                          "to its default of " BOLD("%s") ".",
    consolecmds[index].name, (defaultnumber ? "on" : "off"));
...
static int ParseIntParameter(const char* cvar, const char* strparm, const int valuealiastype)
{
    ...
    for(int i = 0; *valuealiases[i].text; i++)
        if(M_StringCompare(strparm, valuealiases[i].text) &&
        valuealiastype == valuealiases[i].type)
            return valuealiases[i].value;
    ...
    else
    {
        ...
        C_Warning(0,
        "The " BOLD("%s") " CVAR in " BOLD(
        DOOMRETRO_CONFIGFILE) " is "
                              "invalid and has been reset to its default "
                              "of " BOLD("%s%s") ".",
        consolecmds[index].name, temp,
        (consolecmds[index].flags == CF_PERCENT ? "%%" : ""));
        free(temp);
...
static float ParseFloatParameter(const char* cvar, const char* strparm, const int valuealiastype)
{
    ...
    sscanf(strparm, "%10f", &parm) == 1 && parm >= r_gamma_min && parm <= r_gamma_max)
        return parm;
    else if(sscanf(strparm, "%10f", &parm) == 1 &&
    parm >= (float)consolecmds[index].minimumvalue &&
    parm <= (float)consolecmds[index].maximumvalue)
        return parm;
    else
    {
...
{
    if(!*wadfolder || M_StringCompare(wadfolder, wadfolder_default) ||
    !M_FolderExists(wadfolder))
        D_InitWADfolder();
    ...
    if(M_EarlierVersion(version, version_default))
        C_Warning(0,
        "Thank you for upgrading " ITALICS(DOOMRETRO_NAME "!") " Enter " BOLD(
        "releasenotes") " to list what's changed since the last version.");
...
void M_LoadCVARs(const char* filename)
{
    ...
    fs_file* file = FS_OpenFile(filename, FS_READ, FS_TRUE);
    ...
    while(!FS_EOF(file))
    {
        ...
        for(int i = 0; i < numcvars; i++)
        {
            ...
            !M_StringCompare(cvar, cvars[i].oldname))
            ...
            case DEFAULT_BOOL:
                *(bool*)cvars[i].location =
                ParseBoolParameter(cvars[i].name, value, cvars[i].valuealiastype);
                cvarcount++;
                break;
            ...
            case DEFAULT_INT32:
            {
                ...
                *(int*)cvars[i].location =
                ParseIntParameter(cvars[i].name, temp, cvars[i].valuealiastype);
                free(temp);
                cvarcount++;
                break;
            }
            ...
            case DEFAULT_FLOAT:
            {
                ...
                *(float*)cvars[i].location =
                ParseFloatParameter(cvars[i].name, temp, cvars[i].valuealiastype);
                free(temp);
                cvarcount++;
                break;
            }
    ...
    if(!togglingvanilla)
    {
        if(isconfigfile)
        {
            ...
            C_Output("%s CVARs and %s player stats have been loaded from " BOLD("%s") ".",
            temp1, temp2, filename);
            C_Output("%s actions have been bound to controls for the "
